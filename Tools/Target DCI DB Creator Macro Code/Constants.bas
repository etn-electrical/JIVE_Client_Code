...
Public Const DCI_BACKMEM_CHECKBOX_COL = 132
Public Const DCI_RUNLOCK_CHECKBOX_COL = 133
Public Const DCI_ADMINLOCK_CHECKBOX_COL = 134
Public Const DCI_USBLOCK_CHECKBOX_COL = 135
Public Const DCI_CONFIGCRC_CHECKBOX_COL = 136
...
'***************************************************************
'BackupMemory Sheet File Indexing.
'Rows
Public Const BACKMEM_DATA_START_ROW = 9
Public Const BACKMEM_MAX_ROW = 2000

'Columns
Public Const BACKMEM_DCI_DESCRIPT_COL = 1
Public Const BACKMEM_DCI_DEFINE_COL = 2
Public Const BACKMEM_DCID_COL = 3
Public Const BACKMEM_PARAM_DESCRIPT_COL = 4
Public Const BACKMEM_PARAM_DEFINE_COL = 5
Public Const BACKMEM_PARAM_ID_COL = 6
Public Const BACKMEM_DCID_SIZE_COL = 7
Public Const BACKMEM_NV_ADDRESS_COL = 8
Public Const BACKMEM_MAX_COL = 9
Public Const BACKMEM_ERROR_COL = 10
Public Const BACKMEM_WARN_COL = 11
Public Const BACKMEM_UNUSED_COL = 16

' Backup Memory NV address calculation constants
Public Const BACKMEM_NV_CRC_SIZE = 2
Public Const BACKMEM_NV_IDENTITY_ADDR = 0
Public Const BACKMEM_NV_FIRST_ITEM_ADDR = 32
