...
#if BF_TEST_CODE_DBG
	#define TEST_CODE_DBG_PRINT  BF_DBG_ON
#else
	#define TEST_CODE_DBG_PRINT  BF_DBG_OFF
#endif
 ...
 */
#ifndef TEST_CODE_ENABLE_MASK
	#define TEST_CODE_ENABLE_MASK     DEBUG_MASK( TEST_CODE_DBG_PRINT )
#endif
 ...
 */
#define TEST_CODE_DEBUG_PRINT( MessageType, ... )     BF_DEBUG_PRINT( TEST_CODE_ENABLE_MASK, MessageType, __VA_ARGS__ )
