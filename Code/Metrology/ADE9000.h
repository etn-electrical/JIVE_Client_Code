...
#define 			DATA_WR_LOCK									0x0
	...
	//Value of ADE90XX registers

	//Configuration Settings

#define 			ADE9000_PGA_GAIN 								0x091A			//Igain = 4, Vgain = 2, Rest Gain of all channels = 1
#define 			ADE9000_CONFIG0 								0x00000020		//Integrator enabled
#define 			ADE9000_CONFIG1									0x1002			//CF3/ZX pin outputs Zero crossing
#define 			ADE9000_CONFIG2									0x0C00			//Default High pass corner frequency of 1.25Hz
#define 			ADE9000_CONFIG3									0x0000			//Peak and over current detection disabled

	//Energy Accumulation Settings

#define 			ADE9000_ACCMODE									0x0105			//60Hz operation, Absolute active and reactive Egy Acc
#define 			ADE9000_EP_CFG 									0x00A1			//Enable energy accumulation, accumulate samples at 4ksps
#define 			ADE9000_EGY_TIME 								0x0000			//Energy accumulation update time configuration

	//Zero crossing Settings

#define 			ADE9000_ZX_LP_SEL 								0x0000			//Line period and zero crossing obtained from VA
#define 			ADE9000_ZXTHRSH 								0x0000			//Zero crossing threshold
...
#define 			ADE9000_CRC_FORCE 								0x0001

	//Interrupt Setting

#define 			ADE9000_MASK0 									0x00800006		//Interrupt Enable reg-Energy sign change for CH 1, CH 2 and waveform buffer full

	//waveform calibration Settings

#define 			ADE9000_WFB_CFG_CAP_EN 							0x0010			//Resampled waveform capture enable
#define 			ADE9000_WFB_CFG_CAP_DIS 						0x0000			//Resampled waveform capture disable

	//redirect metro channels

#define ADE9000_ADC_REDIRECT 										0X001D7FBD
