    ...
    else
    {
        ...
        else
        {
            ...
            if (idLen > 0)
            {
                if (trace_log != NULL)
                {
                    STRING_sprintf(trace_log, " | PACKET_ID: %u", publishHeader->packetId);
                }
    ...
    else
    {
        ...
        if (result != NULL)
        {
            ...
            else
            {
                ...
                if (trace_log != NULL)
                {
                    sub_trace = STRING_construct_sprintf(" | PACKET_ID: %u", packetId);
                }
    ...
    else
    {
        ...
        if (result != NULL)
        {
            ...
            else
            {
                ...
                if (trace_log != NULL)
                {
                    unsub_trace = STRING_construct_sprintf(" | PACKET_ID: %u", packetId);
                }
