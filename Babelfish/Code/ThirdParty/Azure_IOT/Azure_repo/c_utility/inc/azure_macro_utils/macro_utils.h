...
{                                                                  \
/* "(int)value<0 " condition is always false,so it is generating the warning "pointless integer comparison, the result is always false". To fix this warning condition is removed */ \
