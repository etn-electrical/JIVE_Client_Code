...
/*---------------------------------------------------------------------------*/
#define VPC3_CFG_FINISHED                 static_cast<UBYTE>(0x00)
#define VPC3_CFG_CONFLICT                static_cast<UBYTE>(0x01)
#define VPC3_CFG_NOT_ALLOWED         static_cast<UBYTE>(0x03)

/*---------------------------------------------------------------------------*/
/* 3.5 literals for chk config data                                          */
/*---------------------------------------------------------------------------*/
#define VPC3_CFG_OK                          static_cast<UBYTE>(0x00)
#define VPC3_CFG_FAULT                     static_cast<UBYTE>(0x01)
#define VPC3_CFG_UPDATE                   static_cast<UBYTE>(0x02)
...
/*---------------------------------------------------------------------------*/
/* 6.3 literals for global control                                             */
/*---------------------------------------------------------------------------*/
#define VPC3_GC_CLEAR_DATA              ((UBYTE)0x02)
#define VPC3_GC_UNFREEZE                ((UBYTE)0x04)
#define VPC3_GC_FREEZE                  ((UBYTE)0x08)
#define VPC3_GC_UNSYNCH                 ((UBYTE)0x10)
#define VPC3_GC_SYNCH                   ((UBYTE)0x20)
...
/* 7.1 defines                                                               */
/*---------------------------------------------------------------------------*/
#define EXT_DIAG_RESET                  static_cast<UBYTE>(0x00)
#define DIAG_RESET                         static_cast<UBYTE>(0x00)
#define EXT_DIAG_SET                      static_cast<UBYTE>(0x01)
#define STAT_DIAG_RESET                 static_cast<UBYTE>(0x00)
#define STAT_DIAG_SET                     static_cast<UBYTE>(0x02)
#define EXT_STAT_DIAG_SET              static_cast<UBYTE>(0x03)
#define OVF_DIAG_SET                      static_cast<UBYTE>(0x04)
#define DIAG_WAIT_FOR_ALARM         static_cast<UBYTE>(0x80)
...
#define DIAG_TYPE_MASK                   static_cast<UBYTE>(0xC0)
#define DIAG_TYPE_DEV                     static_cast<UBYTE>(0x00)
#define DIAG_TYPE_KEN                     static_cast<UBYTE>(0x40)
#define DIAG_TYPE_CHN                     static_cast<UBYTE>(0x80)
#define DIAG_TYPE_REV                     static_cast<UBYTE>(0xC0)
...
#define DS240_ST1_MASTER_CLEAR            ((UBYTE)0x40)  //master is in state clear ( Operate --> Clear )
#define DS240_ST1_START_PROCESS           ((UBYTE)0x80)  //set restarted bit in diagnostic state
...
#define MASK_FOR_TS_ENABLED               ((UBYTE)0xE0)  //mask for TsEnabled = TRUE
...
#define TS_DIAG_AT_EV_01               ((UBYTE)0x01)     //1: Event, Data_Set (mixed composition of signal end exception types)
#define TS_DIAG_AT_EV_02               ((UBYTE)0x02)     //2: Event, Trend_Float structure (DS-46)
#define TS_DIAG_AT_EV_03               ((UBYTE)0x03)     //3: Event, Trend_Discrete structure (DS-47)
#define TS_DIAG_AT_EV_04               ((UBYTE)0x04)     //4: Event, Trend_Bit_String structure (DS-48)
                                                         //5 – 9: reserved for other Event alert object types
#define TS_DIAG_AT_PA_0A               ((UBYTE)0x0A)     //10: Process Alarm, Alarm_Float structure (DS-39)
#define TS_DIAG_AT_PA_0B               ((UBYTE)0x0B)     //11: Process Alarm, Alarm_Discrete structure (DS-40)
#define TS_DIAG_AT_PA_0C               ((UBYTE)0x0C)     //12: Process Alarm, Alarm_Integer structure (DS-86)
                                                         //13 – 19: reserved for other Process Alarm alert object types
#define TS_DIAG_AT_PA_0D               ((UBYTE)0x0D)     //13: Process Alarm,
                                                         
                                                         
#define TS_DIAG_AT_UA_14               ((UBYTE)0x14)     //20: Update Alarm, Alarm_Update structure (DS-41)
                                                         //21 – 29: reserved for other Update Alarm alert object types
#define TS_DIAG_AT_SA_1E               ((UBYTE)0x1E)     //30: Status Alarm, Alarm_Mode_Change structure (DS-87)
#define TS_DIAG_AT_SA_1F               ((UBYTE)0x1F)     //31: Status Alarm, Alarm_Simulation structure (DS-88)
#define TS_DIAG_AT_SA_20               ((UBYTE)0x20)     //32: Status Alarm, Alarm_Fail_Safe structure (DS-89)
#define TS_DIAG_AT_SA_21               ((UBYTE)0x21)     //33: Status Alarm, Alarm_Access_Protection structure (DS-90)
#define TS_DIAG_AT_SA_22               ((UBYTE)0x22)     //34: Status Alarm, Alarm_Sampling_Information structure (DS-96)
#define TS_DIAG_AT_SA_23               ((UBYTE)0x23)     //35: Status Alarm, Alarm_Sampling_State structure (DS-96)
                                                         //36 – 39: reserved for other Status Alarm alert object types
#define TS_DIAG_AT_TD_28               ((UBYTE)0x28)     //40: Timestamped Diagnosis, Alarm_Diagnosis structure (DS-91)
#define TS_DIAG_AT_TD_29               ((UBYTE)0x29)     //41: Timestamped Diagnosis, Alarm_Extended_Diagnosis structure (DS-92)
#define TS_DIAG_AT_TD_2A               ((UBYTE)0x2A)     //42: Timestamped Diagnosis, Alarm_Checkback structure (DS-93)
#define TS_DIAG_AT_TD_2B               ((UBYTE)0x2B)     //43: Timestamped Diagnosis, Alarm_Defect_Class structure (DS-94)
#define TS_DIAG_AT_TD_2C               ((UBYTE)0x2C)     //44: Timestamped Diagnosis, Alarm_Sampling_Diagnosis structure (DS-91)
...
#define TS_DIAG_API_PA_01              ((UWORD)0x0001)   //1: "PROFIBUS-PA Profile for Process Control Devices, Version 3, Amendment 1"(support of alarms)
...
#define STATUS_MESSAGE                   static_cast<UBYTE>(0x81)
#define MODUL_STATUS                      static_cast<UBYTE>(0x82)
#define STATUS_PRM_COMMAND_ACK            static_cast<UBYTE>(0x9E)
#define STATUS_RED_STATE                  static_cast<UBYTE>(0x9F)
...
typedef struct
{
   ...
   UBYTE                   bDinBufsize;                        /*!< Length of the 3 Din buffers (dp_cfg.h:\ref DIN_BUFSIZE).            */
   UBYTE                   bDoutBufsize;                       /*!< Length of the 3 Dout buffers (dp_cfg.h:\ref DOUT_BUFSIZE).          */
   UBYTE                   bPrmBufsize;                        /*!< Length of the Set_Param buffer (dp_cfg.h:\ref PRM_BUFSIZE).         */
   UBYTE                   bDiagBufsize;                       /*!< Length of the 2 Diag buffer (dp_cfg.h:\ref DIAG_BUFSIZE).           */
   UBYTE                   bCfgBufsize;                        /*!< Length of the 2 Config buffer (dp_cfg.h:\ref CFG_BUFSIZE).          */
   UBYTE                   bSsaBufsize;                        /*!< Length of the Set_Slave_Address-buffer (dp_cfg.h:\ref SSA_BUFSIZE). */
   ...
   VPC3_UNSIGNED8_PTR      pDiagBuffer;                        /*!< microprocessor formatted pointer to current Diag buffer.*/
...
#if LITTLE_ENDIAN
   #define IM00_SUPPORTED                    ((UWORD)0x0100)
