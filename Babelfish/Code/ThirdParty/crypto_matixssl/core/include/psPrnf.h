...
// __attribute__ is a c compiler functionality hence compiling this we get below warning
// Warning[Pa167]: the "__format__" attribute is not supported
// Fixing this warning by adding __GNUC__ define check
#ifdef __GNUC__
