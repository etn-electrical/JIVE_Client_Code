        ...
        psSize_t *targetlen)
{
    ...
    // LTK-4064: Added this pragma extension to suppress warning Pa084 : 
    // " pointless integer comparison with out of range value" as this code belongs to
    // third party vendor. This will be later fixed once updated version of code is 
    // received from third party vendor.    
#ifndef ESP32_SETUP // This way of warning supress does not work for ESP32
