...
static int32 process_cmd_options(void)
{
    ...
    Strcpy(g_ip,          "192.168.1.6");
    g_ciphers            = 1;
    //g_cipher[0]          = TLS_RSA_WITH_AES_128_CBC_SHA256;	// RSA		//47;
	//g_cipher[0]          = TLS_RSA_WITH_AES_128_CBC_SHA256;	// PSK; 	//XX;
	g_cipher[0]          = TLS_ECDH_ECDSA_WITH_AES_128_CBC_SHA256;	//ECC;//XX
