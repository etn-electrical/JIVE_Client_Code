...
// LTK_4064: Warning: re-definition of AF_INET6
// Removed this definition from here as it is already defined in lwip/socket.h
// which is included in lwm2mclient.c 
...
//    char bootstrap_server[LWM2M_MAX_STR_LEN];Commented
