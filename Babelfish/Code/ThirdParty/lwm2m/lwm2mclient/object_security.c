...
#include "liblwm2m.h"
#include "..\..\..\..\..\Code\Prod_Spec_LWM2M\LWM2M_C_Connector.h"
                                     ...
                                     bool isBootstrap)
{
    ...
    if (NULL != securityObj)
    {
        ...
        if (securityMode == LWM2M_SECURITY_MODE_PRE_SHARED_KEY)
        {
            ...
            {
#ifdef WITH_LOGS
                LWM2M_DEBUG_PRINT(DBG_MSG_DEBUG,"Bad parameters for PSK mode.\r\n");
#endif
            ...
            {
#ifdef WITH_LOGS
                LWM2M_DEBUG_PRINT(DBG_MSG_DEBUG,"Failed to allocate secretKey.\r\n");
#endif
                clean_security_object(securityObj);
                return NULL;
            }
        ...
        if (securityMode == LWM2M_SECURITY_MODE_CERTIFICATE)
        {
            ...
            {
#ifdef WITH_LOGS
                LWM2M_DEBUG_PRINT(DBG_MSG_DEBUG,"Failed to parse server certificate\r\n");
#endif
            }
            ...
            {
#ifdef WITH_LOGS
                LWM2M_DEBUG_PRINT(DBG_MSG_DEBUG,"Failed to parse client certificate\r\n");
#endif
                clean_security_object(securityObj);
                return NULL;
            }
            ...
            {
#ifdef WITH_LOGS
                LWM2M_DEBUG_PRINT(DBG_MSG_DEBUG,"Failed to parse private key (Certificate mode)\r\n");
#endif
                clean_security_object(securityObj);
                return NULL;
            }
        ...
        if (securityMode == LWM2M_SECURITY_MODE_NONE)
        {
            clean_security_object(securityObj);
#ifdef WITH_LOGS
            LWM2M_DEBUG_PRINT(DBG_MSG_DEBUG,"NoSec is not supported.\r\n");
#endif
            return NULL;
        }
