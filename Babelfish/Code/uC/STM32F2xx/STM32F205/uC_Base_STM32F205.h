 ...
 *****************************************************************************************
 */
#ifndef uC_Base_STM32F205_H
   #define uC_Base_STM32F205_H
 ...
 *  Class Declaration
   --------------------------------------------------------------------------------------------------
 */
class uC_Base_STM32F205 : public uC_Base
{
	public:
		uC_Base_STM32F205( void );
		~uC_Base_STM32F205( void );
	...
	private:
		...
		static const uint32_t m_pclock_freqs[uC_BASE_STM32F205_MAX_PCLKS];
