...
const uint32_t uC_Base_STM32F205::m_pclock_freqs[uC_BASE_STM32F205_MAX_PCLKS] =
{
 ...
 */
const uC_BASE_PIO_CTRL_STRUCT uC_Base_STM32F205::m_pio_ctrls[uC_BASE_MAX_PIO_CTRLS] =
{
	{
		GPIOA,
		{
...
const uC_BASE_USB_IO_STRUCT uC_Base_STM32F205::m_usb_io[uC_BASE_MAX_USB_PORTS] =
{
	{
		{
...
const uC_BASE_USART_IO_STRUCT uC_Base_STM32F205::m_usart_io[uC_BASE_MAX_USART_PORTS] =
{
	{
		USART1,
		{
		...
		USART1_IRQn,
		static_cast<uint8_t>( uC_BASE_USART_PORT_1 ),
		DMA_USART1RX_D2S2C4,
		DMA_USART1TX_D2S7C4,
	...
	},
	{
		USART2,
		{
			static_cast<uint8_t>( RCC_PERIPH_CLCK_APB1 ),
...
{ &SPI3_MOSI_PIO_PC12, &SPI3_MISO_PIO_PC11, &SPI3_CLOCK_PIO_PC10, &SPI3_SS_PIO_PA4 };
const uC_BASE_SPI_IO_STRUCT uC_Base_STM32F205::m_spi_io[uC_BASE_SPI_MAX_CTRLS] =
{
	{
		SPI1,
		{
...
uC_BASE_I2C_INT_OBJ_CBACK_FUNC* uC_Base_STM32F205::m_obj_func_i2c_dma_list_Tx[uC_BASE_I2C_MAX_CTRLS];
// Stores the function pointer of the objects static interrupt handler.
uC_BASE_I2C_INT_OBJ_CBACK_FUNC* uC_Base_STM32F205::m_obj_func_i2c_dma_list_Rx[uC_BASE_I2C_MAX_CTRLS];
// Stores the object pointer associated with the interrupt.
uC_BASE_I2C_OBJ_PARAM_TD uC_Base_STM32F205::m_obj_i2c_dma_list_Tx[uC_BASE_I2C_MAX_CTRLS];
// Stores the object pointer associated with the interrupt.
uC_BASE_I2C_OBJ_PARAM_TD uC_Base_STM32F205::m_obj_i2c_dma_list_Rx[uC_BASE_I2C_MAX_CTRLS];

// Stores the function pointer of the objects static interrupt handler.
uC_BASE_I2C_INT_OBJ_CBACK_FUNC* uC_Base_STM32F205::m_obj_func_i2c_list[uC_BASE_I2C_MAX_CTRLS];
// Stores the object pointer associated with the interrupt.
uC_BASE_I2C_OBJ_PARAM_TD uC_Base_STM32F205::m_obj_i2c_list[uC_BASE_I2C_MAX_CTRLS];
 ...
 *****************************************************************************************
 */
void uC_Base_STM32F205::uC_BASE_I2C_DMA_INT1_Tx( void )
{
 ...
 *****************************************************************************************
 */
void uC_Base_STM32F205::uC_BASE_I2C_DMA_INT2_Tx( void )
{
 ...
 *****************************************************************************************
 */
void uC_Base_STM32F205::uC_BASE_I2C_DMA_INT3_Tx( void )
{
 ...
 *****************************************************************************************
 */
void uC_Base_STM32F205::uC_BASE_I2C_DMA_INT1_Rx( void )
{
 ...
 *****************************************************************************************
 */
void uC_Base_STM32F205::uC_BASE_I2C_DMA_INT2_Rx( void )
{
 ...
 *****************************************************************************************
 */
void uC_Base_STM32F205::uC_BASE_I2C_DMA_INT3_Rx( void )
{
	( *m_obj_func_i2c_dma_list_Rx[2] )( m_obj_i2c_dma_list_Rx[2] );
}

void uC_Base_STM32F205::uC_BASE_I2C_INT1( void )    { ( *m_obj_func_i2c_list[0] )( m_obj_i2c_list[0] ); }

void uC_Base_STM32F205::uC_BASE_I2C_INT2( void )    { ( *m_obj_func_i2c_list[1] )( m_obj_i2c_list[1] ); }

void uC_Base_STM32F205::uC_BASE_I2C_INT3( void )    { ( *m_obj_func_i2c_list[2] )( m_obj_i2c_list[2] ); }


const uC_BASE_I2C_IO_STRUCT uC_Base_STM32F205::m_i2c_io[uC_BASE_I2C_MAX_CTRLS] =
{
	{
		I2C1,
		{
...
const uC_BASE_TIMER_IO_STRUCT uC_Base_STM32F205::m_timer_io[uC_BASE_MAX_TIMER_CTRLS] =
{
 ...
 */
const uC_BASE_EXT_INT_IO_STRUCT uC_Base_STM32F205::m_ext_ints[uC_BASE_EXT_INT_MAX_INPUTS] =
{
	{
		EXTI0_IRQn,
		0x0001
...
const uC_BASE_ATOD_IO_STRUCT uC_Base_STM32F205::m_atod_io[uC_BASE_ATOD_MAX_CTRLS] =
{
	{
		ADC1,
		{
 ...
 */
const uC_BASE_DMA_IO_STRUCT uC_Base_STM32F205::m_dma_io[uC_BASE_DMA_STREAM_MAX] =
{
	{
		DMA1,
		DMA1_Stream0,
...
const uC_BASE_CAN_IO_STRUCT uC_Base_STM32F205::m_can_io[uC_BASE_CAN_MAX_CTRLS] =
{
	{
		CAN1,
		{
