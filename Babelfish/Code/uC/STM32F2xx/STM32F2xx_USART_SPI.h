/**
 *****************************************************************************************
 *	@file STM32F2xx_USART_SPI.h
 *
 *	@brief Specialized Queued SPI class for the STM32F2xx architecture
 *
 *	@details
 *
 ...
 *****************************************************************************************
 */
#ifndef STM32F2xx_USART_SPI_H
   #define STM32F2xx_USART_SPI_H
...
/**
 ****************************************************************************************
 * @brief STM32F2xx_USART_SPI class
 *
 * @details Realizes Queued SPI interface for the STM32F2xx architecture
 *
 ****************************************************************************************
 */
class STM32F2xx_USART_SPI : public uC_Queued_SPI
{
	public:
		/**
		 * @brief                  Constructs a STM32F2xx_SPI object.
		 ...
		 */
		STM32F2xx_USART_SPI( uint8_t hw_usart_num, uint8_t total_chip_sel,
		...
		/**
		 * @brief Constructs a STM32F2xx_USART_SPI object.
	...
	protected:
		 ...
		 * @param object - pointer to STM32F2xx object call back is itended for.
		 */
		static void DMA_ISR_Static( void* object )
		{
			static_cast<STM32F2xx_USART_SPI*>( object )->DMA_ISR();
		}
		...
		{
			static_cast<STM32F2xx_USART_SPI*>( object )->ISR();
		}
	...
	private:
		 ...
		 */
		STM32F2xx_USART_SPI( const STM32F2xx_USART_SPI& object );
		STM32F2xx_USART_SPI & operator =( const STM32F2xx_USART_SPI& object );
