 ...
 *****************************************************************************************
 */
#ifndef uC_Base_STM32F207_H
   #define uC_Base_STM32F207_H
 ...
 *  Class Declaration
   --------------------------------------------------------------------------------------------------
 */
class uC_Base_STM32F207 : public uC_Base
{
	public:
		uC_Base_STM32F207( void );
		~uC_Base_STM32F207( void );
		...
		static bool Set_Option_Bytes( FLASH_OBProgramInitTypeDef const* optionBytes = & DEFAULT_DEBUG_OPTION_BYTES );

		static const FLASH_OBProgramInitTypeDef DEFAULT_DEBUG_OPTION_BYTES;
		static const FLASH_OBProgramInitTypeDef DEFAULT_RELEASE_OPTION_BYTES;
	...
	private:
		...
		static const uint32_t m_pclock_freqs[uC_BASE_STM32F207_MAX_PCLKS];
