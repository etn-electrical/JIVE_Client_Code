...
#ifndef __IOSTM32F207xx_H
#define __IOSTM32F207xx_H
...
***************************************************************************
**
**   STM32F207xx SPECIAL FUNCTION REGISTERS
**
***************************************************************************
***************************************************************************
***************************************************************************/
...
/* RCC AHB2 peripheral clock enable in low power mode register (RCC AHB2 peripheral clock enable in low power mode
...
__IO_REG32_BIT( SYSCFG_EXTICR2,    0x4001380C, __READ_WRITE, __syscfg_exticr1_bits );
__IO_REG32_BIT( SYSCFG_EXTICR3,    0x40013810, __READ_WRITE, __syscfg_exticr1_bits );
__IO_REG32_BIT( SYSCFG_EXTICR4,    0x40013814, __READ_WRITE, __syscfg_exticr1_bits );
...
__IO_REG32_BIT( RTC_TCR,           0x40002840, __READ_WRITE, __rtc_tcr_bits );
...
**
***************************************************************************/
__IO_REG32_BIT( UART6_SR,         0x40011400, __READ_WRITE, __uart_sr_bits );
__IO_REG32_BIT( UART6_DR,         0x40011404, __READ_WRITE, __uart_dr_bits );
__IO_REG32_BIT( UART6_BRR,        0x40011408, __READ_WRITE, __uart_brr_bits );
__IO_REG32_BIT( UART6_CR1,        0x4001140C, __READ_WRITE, __uart_cr1_bits );
__IO_REG32_BIT( UART6_CR2,        0x40011410, __READ_WRITE, __uart_cr2_bits );
__IO_REG32_BIT( UART6_CR3,        0x40011414, __READ_WRITE, __uart5_cr3_bits );
