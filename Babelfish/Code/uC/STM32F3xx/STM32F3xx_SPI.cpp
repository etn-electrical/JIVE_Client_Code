 ...
 *****************************************************************************************
 */
STM32F3xx_SPI::STM32F3xx_SPI( uint8_t channel, uint8_t no_slaves, bool_t master,
 ...
 *****************************************************************************************
 */
STM32F3xx_SPI::~STM32F3xx_SPI( void )
{
 ...
 *****************************************************************************************
 */
void STM32F3xx_SPI::Start_Exchange( bool_t new_exchange )
{
 ...
 *****************************************************************************************
 */
void STM32F3xx_SPI::DMA_ISR( void )
{
	bool_t failure;
 ...
 *****************************************************************************************
 */
void STM32F3xx_SPI::SPI_ISR( void )
{
 ...
 *****************************************************************************************
 */
void STM32F3xx_SPI::Assume_IO_Control( const uC_BASE_SPI_IO_PORT_STRUCT* spi_io,
 ...
 *****************************************************************************************
 */
void STM32F3xx_SPI::Initialize_Peripheral_Clock( const PERIPH_DEF_ST* periph_def ) const
{
 ...
 *****************************************************************************************
 */
bool_t STM32F3xx_SPI::Clear_DMA_Interrupts()
{
 ...
 *****************************************************************************************
 */
void STM32F3xx_SPI::SPI_Chip_Configuration( spi_mode mode, uint32_t chip_clock_freq,
