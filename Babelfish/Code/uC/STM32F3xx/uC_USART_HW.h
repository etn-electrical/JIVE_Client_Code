...
class uC_USART_HW
{
	public:
		...
		inline void Enable_RX_Ready_Int( void )     { m_usart->CR1 |= USART_CR1_RXNEIE; }

		inline void Disable_RX_Ready_Int( void )    { m_usart->CR1 &= ~USART_CR1_RXNEIE; }
		...
		inline void Enable_TX_Empty_Int( void )     { m_usart->CR1 |= USART_CR1_TCIE; }

		inline void Disable_TX_Empty_Int( void )    { m_usart->CR1 &= ~USART_CR1_TCIE; }
		...
		inline void Enable_Parity_Error_Int( void )     { m_usart->CR1 |= USART_CR1_PEIE; }

		inline void Disable_Parity_Error_Int( void )    { m_usart->CR1 &= ~USART_CR1_PEIE; }
		...
		inline void Clear_Int_Status( void )                { m_usart->ICR = 0x121B5F; }
		...
		inline uint32_t Get_Int_Status_Bits( void )           { return ( m_usart->ISR ); }
