/**
 **************************************************************************************************
 *@file           STM32F3xx_I2C.h Header File for I2C implementation.
 *
 ...
 **************************************************************************************************
 */
#ifndef STM32F3xx_I2C_H
#define STM32F3xx_I2C_H
...
class STM32F3xx_I2C : public uC_Queued_I2C
{
	public:
		 ...
		 * @note
		 */
		STM32F3xx_I2C( class_config_t const* i2c_assy,
					   select_config_t const* const select_config );

		/**
		 * @brief                   Destructor to delete an instance of STM32F3xx_I2C class
		 * @return
		 */
		~STM32F3xx_I2C( void );
	...
	protected:
		...
		{
			static_cast<STM32F3xx_I2C*>( object )->DMA_TX_ISR();
		}
		...
		{
			static_cast<STM32F3xx_I2C*>( object )->DMA_RX_ISR();
		}
		...
		{
			static_cast<STM32F3xx_I2C*>( object )->I2C_ISR();
		}
