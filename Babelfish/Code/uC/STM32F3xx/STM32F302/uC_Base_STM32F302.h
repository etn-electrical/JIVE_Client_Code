 ...
 *****************************************************************************************
 */
#ifndef uC_Base_STM32F302_H
   #define uC_Base_STM32F302_H
 ...
 *  Class Declaration
   --------------------------------------------------------------------------------------------------
 */
class uC_Base_STM32F302 : public uC_Base
{
	public:
		uC_Base_STM32F302( void );
		~uC_Base_STM32F302( void );
	...
	private:
		...
		static const uint32_t m_pclock_freqs[uC_BASE_STM32F302_MAX_PCLKS];

		// static const uC_BASE_TWI_IO_STRUCT		m_twi_io[uC_BASE_TWI_MAX_CTRLS];
