 ...
 *****************************************************************************************
 */
uC_USART_9BIT_DMA::uC_USART_9BIT_DMA( uint8_t hw_usart_num, uint8_t hw_timer_num,
									  const uC_BASE_USART_IO_PORT_STRUCT* io_port ) :
	uC_USART_9BIT_HW( hw_usart_num, io_port, true ),
	m_cback_request( 0U ),
	...
	uC_USART_9BIT_Buff()
{
	...
	uC_USART_9BIT_DMA::Stop_TX();
	uC_USART_9BIT_DMA::Stop_RX();
 ...
 *****************************************************************************************
 */
uC_USART_9BIT_DMA::~uC_USART_9BIT_DMA( void )
{
	m_cback_func = static_cast<uC_USART_9BIT_Buff::cback_func_t>( nullptr );
	m_cback_param = static_cast<uC_USART_9BIT_Buff::cback_param_t>( nullptr );
	delete m_timer;
	m_buffer_head = reinterpret_cast<uint8_t*>( nullptr );
}
 ...
 *****************************************************************************************
 */
void uC_USART_9BIT_DMA::Config_Callback( uC_USART_9BIT_Buff::cback_func_t cback_func,
 ...
 *****************************************************************************************
 */
void uC_USART_9BIT_DMA::Start_RX( uint8_t* data, uint16_t length )
{
	...
	m_rx_dma_ctrl->Set_Buff( data, &m_usart->DR, length );
 ...
 *****************************************************************************************
 */
uC_USART_9BIT_Buff::rx_state_t uC_USART_9BIT_DMA::RX_State( void )
{
	return ( m_rx_state );
}
 ...
 *****************************************************************************************
 */
uint16_t uC_USART_9BIT_DMA::Get_RX_Length( void )
{
	uint32_t RxCount;

	RxCount = ( m_rx_dma_ctrl->Counts_Done() ) << 1;
	return ( static_cast<uint16_t>( RxCount ) );
}
 ...
 *****************************************************************************************
 */
void uC_USART_9BIT_DMA::Stop_RX( void )
{
	Push_TGINT();
 ...
 *****************************************************************************************
 */
void uC_USART_9BIT_DMA::Start_TX( uint8_t* data, uint16_t length )
{
	Push_TGINT();
	...
	length = length >> 1;	/*  9 Bit data length Divide by 2 */
	m_tx_dma_ctrl->Set_Buff( data, &m_usart->DR, length );

	m_tx_dma_ctrl->Enable_End_Buff_Int();
	m_tx_dma_ctrl->Enable_Int();

	m_usart->SR &= ~USART_SR_TC;
 ...
 *****************************************************************************************
 */
uC_USART_9BIT_Buff::tx_state_t uC_USART_9BIT_DMA::TX_State( void )
{
	return ( m_tx_state );
}
 ...
 *****************************************************************************************
 */
bool_t uC_USART_9BIT_DMA::TX_Holdoff( void )
{
	return ( m_tx_holdoff );
}
 ...
 *****************************************************************************************
 */
void uC_USART_9BIT_DMA::Stop_TX( void )
{
	Push_TGINT();
 ...
 *****************************************************************************************
 */
void uC_USART_9BIT_DMA::USART_Int( void )
{
	uint32_t int_status;
 ...
 *****************************************************************************************
 */
void uC_USART_9BIT_DMA::RX_Timer_Int( void )
{
	cback_status_t cback_status_bits = 0U;
 ...
 *****************************************************************************************
 */
void uC_USART_9BIT_DMA::TX_Timer_Int( void )
{
	cback_status_t cback_status_bits = 0U;
 ...
 *****************************************************************************************
 */
void uC_USART_9BIT_DMA::RX_DMA_Int( void )
{
	cback_status_t cback_status_bits = 0U;
 ...
 *****************************************************************************************
 */
void uC_USART_9BIT_DMA::TX_DMA_Int( void )
{
	cback_status_t cback_status_bits = 0U;
 ...
 *****************************************************************************************
 */
bool_t uC_USART_9BIT_DMA::Config_Port( uint32_t baud_rate,
									   uC_USART_9BIT_Buff::char_size_t char_size,
