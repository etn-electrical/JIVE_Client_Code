 ...
 *****************************************************************************************
 */
uC_Base_STM32WB55R::uC_Base_STM32WB55R( void ) : uC_Base()
{}
 ...
 *****************************************************************************************
 */
uC_BASE_WDOG_CTRL_STRUCT const* uC_Base_STM32WB55R::Get_WDOG_Ctrl( uint8_t block )
{
 ...
 *****************************************************************************************
 */
uC_BASE_TIMER_IO_STRUCT const* uC_Base_STM32WB55R::Get_Timer_Ctrl( uint32_t timer )
{
 ...
 *****************************************************************************************
 */
uC_BASE_LPTIMER_IO_STRUCT const* uC_Base_STM32WB55R::Get_LPTimer_Ctrl( uint32_t timer )
{
	uC_BASE_LPTIMER_IO_STRUCT const* return_ctrl =
		reinterpret_cast<uC_BASE_LPTIMER_IO_STRUCT const*>( nullptr );

	if ( timer < uC_BASE_MAX_LPTIMER_CTRLS )
	{
		return_ctrl = &m_lptimer_io[timer];
	}
 ...
 *****************************************************************************************
 */
uC_BASE_PIO_CTRL_STRUCT const* uC_Base_STM32WB55R::Get_PIO_Ctrl( uint32_t io_block )
{
 ...
 *****************************************************************************************
 */
uC_BASE_USB_IO_STRUCT const* uC_Base_STM32WB55R::Get_USB_Ctrl( uint8_t usb_channel )
{
 ...
 *****************************************************************************************
 */
uC_BASE_USART_IO_STRUCT const* uC_Base_STM32WB55R::Get_USART_Ctrl( uint32_t port )
{
 ...
 *****************************************************************************************
 */
uC_BASE_SPI_IO_STRUCT const* uC_Base_STM32WB55R::Get_SPI_Ctrl( uint32_t spi_block )
{
 ...
 *****************************************************************************************
 */
uC_BASE_I2C_IO_STRUCT const* uC_Base_STM32WB55R::Get_I2C_Ctrl( uint32_t i2c_block )
{
 ...
 *****************************************************************************************
 */
uC_BASE_EXT_INT_IO_STRUCT const* uC_Base_STM32WB55R::Get_Ext_Int_Ctrl(
 ...
 *****************************************************************************************
 */
uC_BASE_TIMER_IO_STRUCT const* uC_Base_STM32WB55R::Get_PWM_Ctrl( uint32_t pwm_block )
{
 ...
 *****************************************************************************************
 */
uC_BASE_ATOD_IO_STRUCT const* uC_Base_STM32WB55R::Get_AtoD_Ctrl( uint32_t atod_block )
{
 ...
 *****************************************************************************************
 */
uC_BASE_DMA_IO_STRUCT const* uC_Base_STM32WB55R::Get_DMA_Ctrl( uint32_t dma_channel )
{
 ...
 *****************************************************************************************
 */
uC_BASE_EMAC_IO_STRUCT const* uC_Base_STM32WB55R::Get_EMAC_Ctrl( uint8_t emac_block )
{
 ...
 *****************************************************************************************
 */
uint32_t uC_Base_STM32WB55R::Get_PClock_Freq( uint8_t pclock_selection )
{
 ...
 *****************************************************************************************
 */
bool uC_Base_STM32WB55R::Set_Option_Bytes( BROWN_OUT_OPT_SELECT_EN brown_out_sel,
										   WATCHDOG_OPT_SELECT_EN watchdog_sel )
{
	...
	uint32_t flash_reg_msk;

	flash_ctrl_ptr = ( uint8_t volatile* )OPTCR_BYTE0_ADDRESS;
	target_opt = ( brown_out_sel << 2U ) | ( watchdog_sel << 5U );
	flash_reg_msk = FLASH_OPTR_BOR_LEV | FLASH_OPTR_IWDG_SW;
	current_opt = *flash_ctrl_ptr & flash_reg_msk;
	if ( current_opt != target_opt )
	{
		...
		current_opt = *flash_ctrl_ptr & ~( FLASH_OPTR_BOR_LEV | FLASH_OPTR_IWDG_SW );

		*flash_ctrl_ptr = ( target_opt | current_opt );	// | current_opt;
		// while ( ( FLASH->SR & FLASH_SR_BSY ) != 0U ){};

		*flash_ctrl_ptr |= FLASH_CR_OPTSTRT;
		while ( ( FLASH->SR & FLASH_SR_BSY ) != 0U )
		{}

		*flash_ctrl_ptr |= FLASH_CR_OPTLOCK;
		// while ( ( FLASH->SR & FLASH_SR_BSY ) != 0U ){};
 ...
 *****************************************************************************************
 */
// no CAN support for STM32WB55xx
// uC_BASE_CAN_IO_STRUCT const*        uC_Base_STM32WB55R::Get_CAN_Ctrl( uint32_t can_block )
// {
 ...
 *****************************************************************************************
 */
uC_BASE_TWI_IO_STRUCT const* uC_Base_STM32WB55R::Get_TWI_Ctrl( uint32_t twi_block )
{
