...
class uC_RTC_Backup
{
	public:
		 ...
		 * by system and RTC_BKP_REG_1 is being used by Uberloader for FUS operation. So we are using backup registers
		 * from RTC_BKP_REG_2 to RTC_BKP_REG_19.
		 */
		static const uint8_t RTC_BKP_FUS_START_ADDR = RTC_BKP_REG_1 * 4U;

		static const uint8_t RTC_BKP_FC_START_ADDR = RTC_BKP_REG_2 * 4U;
