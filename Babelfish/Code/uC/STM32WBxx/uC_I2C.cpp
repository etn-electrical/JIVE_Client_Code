...
{
	m_dma_transfer = false;		// overriding this value, since dma is not enabled
	m_synchronous_type = synchronus_trnasfer;	// asynchronous mode not supported yet, PBI has been created
