...
const uint32_t uC_Base_STM32F105::m_pclock_freqs[uC_BASE_STM32F105_MAX_PCLKS] =
{
 ...
 */
const uC_BASE_PIO_CTRL_STRUCT uC_Base_STM32F105::m_pio_ctrls[uC_BASE_MAX_PIO_CTRLS] =
{
	{
		GPIOA,
		{
...
const uC_BASE_USART_IO_PORT_STRUCT uC_BASE_USART4_DEFAULT_PORT = { &USART4_TX_PIO, &USART4_RX_PIO };
const uC_BASE_USART_IO_PORT_STRUCT uC_BASE_USART5_DEFAULT_PORT = { &USART5_TX_PIO, &USART5_RX_PIO };

const uC_BASE_USART_IO_STRUCT uC_Base_STM32F105::m_usart_io[uC_BASE_MAX_USART_PORTS] =
{
	{
		USART1,
		{
...
const uC_BASE_SPI_IO_STRUCT uC_Base_STM32F105::m_spi_io[uC_BASE_SPI_MAX_CTRLS] =
{
	{
		SPI1,
		{
...
uC_PERIPH_IO_STRUCT const* m_timer1_pio[uC_BASE_MAX_TIMER_CAP_COMP_CH] =
{ &TIMER1_PIO1, &TIMER1_PIO2, &TIMER1_PIO3, &TIMER1_PIO4 };
uC_PERIPH_IO_STRUCT const* m_timer2_pio[uC_BASE_MAX_TIMER_CAP_COMP_CH] =
{ &TIMER2_PIO1, &TIMER2_PIO2, &TIMER2_PIO3, &TIMER2_PIO4 };
uC_PERIPH_IO_STRUCT const* m_timer3_pio[uC_BASE_MAX_TIMER_CAP_COMP_CH] =
{ &TIMER3_PIO1, &TIMER3_PIO2, &TIMER3_PIO3, &TIMER3_PIO4 };
uC_PERIPH_IO_STRUCT const* m_timer4_pio[uC_BASE_MAX_TIMER_CAP_COMP_CH] =
...
const uC_BASE_TIMER_IO_STRUCT uC_Base_STM32F105::m_timer_io[uC_BASE_MAX_TIMER_CTRLS] =
{
 ...
 */
const uC_BASE_EXT_INT_IO_STRUCT uC_Base_STM32F105::m_ext_ints[uC_BASE_EXT_INT_MAX_INPUTS] =
{
	{
		EXTI0_IRQn,
		0x0001
...
const uC_BASE_ATOD_IO_STRUCT uC_Base_STM32F105::m_atod_io[uC_BASE_ATOD_MAX_CTRLS] =
{
	{
		ADC1,
		{
 ...
 */
const uC_BASE_DMA_IO_STRUCT uC_Base_STM32F105::m_dma_io[uC_BASE_DMA_CHANNEL_MAX] =
{
	{
		DMA1,
		DMA1_Channel1,
