 ...
 *****************************************************************************************
 */
#ifndef uC_Base_STM32F107_H
   #define uC_Base_STM32F107_H
 ...
 *  Class Declaration
   --------------------------------------------------------------------------------------------------
 */
class uC_Base_STM32F107 : public uC_Base
{
	public:
		uC_Base_STM32F107( void );
		~uC_Base_STM32F107( void );
	...
	private:
		...
		static const uint32_t m_pclock_freqs[uC_BASE_STM32F107_MAX_PCLKS];
