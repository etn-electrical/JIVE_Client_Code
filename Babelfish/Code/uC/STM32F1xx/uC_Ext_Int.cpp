 ...
 *****************************************************************************************
 */
#define uC_EXT_INT_5to9_CLR_MASK     0x03E0UL
#define uC_EXT_INT_10to15_CLR_MASK   0xFC00UL
	...
	m_ext_pio_ctrl( reinterpret_cast<uC_USER_IO_STRUCT const*>( nullptr ) )
{
	...
	{
		periph_def.pid = RCC_APB2RSTR_AFIORST;
	...
	AFIO->EXTICR[pio_ctrl->pio_num >> 0x02U] &=
