 ...
 *****************************************************************************************
 */
#ifndef uC_Base_STM32F100_H
   #define uC_Base_STM32F100_H
 ...
 *  Class Declaration
   --------------------------------------------------------------------------------------------------
 */
class uC_Base_STM32F100 : public uC_Base
{
	public:
		uC_Base_STM32F100( void );
		~uC_Base_STM32F100( void );
	...
	private:
		...
		static const uint32_t m_pclock_freqs[uC_BASE_STM32F100_MAX_PCLKS];
