...
class uC_Timers_HW
{
	public:
		...
		inline void Enable_CC_Int( void )               { uC_Interrupt::Enable_Int( m_tmr_ctrl->irq_num_cc ); }

		inline void Disable_CC_Int( void )          { uC_Interrupt::Disable_Int( m_tmr_ctrl->irq_num_cc ); }
