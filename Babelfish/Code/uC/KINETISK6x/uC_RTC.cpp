...
void uC_RTC::uC_RTC_Init( RTC_clock_source_t clk_src, RTC_format_t format )
{
	...
	m_RTC->CR &= static_cast<uint32_t>( ~( RTC_CR_FMT | RTC_CR_OSEL | RTC_CR_POL ) );
...
void uC_RTC::Set_Time( RTC_time_t* time )
{
	...
	tmpreg = ( ( static_cast<uint32_t>( time->hours ) << 16U )
	...
	m_RTC->TR = static_cast<uint32_t>( tmpreg & RTC_TR_RESERVED_MASK );
...
void uC_RTC::Set_Date( RTC_date_t* date )
{
	...
	datetmpreg = ( ( static_cast<uint32_t>( date->year ) << 16U ) |
	...
	m_RTC->DR = static_cast<uint32_t>( datetmpreg & RTC_DR_RESERVED_MASK );
...
void uC_RTC::Get_Time( RTC_time_t* time )
{
	...
	tmpreg = m_RTC->TR & RTC_TR_RESERVED_MASK;
...
void uC_RTC::Get_Date( RTC_date_t* date )
{
	...
	datetmpreg = m_RTC->DR & RTC_DR_RESERVED_MASK;
...
void uC_RTC::Convert_Time_To_BCDFormat( RTC_time_t* time )
{
	...
	time->subseconds = Byte_To_Bcd( time->subseconds );
}
...
void uC_RTC::Convert_Time_To_BinaryFormat( RTC_time_t* time )
{
	...
	time->subseconds = Bcd_To_Byte( time->subseconds );
}
