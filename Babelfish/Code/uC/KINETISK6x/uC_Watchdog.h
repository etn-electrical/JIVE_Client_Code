...
/*
 **************************************************************************************************
 *   uc_Watchdog class declaration     This class includes all the functions which will help in enabling the watchdog
 *timer.
   --------------------------------------------------------------------------------------------------
 */
class uC_Watchdog
{
	public:
		 ...
		 * @note       This constructor is used to assign the value returned by Get_ bone() to the variable m_bone.
		 */
		 ...
		 * @note        This function is used to set the timeout value for the downcounter which is used to trigger
		 *system reset.
		 */
		...
		/**
		 * @brief       This function is used to assign reload value 0xAAAA into key register of IWDG.
		 */
		...
		/**
		 * @brief      This function is used to set bits of the variable m_bones_thrown_mask by left shifting m_bone by
		 *1 .
		 *  @note       This is used to set bits of the variable m_dog_bones_returned_mask by left shifting m_bone .
		 */
