...
class uC_RTC
{
	public:
		...
		enum RTC_clock_source_t
		{
			...
			CLOCK_SOURCE_HSE///< High speed External crystal (supports 1 MHz to 31 MHz External crystal)
		};
	...
	private:
		 ...
		 *        Considers 1MHz HSE input(after divided by RCC_RTCCLKSource_HSE_Div) or 32.7 KHz LSE/LSI
		 */
		...
		static const uint32_t LSE_LSI_PRER_REG_PREDIV_A = static_cast<uint32_t>( 32U - 1 );
		static const uint32_t LSE_LSI_PRER_REG_PREDIV_S = static_cast<uint32_t>( 1024U - 1 );
