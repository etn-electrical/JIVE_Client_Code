...
#include "Includes.h"
#include "uC_DMA.h"
// #define DEBUG_RAM_TEST	// Define this to provide debug information to the host via Term_Print().
#include "uC_RAM.h"
	...
	: m_cr_update_task( reinterpret_cast<CR_Tasker*>( NULL ) )
{
	...
	m_volatile_item_last.start = &__ICFEDIT_region_RAM_end__ + 1U;
