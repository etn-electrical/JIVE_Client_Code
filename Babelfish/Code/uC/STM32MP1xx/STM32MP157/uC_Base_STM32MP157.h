 ...
 *****************************************************************************************
 */
#ifndef uC_Base_STM32MP157_H
   #define uC_Base_STM32MP157_H
 ...
 *  Class Declaration
   --------------------------------------------------------------------------------------------------
 */
class uC_Base_STM32MP157 : public uC_Base
{
	public:
		uC_Base_STM32MP157( void );
		~uC_Base_STM32MP157( void );
	...
	private:
		...
		static const uint32_t m_pclock_freqs[uC_BASE_STM32MP157_MAX_PCLKS];
