...
/*
 ********************************
 *  FMC SDRAM Control Definition Structure
    Only tested on F750 board to support External RAM
 */
typedef struct uC_BASE_FMC_SDRAM_IO_PORT_STRUCT
{
	const uC_PERIPH_IO_STRUCT* a0_pio;
	const uC_PERIPH_IO_STRUCT* a1_pio;
	const uC_PERIPH_IO_STRUCT* a2_pio;
	const uC_PERIPH_IO_STRUCT* a3_pio;
	const uC_PERIPH_IO_STRUCT* a4_pio;
	const uC_PERIPH_IO_STRUCT* a5_pio;
	const uC_PERIPH_IO_STRUCT* a6_pio;
	const uC_PERIPH_IO_STRUCT* a7_pio;
	const uC_PERIPH_IO_STRUCT* a8_pio;
	const uC_PERIPH_IO_STRUCT* a9_pio;
	const uC_PERIPH_IO_STRUCT* a10_pio;
	const uC_PERIPH_IO_STRUCT* a11_pio;
	const uC_PERIPH_IO_STRUCT* b0_pio;
	const uC_PERIPH_IO_STRUCT* b1_pio;
	const uC_PERIPH_IO_STRUCT* d0_pio;
	const uC_PERIPH_IO_STRUCT* d1_pio;
	const uC_PERIPH_IO_STRUCT* d2_pio;
	const uC_PERIPH_IO_STRUCT* d3_pio;
	const uC_PERIPH_IO_STRUCT* d4_pio;
	const uC_PERIPH_IO_STRUCT* d5_pio;
	const uC_PERIPH_IO_STRUCT* d6_pio;
	const uC_PERIPH_IO_STRUCT* d7_pio;
	const uC_PERIPH_IO_STRUCT* d8_pio;
	const uC_PERIPH_IO_STRUCT* d9_pio;
	const uC_PERIPH_IO_STRUCT* d10_pio;
	const uC_PERIPH_IO_STRUCT* d11_pio;
	const uC_PERIPH_IO_STRUCT* d12_pio;
	const uC_PERIPH_IO_STRUCT* d13_pio;
	const uC_PERIPH_IO_STRUCT* d14_pio;
	const uC_PERIPH_IO_STRUCT* d15_pio;
	const uC_PERIPH_IO_STRUCT* nbl0_pio;
	const uC_PERIPH_IO_STRUCT* nbl1_pio;
	const uC_PERIPH_IO_STRUCT* sdclk_pio;
	const uC_PERIPH_IO_STRUCT* sdnwe_pio;
	const uC_PERIPH_IO_STRUCT* sdnras_pio;
	const uC_PERIPH_IO_STRUCT* sdncas_pio;
	const uC_PERIPH_IO_STRUCT* sdcke0_pio;
	const uC_PERIPH_IO_STRUCT* sdne0_pio;
} uC_BASE_FMC_SDRAM_IO_PORT_STRUCT;

typedef struct uC_BASE_FMC_SDRAM_IO_STRUCT
{
	FMC_Bank5_6_TypeDef* reg_ctrl;
	PERIPH_DEF_ST periph_def;
	IRQn_Type irq_num;

	uC_BASE_FMC_SDRAM_IO_PORT_STRUCT const* default_port_io;
} uC_BASE_FMC_SDRAM_IO_STRUCT;
...
{
	IRQn_Type irq_num;
	uint16_t irq_assignment;		// This is a bitfield.  It equates to the vector associated with
									// the IRQn.
...
class uC_Base
{
	...
	public:
		...
		virtual uC_BASE_USB_IO_STRUCT const* Get_USB_Ctrl( uint8_t port ) {return ( nullptr );}

		virtual uC_BASE_SPI_IO_STRUCT const* Get_SPI_Ctrl( uint32_t spi_block ) = 0;

		virtual uC_BASE_FMC_SDRAM_IO_STRUCT const* Get_FMC_SDRAM_Ctrl( uint32_t fmc_sdram_block ) = 0;

		virtual uC_BASE_I2C_IO_STRUCT const* Get_I2C_Ctrl( uint32_t i2c_block ) = 0;

		virtual uC_BASE_EXT_INT_IO_STRUCT const* Get_Ext_Int_Ctrl( uC_USER_IO_STRUCT const* pio_ctrl )
		= 0;
