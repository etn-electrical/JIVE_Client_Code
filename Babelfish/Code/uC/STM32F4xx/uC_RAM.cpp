	...
	: m_cr_update_task( reinterpret_cast<CR_Tasker*>( NULL ) )
{
	...
	m_volatile_item_post_ccm.end -= 1U;		// start of system SRAM - 1 [Separate statements to avoid a PC-lint warning
											// (428).]
	...
	m_volatile_item_last.start = &__ICFEDIT_region_RAM_end__;	// end of system SRAM + 1
	m_volatile_item_last.start += 1U;
