 ...
 *****************************************************************************************
 */
#ifndef uC_Base_STM32F411_H
   #define uC_Base_STM32F411_H
 ...
 *  Class Declaration
   --------------------------------------------------------------------------------------------------
 */
class uC_Base_STM32F411 : public uC_Base
{
	public:
		uC_Base_STM32F411( void );
		~uC_Base_STM32F411( void );
	...
	private:
		...
		static const uint32_t m_pclock_freqs[uC_BASE_STM32F411_MAX_PCLKS];
