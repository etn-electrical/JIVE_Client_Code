 ...
 *****************************************************************************************
 */
#ifndef uC_Base_STM32F427_H
   #define uC_Base_STM32F427_H
 ...
 *  Class Declaration
   --------------------------------------------------------------------------------------------------
 */
class uC_Base_STM32F427 : public uC_Base
{
	public:
		uC_Base_STM32F427( void );
		~uC_Base_STM32F427( void );
	...
	private:
		...
		static const uint32_t m_pclock_freqs[uC_BASE_STM32F427_MAX_PCLKS];
