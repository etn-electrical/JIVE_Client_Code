...
/**
 *****************************************************************************************
 * @brief    The STM32F427 micro controller specific class for IEEE 1588 (PTP).
...
class uC_PTP_Slave
{
	...
	private:
		...
		/**
		 * @brief      -  Enable or disable enhanced descriptor structure
		 * @param state - Enable or disable
		 *
		 */
#ifdef USE_ENHANCED_DMA_DESCRIPTORS
		void Enhanced_Descriptor_Cmd( FunctionalState state );
