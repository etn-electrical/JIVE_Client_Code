...
/*
 ********************************
 *  Configure Input channel of Timer Structure
 */
typedef struct uC_PERIPH_TIM_CAPTURE_STRUCT
{
...
/*
 ********************************
 *  Initialize Timer Base Structure
 */
typedef struct uC_PERIPH_TIM_CONFIG_STRUCT
{
