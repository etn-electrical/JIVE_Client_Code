 ...
 *****************************************************************************************
 */
STM32F4xx_USART_SPI::STM32F4xx_USART_SPI( uint8_t hw_usart_num, uint8_t total_chip_sel,
	...
	m_exchange_length( 0U )
{
	...
	if ( ( master == false ) || ( m_usart_periph_ctrl == reinterpret_cast<uC_BASE_USART_IO_STRUCT const*>( nullptr ) ) )
	{
		BF_ASSERT(false);		// We currently don't support slave mode.  It might be
		// tricky.  See datasheet.
	}
	else
	{
 ...
 *****************************************************************************************
 */
STM32F4xx_USART_SPI::~STM32F4xx_USART_SPI( void )
{
 ...
 *****************************************************************************************
 */
void STM32F4xx_USART_SPI::Start_Exchange( bool new_exchange )
{
	volatile uint16_t data_dump;
 ...
 *****************************************************************************************
 */
void STM32F4xx_USART_SPI::DMA_ISR( void )
{
	bool failure = false;
 ...
 *****************************************************************************************
 */
void STM32F4xx_USART_SPI::ISR( void )
{
 ...
 *****************************************************************************************
 */
void STM32F4xx_USART_SPI::Assume_IO_Control( uC_BASE_USART_IO_PORT_STRUCT const* usart_pio,
 ...
 *****************************************************************************************
 */
void STM32F4xx_USART_SPI::Initialize_Peripheral_Clock( const PERIPH_DEF_ST* periph_def ) const
{
 ...
 *****************************************************************************************
 */
void STM32F4xx_USART_SPI::SPI_Chip_Configuration( spi_mode mode, uint32_t chip_clock_freq,
