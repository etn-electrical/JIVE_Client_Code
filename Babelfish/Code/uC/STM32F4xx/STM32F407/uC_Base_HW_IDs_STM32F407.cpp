...
const uint32_t uC_Base_STM32F407::m_pclock_freqs[uC_BASE_STM32F407_MAX_PCLKS] =
{
 ...
 */
const uC_BASE_PIO_CTRL_STRUCT uC_Base_STM32F407::m_pio_ctrls[uC_BASE_MAX_PIO_CTRLS] =
{
	{
		GPIOA,
		{
...
const uC_BASE_USB_IO_STRUCT uC_Base_STM32F407::m_usb_io[uC_BASE_MAX_USB_PORTS] =
{
	{
		{
...
const uC_BASE_USART_IO_STRUCT uC_Base_STM32F407::m_usart_io[uC_BASE_MAX_USART_PORTS] =
{
	{
		USART1,
		{
...
const uC_BASE_SPI_IO_STRUCT uC_Base_STM32F407::m_spi_io[uC_BASE_SPI_MAX_CTRLS] =
{
	{
		SPI1,
		{
...
uC_BASE_I2C_INT_OBJ_CBACK_FUNC* uC_Base_STM32F407::m_obj_func_i2c_dma_list_Tx[uC_BASE_I2C_MAX_CTRLS];
// Stores the function pointer of the objects static interrupt handler.
uC_BASE_I2C_INT_OBJ_CBACK_FUNC* uC_Base_STM32F407::m_obj_func_i2c_dma_list_Rx[uC_BASE_I2C_MAX_CTRLS];
// Stores the object pointer associated with the interrupt.
uC_BASE_I2C_OBJ_PARAM_TD uC_Base_STM32F407::m_obj_i2c_dma_list_Tx[uC_BASE_I2C_MAX_CTRLS];
// Stores the object pointer associated with the interrupt.
uC_BASE_I2C_OBJ_PARAM_TD uC_Base_STM32F407::m_obj_i2c_dma_list_Rx[uC_BASE_I2C_MAX_CTRLS];

// Stores the function pointer of the objects static interrupt handler.
uC_BASE_I2C_INT_OBJ_CBACK_FUNC* uC_Base_STM32F407::m_obj_func_i2c_list[uC_BASE_I2C_MAX_CTRLS];
// Stores the object pointer associated with the interrupt.
uC_BASE_I2C_OBJ_PARAM_TD uC_Base_STM32F407::m_obj_i2c_list[uC_BASE_I2C_MAX_CTRLS];

void uC_Base_STM32F407::uC_BASE_I2C_DMA_INT1_Tx( void )
{
	( *m_obj_func_i2c_dma_list_Tx[0] )( m_obj_i2c_dma_list_Tx[0] );
}

void uC_Base_STM32F407::uC_BASE_I2C_DMA_INT2_Tx( void )
{
	( *m_obj_func_i2c_dma_list_Tx[1] )( m_obj_i2c_dma_list_Tx[1] );
}

void uC_Base_STM32F407::uC_BASE_I2C_DMA_INT3_Tx( void )
{
	( *m_obj_func_i2c_dma_list_Tx[2] )( m_obj_i2c_dma_list_Tx[2] );
}

void uC_Base_STM32F407::uC_BASE_I2C_DMA_INT1_Rx( void )
{
	( *m_obj_func_i2c_dma_list_Rx[0] )( m_obj_i2c_dma_list_Rx[0] );
}

void uC_Base_STM32F407::uC_BASE_I2C_DMA_INT2_Rx( void )
{
	( *m_obj_func_i2c_dma_list_Rx[1] )( m_obj_i2c_dma_list_Rx[1] );
}

void uC_Base_STM32F407::uC_BASE_I2C_DMA_INT3_Rx( void )
{
	( *m_obj_func_i2c_dma_list_Rx[2] )( m_obj_i2c_dma_list_Rx[2] );
}

void uC_Base_STM32F407::uC_BASE_I2C_INT1( void )    { ( *m_obj_func_i2c_list[0] )( m_obj_i2c_list[0] ); }

void uC_Base_STM32F407::uC_BASE_I2C_INT2( void )    { ( *m_obj_func_i2c_list[1] )( m_obj_i2c_list[1] ); }

void uC_Base_STM32F407::uC_BASE_I2C_INT3( void )    { ( *m_obj_func_i2c_list[2] )( m_obj_i2c_list[2] ); }


const uC_BASE_I2C_IO_STRUCT uC_Base_STM32F407::m_i2c_io[uC_BASE_I2C_MAX_CTRLS] =
{
	{
		I2C1,
		{
...
const uC_BASE_TIMER_IO_STRUCT uC_Base_STM32F407::m_timer_io[uC_BASE_MAX_TIMER_CTRLS] =
{
 ...
 */
const uC_BASE_EXT_INT_IO_STRUCT uC_Base_STM32F407::m_ext_ints[uC_BASE_EXT_INT_MAX_INPUTS] =
{
	{
		EXTI0_IRQn,
		0x0001
...
const uC_BASE_ATOD_IO_STRUCT uC_Base_STM32F407::m_atod_io[uC_BASE_ATOD_MAX_CTRLS] =
{
	{
		ADC1,
		{
 ...
 */
const uC_BASE_DMA_IO_STRUCT uC_Base_STM32F407::m_dma_io[uC_BASE_DMA_STREAM_MAX] =
{
	{
		DMA1,
		DMA1_Stream0,
...
const uC_BASE_EMAC_IO_STRUCT uC_Base_STM32F407::m_emac_io[uC_BASE_EMAC_MAX_CTRLS] =
{
	{
		ETH,
		{
...
const uC_BASE_CAN_IO_STRUCT uC_Base_STM32F407::m_can_io[uC_BASE_CAN_MAX_CTRLS] =
{
	{
		CAN1,
		{
