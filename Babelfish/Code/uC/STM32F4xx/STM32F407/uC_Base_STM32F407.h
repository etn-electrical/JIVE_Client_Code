 ...
 *****************************************************************************************
 */
#ifndef uC_Base_STM32F407_H
   #define uC_Base_STM32F407_H
 ...
 *  Class Declaration
   --------------------------------------------------------------------------------------------------
 */
class uC_Base_STM32F407 : public uC_Base
{
	public:
		uC_Base_STM32F407( void );
		~uC_Base_STM32F407( void );
	...
	private:
		...
		static const uint32_t m_pclock_freqs[uC_BASE_STM32F407_MAX_PCLKS];
