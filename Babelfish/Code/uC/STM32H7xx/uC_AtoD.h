...
typedef enum uC_ATOD_RESOLUTION_ENUM
{
	...
	/** @brief AtoD conversion with 14 bit resolution */
	uC_ATOD_14BIT_RESOLUTION,
	/** @brief AtoD conversion with 16 bit resolution */
	uC_ATOD_16BIT_RESOLUTION,
...
#define ADC_CR_BITS_PROPERTY_RS     ( ADC_CR_ADCAL | ADC_CR_JADSTP | ADC_CR_ADSTP | ADC_CR_JADSTART | \
...
class uC_AtoD
{
	...
	public:
		...
		/**
		 * @brief                   Destructor to delete the uc_AtoD instance when it goes out of
		 * scope
		 * @param[in] void          none
		 * @return
		 */
	...
	private:
		...
		/**
		 * @brief                   This function dumps ADC regular data register value into local
		 * variable
		 * @param[in] void          none
		 * @return
		 */
