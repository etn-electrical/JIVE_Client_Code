	...
	, public uC_USART_Buff
{
	...
	private:
		...
		{
			( ( uC_USART_DMA* )handle )->RX_Timer_Int();
		}
		...
		{
			( ( uC_USART_DMA* )handle )->TX_Timer_Int();
		}
		...
		{
			( ( uC_USART_DMA* )handle )->RX_DMA_Int();
		}
		...
		{
			( ( uC_USART_DMA* )handle )->TX_DMA_Int();
		}
