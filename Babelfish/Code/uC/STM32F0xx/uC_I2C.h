...
class uC_I2C
{
	...
	public:
		...
		uC_I2C( uint8_t channel, uint16_t device_address, i2c_mode_t speed_mode =
				I2C_STANDARD_MODE, address_type_t addr_mode = ADDRESS_10_BIT,
				bool_t synchronus_trnasfer = true, bool_t enable_dma = false,
				uC_BASE_I2C_IO_PORT_STRUCT const* io_port = nullptr );
	...
	private:
		...
		// return_type I2C_WaitOnTXISFlagUntilTimeout(I2C_HandleTypeDef *hi2c, uint32_t Timeout,
		// uint32_t Tickstart)
		/** @brief Receives data from an I2C slave */
