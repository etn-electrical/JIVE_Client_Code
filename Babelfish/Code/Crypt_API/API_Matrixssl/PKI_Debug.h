...
#if BF_PKI_DBG
	#define PKI_DBG_PRINT  BF_DBG_ON
#else
	#define PKI_DBG_PRINT  BF_DBG_OFF
#endif
 ...
 */
#ifndef PKI_ENABLE_MASK
	#define PKI_ENABLE_MASK     DEBUG_MASK( PKI_DBG_PRINT )
#endif

/**
 * Macro to print PKI specific debug prints
 ...
 */
#define PKI_DEBUG_PRINT( MessageType, ... )     BF_DEBUG_PRINT( PKI_ENABLE_MASK, MessageType, __VA_ARGS__ )

#endif	// #ifndef PKI_DEBUG_H