 ...
 *****************************************************************************************
 */
IEC61850_SAV_DCI::IEC61850_SAV_DCI( const sav_message_info_t* sav_message_info,
									DCI_SOURCE_ID_TD unique_id ) :
	m_source_id( unique_id ),
	m_dci_access( new DCI_Patron( false ) ),
	m_sav_message_info( sav_message_info )
{
 ...
 *****************************************************************************************
 */
IEC61850_SAV_DCI::~IEC61850_SAV_DCI( void )
{
	delete m_dci_access;
 ...
 *****************************************************************************************
 */
DCI_ERROR_TD IEC61850_SAV_DCI::Get_Dcid_Data( DCI_ID_TD dcid, DCI_LENGTH_TD* length_ptr,
 ...
 *****************************************************************************************
 */
DCI_ERROR_TD IEC61850_SAV_DCI::Set_Dcid_Data( DCI_ID_TD dcid, DCI_LENGTH_TD length, uint8_t* src_data_ptr )
{
	DCI_ERROR_TD dci_error = DCI_ERR_NO_ERROR;
	DCI_ACCESS_ST_TD access_struct;
 ...
 *****************************************************************************************
 */
iec61850_error_t IEC61850_SAV_DCI::Get_Group_Id_Details( DCI_ID_TD dcid, group_param_t* group_id,
														 ...
														 uint8_t message_type )
{
	...
	const sav_group_info_t* search_struct = nullptr;
	sub_group_param_t index;
	iec61850_error_t return_type = IEC61850_ERR_NO_ERROR;

	*sub_group_id = IEC61850_SAV_INVALID_SUBGROUP_ID;
	if ( message_type == PUBLISH )
	{
		search_struct = m_sav_message_info->pub_group_profile;
	}
	else if ( message_type == SUBSCRIBE )
	{
		search_struct = m_sav_message_info->sub_group_profile;
	}
	else
	{
 ...
 *****************************************************************************************
 */
iec61850_error_t IEC61850_SAV_DCI::Get_Group_Assembly_Parameters( group_param_t group_id, DCI_LENGTH_TD* length_ptr,
																  uint8_t* dest_data_ptr, uint8_t message_type )
{
	DCI_ERROR_TD dci_error = DCI_ERR_INVALID_DATA_ID;
	uint16_t length = DISABLE_VALUE;
	const sav_group_info_t* search_struct;
 ...
 *****************************************************************************************
 */
iec61850_error_t IEC61850_SAV_DCI::Get_Subgroup_Assembly_Parameters( group_param_t group_id,
																	 sub_group_param_t sub_group_id,
 ...
 *****************************************************************************************
 */
iec61850_error_t IEC61850_SAV_DCI::Set_SubGroup_Assembly_Parameters( group_param_t group_id,
																	 sub_group_param_t sub_group_id,
 ...
 *****************************************************************************************
 */
iec61850_error_t IEC61850_SAV_DCI::Get_Subgroup_Param_Length( group_param_t group_id,
															  sub_group_param_t sub_group_id, DCI_LENGTH_TD* length_ptr,
															  uint8_t message_type )
{
	DCI_ERROR_TD dci_error = DCI_ERR_INVALID_DATA_ID;
	uint16_t length = DISABLE_VALUE;
 ...
 *****************************************************************************************
 */
iec61850_error_t IEC61850_SAV_DCI::Get_Maingroup_Params_Length( group_param_t group_id, DCI_LENGTH_TD* length_ptr,
																uint8_t message_type )
{
	DCI_ERROR_TD dci_error = DCI_ERR_INVALID_DATA_ID;
	uint16_t length = DISABLE_VALUE;
