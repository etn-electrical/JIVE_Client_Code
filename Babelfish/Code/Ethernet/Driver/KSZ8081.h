/**
 **********************************************************************************************
 * @file            KSZ8081 Header File for driver class.
 *
...
class KSZ8081 : public PHY_Driver
{
	public:
		/**
		 ...
		 * @n
		 */
		KSZ8081( BF_Lib::Output* reset_ctrl, EMAC_Driver* emac_ctrl, bool_t switch_enable, bool_t alr_learn,
				 uint8_t PhyAddr );
