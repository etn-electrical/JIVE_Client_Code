 ...
 *****************************************************************************************
 */
#ifndef SST26VF_BLOCK_H
#define SST26VF_BLOCK_H
...
struct SST26VF_BLOCK_CHIP_CONFIG_TD
{
 ...
 ****************************************************************************************
 */
class SST26VF_Block : public NV_Ctrl
{
	public:
		 ...
		 * @return None
		 */
		SST26VF_Block( uC_SPI* spi_ctrl, uint8_t chip_select, SST26VF_BLOCK_CHIP_CONFIG_TD const* chip_config );
	...
	private:
		...
		SST26VF_BLOCK_CHIP_CONFIG_TD const* m_chip_cfg;	// chip configuration
