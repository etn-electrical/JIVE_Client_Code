 ...
 *****************************************************************************************
 */
#ifndef uC_Base_STM32F373_H
   #define uC_Base_STM32F373_H
 ...
 *  Class Declaration
   --------------------------------------------------------------------------------------------------
 */
class uC_Base_STM32F373 : public uC_Base
{
	public:
		uC_Base_STM32F373( void );
		~uC_Base_STM32F373( void );
	...
	private:
		...
		static const uint32_t m_pclock_freqs[uC_BASE_STM32F373_MAX_PCLKS];
