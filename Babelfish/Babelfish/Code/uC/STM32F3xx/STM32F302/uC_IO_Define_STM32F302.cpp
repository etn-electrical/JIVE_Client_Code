...
/*Timer 6 do not have Capture compare channels*/
const uC_PERIPH_IO_STRUCT TIMER6_PIO1_UNS =
{ static_cast<GPIO_TypeDef*>( NULL ), static_cast<uint8_t>( IO_PIN_UNDEFINED ),
  static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_UNSUPPORTED ) };
const uC_PERIPH_IO_STRUCT TIMER6_PIO2_UNS =
{ static_cast<GPIO_TypeDef*>( NULL ), static_cast<uint8_t>( IO_PIN_UNDEFINED ),
  static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_UNSUPPORTED ) };
const uC_PERIPH_IO_STRUCT TIMER6_PIO3_UNS =
{ static_cast<GPIO_TypeDef*>( NULL ), static_cast<uint8_t>( IO_PIN_UNDEFINED ),
  static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_UNSUPPORTED ) };
const uC_PERIPH_IO_STRUCT TIMER6_PIO4_UNS =
{ static_cast<GPIO_TypeDef*>( NULL ), static_cast<uint8_t>( IO_PIN_UNDEFINED ),
  static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_UNSUPPORTED ) };
...
{ GPIOF, static_cast<uint8_t>( IO_PIN_2 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_ANALOG ) };
const uC_PERIPH_IO_STRUCT ADC12_IN14_PIO =
{ GPIOB, static_cast<uint8_t>( IO_PIN_11 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_ANALOG ) };

/* ADC channels undefined in pin functions */
...
const uC_PERIPH_IO_STRUCT ADC2_IN1_PIO =
 ...
 *		CAN Peripheral
 */
const uC_PERIPH_IO_STRUCT CAN_RX_PIO_PA11 = { GPIOA, IO_PIN_11, uC_IO_ALTERNATE_MAP_9 };
const uC_PERIPH_IO_STRUCT CAN_TX_PIO_PA12 = { GPIOA, IO_PIN_12, uC_IO_ALTERNATE_MAP_9 };

// const uC_PERIPH_IO_STRUCT 	CAN_RX_PIO_PD0    = { GPIOD, IO_PIN_0, uC_IO_ALTERNATE_MAP_7 };
// const uC_PERIPH_IO_STRUCT 	CAN_TX_PIO_PD1    = { GPIOD, IO_PIN_1, uC_IO_ALTERNATE_MAP_7 };
