/**
 *****************************************************************************************
 *	@file STM32F3xx_SPI.h
 *
 *	@brief Specialized Queued SPI class for the STM32F3xx architecture
 *
 *	@details
 *
 ...
 *****************************************************************************************
 */
#ifndef STM32F3xx_SPI_H
#define STM32F3xx_SPI_H
...
/**
 ****************************************************************************************
 * @brief STM32F3xx_SPI class
 *
 * @details Realizes Queued SPI interface for the STM32F3xx architecture
 *
 ****************************************************************************************
 */
class STM32F3xx_SPI : public uC_Queued_SPI
{
	public:

		/**
		 * @brief                  Constructs a STM32F3xx_SPI object.
		 ...
		 */
		STM32F3xx_SPI( uint8_t channel, uint8_t no_slaves, bool_t master,
					   uC_BASE_SPI_IO_PORT_STRUCT const* io_ctrl, uC_USER_IO_STRUCT const* const pio[] );

		/** @brief Destructor to delete an instance of STM32F3xx_SPI class */
		~STM32F3xx_SPI( void );
	...
	protected:
		 ...
		 * @param[in] object - pointer to STM32F3xx object call back is itended for.
		 */
		static void DMA_ISR_Static( void* object )
		{
			static_cast<STM32F3xx_SPI*>( object )->DMA_ISR();
		}
		...
		{
			static_cast<STM32F3xx_SPI*>( object )->SPI_ISR();
		}
