/**
 **********************************************************************************************
 *  @file           STM32F3xx_I2C.cpp C++ Implementation File for Queued I2C derived class.
 *
 *  @brief          The file shall include the definitions of all the functions described in
 *                  STM32F3xx_I2C.h file.
 *  @details
 ...
 *****************************************************************************************
 */
STM32F3xx_I2C::STM32F3xx_I2C( class_config_t const* i2c_assy,
	...
	uC_Queued_I2C()
{
	...
	uC_Interrupt::Set_Vector( static_cast<Advanced_Vect::int_cback_t>
							  ( m_i2c_vector_obj->Get_Int_Func() ),
 ...
 *****************************************************************************************
 */
STM32F3xx_I2C::~STM32F3xx_I2C( void )
{
	uC_Interrupt::Clear_Vector( m_i2c_vector_number );
 ...
 *****************************************************************************************
 */
void STM32F3xx_I2C::Start_Exchange( bool_t new_exchange )
{
 ...
 *****************************************************************************************
 */
void STM32F3xx_I2C::DMA_TX_ISR( void )
{
	bool_t failure;
 ...
 *****************************************************************************************
 */
void STM32F3xx_I2C::DMA_RX_ISR( void )
{
	bool_t failure;
 ...
 *****************************************************************************************
 */
void STM32F3xx_I2C::I2C_ISR( void )
{
 ...
 *****************************************************************************************
 */
void STM32F3xx_I2C::Assume_IO_Control( const uC_BASE_I2C_IO_PORT_STRUCT* i2c_io ) const
{
 ...
 *****************************************************************************************
 */
void STM32F3xx_I2C::Initialize_Peripheral_Clock( const PERIPH_DEF_ST* periph_def ) const
{
 ...
 *****************************************************************************************
 */
bool_t STM32F3xx_I2C::Clear_DMA_Interrupts()
{
 ...
 *****************************************************************************************
 */
void STM32F3xx_I2C::select_config_t::Configure( i2c_speed_mode_t i2c_mode,
												...
												uint16_t byte_count_theshold )
{
	...
	if ( I2C_FAST_SPEED == i2c_mode )
	{
		if ( DUTYCYCLE_FASTMODE_2 == fmode_duty_cycle )
		{
			i2c_ccr_value = static_cast<uint16_t>
				( i2c_pclk1_freq / ( I2C_ClockSpeed_400KHz * 3U ) );
			fast_mode_duty = static_cast<uint16_t>( 0x8000U );
		}
		else/* FASTMODE_DUTYCYCLE_16_9 */
		{
			i2c_ccr_value = static_cast<uint16_t>
				( i2c_pclk1_freq / ( I2C_ClockSpeed_400KHz * 25U ) );
	...
	{
		i2c_ccr_value = static_cast<uint16_t>
			( ( i2c_pclk1_freq ) / ( I2C_ClockSpeed_100KHz << 1U ) );
		if ( i2c_ccr_value < 4U )
		{
			/* Set minimum allowed value */
			i2c_ccr_value = 4U;
 ...
 *****************************************************************************************
 */
void STM32F3xx_I2C::Generate_Start( void )
{
 ...
 *****************************************************************************************
 */
void STM32F3xx_I2C::Set_Stop( void )
{
	m_i2c->CR1 &= ( ~I2C_CR1_ACK );
 ...
 *****************************************************************************************
 */
uint16_t STM32F3xx_I2C::Get_SR1( void ) const
{
	return ( m_i2c->SR1 );
}
 ...
 *****************************************************************************************
 */
uint16_t STM32F3xx_I2C::Get_SR2( void ) const
{
	return ( m_i2c->SR2 );
}
 ...
 *****************************************************************************************
 */
void STM32F3xx_I2C::Wait_Flag_Timeout( uint32_t flag_mask ) const
{
 ...
 *****************************************************************************************
 */
void STM32F3xx_I2C::Bus_Busy_TimeOut( void )
{
