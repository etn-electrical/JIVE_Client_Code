				  ...
				  uint32_t tick_frequency_in_hertz, uint8_t tick_interrupt_priority )
{
	 ...
	 * @n PCLint: Note 1924: Violates MISRA C++ 2008 Required Rule 5-2-4, C-style casts and notation casts shall not be
	 * used
	 * @n Justification: The ST supplied includes are written for both C and C++ therefore C-style casts are required
	 * for all headers used
	 ...
	 * @n PCLint: Note 1924: Violates MISRA C++ 2008 Required Rule 5-0-4, Implicit integral conversions shall not change
	 ...
	 */
	/*lint -e{1960}  */
	SysTick->LOAD = ( static_cast<uint32_t>( SYSTICK_CLOCK_FREQ ) / tick_frequency_in_hertz ) - 1U;
}
