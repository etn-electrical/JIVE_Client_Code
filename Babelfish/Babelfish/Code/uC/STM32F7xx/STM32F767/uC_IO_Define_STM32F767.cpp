...
#define PIOJ_PIN_NUM_0        IO_PIN_0
...
const uC_PERIPH_IO_STRUCT USART1_TX_PIO_PB14 =
{ GPIOB, static_cast<uint8_t>( IO_PIN_14 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_4 ) };
const uC_PERIPH_IO_STRUCT USART1_RX_PIO_PB15 =
{ GPIOB, static_cast<uint8_t>( IO_PIN_15 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_4 ) };
...
const uC_PERIPH_IO_STRUCT UART4_TX_PIO_PA0 =
{ GPIOA, static_cast<uint8_t>( IO_PIN_0 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_8 ) };
const uC_PERIPH_IO_STRUCT UART4_RX_PIO_PA1 =
{ GPIOA, static_cast<uint8_t>( IO_PIN_1 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_8 ) };
const uC_PERIPH_IO_STRUCT UART4_RX_PIO_PA11 =
{ GPIOA, static_cast<uint8_t>( IO_PIN_11 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_6 ) };
const uC_PERIPH_IO_STRUCT UART4_TX_PIO_PA12 =
{ GPIOA, static_cast<uint8_t>( IO_PIN_12 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_6 ) };
const uC_PERIPH_IO_STRUCT UART4_TX_PIO_PC10 =
{ GPIOC, static_cast<uint8_t>( IO_PIN_10 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_8 ) };
const uC_PERIPH_IO_STRUCT UART4_RX_PIO_PC11 =
{ GPIOC, static_cast<uint8_t>( IO_PIN_11 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_8 ) };
const uC_PERIPH_IO_STRUCT UART4_RX_PIO_PD0 =
{ GPIOD, static_cast<uint8_t>( IO_PIN_0 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_8 ) };
const uC_PERIPH_IO_STRUCT UART4_TX_PIO_PD1 =
{ GPIOD, static_cast<uint8_t>( IO_PIN_1 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_8 ) };
const uC_PERIPH_IO_STRUCT UART4_TX_PIO_PH13 =
{ GPIOH, static_cast<uint8_t>( IO_PIN_13 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_8 ) };
const uC_PERIPH_IO_STRUCT UART4_RX_PIO_PH14 =
{ GPIOH, static_cast<uint8_t>( IO_PIN_14 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_8 ) };
const uC_PERIPH_IO_STRUCT UART4_RX_PIO_PI9 =
{ GPIOI, static_cast<uint8_t>( IO_PIN_9 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_8 ) };


const uC_PERIPH_IO_STRUCT UART5_RX_PIO_PB5 =
{ GPIOB, static_cast<uint8_t>( IO_PIN_5 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_1 ) };
const uC_PERIPH_IO_STRUCT UART5_TX_PIO_PB6 =
{ GPIOB, static_cast<uint8_t>( IO_PIN_6 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_1 ) };
const uC_PERIPH_IO_STRUCT UART5_RX_PIO_PB8 =
{ GPIOB, static_cast<uint8_t>( IO_PIN_8 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_7 ) };
const uC_PERIPH_IO_STRUCT UART5_TX_PIO_PB9 =
{ GPIOB, static_cast<uint8_t>( IO_PIN_9 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_7 ) };
const uC_PERIPH_IO_STRUCT UART5_RX_PIO_PB12 =
{ GPIOD, static_cast<uint8_t>( IO_PIN_12 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_8 ) };
const uC_PERIPH_IO_STRUCT UART5_TX_PIO_PB13 =
{ GPIOB, static_cast<uint8_t>( IO_PIN_13 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_8 ) };
const uC_PERIPH_IO_STRUCT UART5_TX_PIO_PC12 =
{ GPIOC, static_cast<uint8_t>( IO_PIN_12 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_8 ) };
const uC_PERIPH_IO_STRUCT UART5_RX_PIO_PD2 =
...
const uC_PERIPH_IO_STRUCT UART7_RX_PIO_PA8 =
{ GPIOA, static_cast<uint8_t>( IO_PIN_8 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_12 ) };
const uC_PERIPH_IO_STRUCT UART7_TX_PIO_PA15 =
{ GPIOA, static_cast<uint8_t>( IO_PIN_15 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_12 ) };
const uC_PERIPH_IO_STRUCT UART7_RX_PIO_PB3 =
{ GPIOB, static_cast<uint8_t>( IO_PIN_3 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_12 ) };
const uC_PERIPH_IO_STRUCT UART7_TX_PIO_PB4 =
{ GPIOB, static_cast<uint8_t>( IO_PIN_4 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_12 ) };
const uC_PERIPH_IO_STRUCT UART7_RX_PIO_PF6 =
{ GPIOF, static_cast<uint8_t>( IO_PIN_6 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_8 ) };
const uC_PERIPH_IO_STRUCT UART7_TX_PIO_PF7 =
{ GPIOF, static_cast<uint8_t>( IO_PIN_7 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_8 ) };
const uC_PERIPH_IO_STRUCT UART7_RX_PIO_PE7 =
{ GPIOE, static_cast<uint8_t>( IO_PIN_7 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_8 ) };
const uC_PERIPH_IO_STRUCT UART7_TX_PIO_PE8 =
{ GPIOE, static_cast<uint8_t>( IO_PIN_8 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_8 ) };


const uC_PERIPH_IO_STRUCT UART8_RX_PIO_PE0 =
{ GPIOE, static_cast<uint8_t>( IO_PIN_0 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_8 ) };
const uC_PERIPH_IO_STRUCT UART8_TX_PIO_PE1 =
...
const uC_PERIPH_IO_STRUCT SPI1_SS_PIO_PG10 =
{ GPIOG, static_cast<uint8_t>( IO_PIN_10 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_5 ) };
const uC_PERIPH_IO_STRUCT SPI1_CLOCK_PIO_PG11 =
{ GPIOG, static_cast<uint8_t>( IO_PIN_11 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_5 ) };
const uC_PERIPH_IO_STRUCT SPI1_MISO_PIO_PG9 =
{ GPIOG, static_cast<uint8_t>( IO_PIN_9 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_5 ) };
const uC_PERIPH_IO_STRUCT SPI1_MOSI_PIO_PD7 =
{ GPIOD, static_cast<uint8_t>( IO_PIN_7 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_5 ) };

const uC_PERIPH_IO_STRUCT SPI2_CLOCK_PIO_PA9 =
...
const uC_PERIPH_IO_STRUCT SPI2_CLOCK_PIO_PA12 =
...
const uC_PERIPH_IO_STRUCT SPI2_SS_PIO_PB4 =
...
const uC_PERIPH_IO_STRUCT SPI2_MOSI_PIO_PC1 =
{ GPIOC, static_cast<uint8_t>( IO_PIN_1 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_5 ) };
...
const uC_PERIPH_IO_STRUCT SPI2_SS_PIO_PI0 =
{ GPIOI, static_cast<uint8_t>( IO_PIN_0 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_5 ) };
...
const uC_PERIPH_IO_STRUCT SPI3_MOSI_PIO_PB2 =
{ GPIOB, static_cast<uint8_t>( IO_PIN_2 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_7 ) };
...
const uC_PERIPH_IO_STRUCT SPI3_MOSI_PIO_PD6 =
...
const uC_PERIPH_IO_STRUCT SPI4_SS_PIO_PE4 =
{ GPIOE, static_cast<uint8_t>( IO_PIN_4 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_5 ) };
...
const uC_PERIPH_IO_STRUCT SPI6_SS_PIO_PA4 =
{ GPIOA, static_cast<uint8_t>( IO_PIN_4 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_8 ) };
const uC_PERIPH_IO_STRUCT SPI6_CLOCK_PIO_PA5 =
{ GPIOA, static_cast<uint8_t>( IO_PIN_5 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_8 ) };
const uC_PERIPH_IO_STRUCT SPI6_MISO_PIO_PA6 =
{ GPIOA, static_cast<uint8_t>( IO_PIN_6 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_8 ) };
const uC_PERIPH_IO_STRUCT SPI6_MOSI_PIO_PA7 =
{ GPIOA, static_cast<uint8_t>( IO_PIN_7 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_8 ) };
const uC_PERIPH_IO_STRUCT SPI6_SS_PIO_PA15 =
{ GPIOA, static_cast<uint8_t>( IO_PIN_15 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_7 ) };
const uC_PERIPH_IO_STRUCT SPI6_CLOCK_PIO_PB3 =
{ GPIOB, static_cast<uint8_t>( IO_PIN_3 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_8 ) };
const uC_PERIPH_IO_STRUCT SPI6_MISO_PIO_PB4 =
{ GPIOB, static_cast<uint8_t>( IO_PIN_4 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_8 ) };
const uC_PERIPH_IO_STRUCT SPI6_MOSI_PIO_PB5 =
{ GPIOB, static_cast<uint8_t>( IO_PIN_5 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_8 ) };
...
// Alternate GPIO Pins available for I2C operation if needed can be enabled and used

// const uC_PERIPH_IO_STRUCT I2C1_SCL_PIO_PB10 =
// { GPIOB, static_cast<uint8_t>( IO_PIN_10 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_4 ) };
// const uC_PERIPH_IO_STRUCT I2C1_SDA_PIO_PB11 =
// { GPIOB, static_cast<uint8_t>( IO_PIN_11 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_4 ) };
...
const uC_PERIPH_IO_STRUCT I2C4_SCL_PIO_PD12 =
{ GPIOD, static_cast<uint8_t>( IO_PIN_12 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_4 ) };
const uC_PERIPH_IO_STRUCT I2C4_SDA_PIO_PD13 =
{ GPIOD, static_cast<uint8_t>( IO_PIN_13 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_4 ) };

const uC_PERIPH_IO_STRUCT I2C4_SCL_PIO_PB6 =
{ GPIOB, static_cast<uint8_t>( IO_PIN_6 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_11 ) };
const uC_PERIPH_IO_STRUCT I2C4_SDA_PIO_PB7 =
{ GPIOB, static_cast<uint8_t>( IO_PIN_7 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_11 ) };

const uC_PERIPH_IO_STRUCT I2C4_SCL_PIO_PB8 =
{ GPIOB, static_cast<uint8_t>( IO_PIN_8 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_1 ) };
const uC_PERIPH_IO_STRUCT I2C4_SDA_PIO_PB9 =
{ GPIOB, static_cast<uint8_t>( IO_PIN_9 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_1 ) };

const uC_PERIPH_IO_STRUCT I2C4_SCL_PIO_PF14 =
{ GPIOF, static_cast<uint8_t>( IO_PIN_14 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_4 ) };
const uC_PERIPH_IO_STRUCT I2C4_SDA_PIO_PF15 =
{ GPIOF, static_cast<uint8_t>( IO_PIN_15 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_4 ) };
...
{ GPIOC, static_cast<uint8_t>( IO_PIN_7 ),  static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_2 ) };
...
const uC_PERIPH_IO_STRUCT TIMER9_PIO1_PA2 =
{ GPIOA, static_cast<uint8_t>( IO_PIN_2 ),  static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_3 ) };
const uC_PERIPH_IO_STRUCT TIMER9_PIO2_PA3 =
{ GPIOA, static_cast<uint8_t>( IO_PIN_3 ),  static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_3 ) };
const uC_PERIPH_IO_STRUCT TIMER9_PIO1_PE5 =
{ GPIOE, static_cast<uint8_t>( IO_PIN_5 ),  static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_3 ) };
const uC_PERIPH_IO_STRUCT TIMER9_PIO2_PE6 =
{ GPIOE, static_cast<uint8_t>( IO_PIN_6 ),  static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_3 ) };

const uC_PERIPH_IO_STRUCT TIMER10_PIO1_PB8 =
{ GPIOB, static_cast<uint8_t>( IO_PIN_8 ),  static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_3 ) };
const uC_PERIPH_IO_STRUCT TIMER10_PIO1_PF6 =
{ GPIOF, static_cast<uint8_t>( IO_PIN_6 ),  static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_3 ) };

const uC_PERIPH_IO_STRUCT TIMER11_PIO1_PB9 =
{ GPIOB, static_cast<uint8_t>( IO_PIN_9 ),  static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_3 ) };
const uC_PERIPH_IO_STRUCT TIMER11_PIO1_PF7 =
{ GPIOF, static_cast<uint8_t>( IO_PIN_7 ),  static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_3 ) };

const uC_PERIPH_IO_STRUCT TIMER12_PIO1_PH6 =
{ GPIOH, static_cast<uint8_t>( IO_PIN_6 ),  static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_9 ) };
const uC_PERIPH_IO_STRUCT TIMER12_PIO2_PH9 =
{ GPIOH, static_cast<uint8_t>( IO_PIN_9 ),  static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_9 ) };
const uC_PERIPH_IO_STRUCT TIMER12_PIO1_PB14 =
{ GPIOB, static_cast<uint8_t>( IO_PIN_14 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_9 ) };
const uC_PERIPH_IO_STRUCT TIMER12_PIO2_PB15 =
{ GPIOB, static_cast<uint8_t>( IO_PIN_15 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_9 ) };

const uC_PERIPH_IO_STRUCT TIMER13_PIO1_PA6 =
{ GPIOA, static_cast<uint8_t>( IO_PIN_6 ),  static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_9 ) };
const uC_PERIPH_IO_STRUCT TIMER13_PIO1_PF8 =
{ GPIOF, static_cast<uint8_t>( IO_PIN_8 ),  static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_9 ) };

const uC_PERIPH_IO_STRUCT TIMER14_PIO1_PA7 =
{ GPIOA, static_cast<uint8_t>( IO_PIN_7 ),  static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_9 ) };
const uC_PERIPH_IO_STRUCT TIMER14_PIO1_PF9 =
{ GPIOF, static_cast<uint8_t>( IO_PIN_9 ),  static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_9 ) };
...
const uC_PERIPH_IO_STRUCT ADC12_IN0_PIO = { GPIOA, static_cast<uint8_t>( IO_PIN_0 ),
											static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_ANALOG ) };
const uC_PERIPH_IO_STRUCT ADC12_IN1_PIO = { GPIOA, static_cast<uint8_t>( IO_PIN_1 ),
											static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_ANALOG ) };
const uC_PERIPH_IO_STRUCT ADC12_IN2_PIO = { GPIOA, static_cast<uint8_t>( IO_PIN_2 ),
											static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_ANALOG ) };
const uC_PERIPH_IO_STRUCT ADC12_IN3_PIO = { GPIOA, static_cast<uint8_t>( IO_PIN_3 ),
											static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_ANALOG ) };
const uC_PERIPH_IO_STRUCT ADC12_IN4_PIO = { GPIOA, static_cast<uint8_t>( IO_PIN_4 ),
											static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_ANALOG ) };
const uC_PERIPH_IO_STRUCT ADC12_IN5_PIO = { GPIOA, static_cast<uint8_t>( IO_PIN_5 ),
											static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_ANALOG ) };
const uC_PERIPH_IO_STRUCT ADC12_IN6_PIO = { GPIOA, static_cast<uint8_t>( IO_PIN_6 ),
											static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_ANALOG ) };
const uC_PERIPH_IO_STRUCT ADC12_IN7_PIO = { GPIOA, static_cast<uint8_t>( IO_PIN_7 ),
											static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_ANALOG ) };
const uC_PERIPH_IO_STRUCT ADC12_IN8_PIO = { GPIOB, static_cast<uint8_t>( IO_PIN_0 ),
											static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_ANALOG ) };
const uC_PERIPH_IO_STRUCT ADC12_IN9_PIO = { GPIOB, static_cast<uint8_t>( IO_PIN_1 ),
											static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_ANALOG ) };
const uC_PERIPH_IO_STRUCT ADC12_IN10_PIO = { GPIOC, static_cast<uint8_t>( IO_PIN_0 ),
											 static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_ANALOG ) };
const uC_PERIPH_IO_STRUCT ADC12_IN11_PIO = { GPIOC, static_cast<uint8_t>( IO_PIN_1 ),
											 static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_ANALOG ) };
const uC_PERIPH_IO_STRUCT ADC12_IN12_PIO = { GPIOC, static_cast<uint8_t>( IO_PIN_2 ),
											 static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_ANALOG ) };
const uC_PERIPH_IO_STRUCT ADC12_IN13_PIO = { GPIOC, static_cast<uint8_t>( IO_PIN_3 ),
											 static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_ANALOG ) };
const uC_PERIPH_IO_STRUCT ADC12_IN14_PIO = { GPIOC, static_cast<uint8_t>( IO_PIN_4 ),
											 static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_ANALOG ) };
const uC_PERIPH_IO_STRUCT ADC12_IN15_PIO = { GPIOC, static_cast<uint8_t>( IO_PIN_5 ),
											 static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_ANALOG ) };

const uC_PERIPH_IO_STRUCT ADC12_IN16_PIO = { GPIOC, static_cast<uint8_t>( IO_PIN_UNDEFINED ),
											 static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_ANALOG ) };
const uC_PERIPH_IO_STRUCT ADC12_IN17_PIO = { GPIOC, static_cast<uint8_t>( IO_PIN_UNDEFINED ),
											 static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_ANALOG ) };
const uC_PERIPH_IO_STRUCT ADC12_IN18_PIO = { GPIOC, static_cast<uint8_t>( IO_PIN_UNDEFINED ),
											 static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_ANALOG ) };


const uC_PERIPH_IO_STRUCT ADC3_IN0_PIO = { GPIOA, static_cast<uint8_t>( IO_PIN_0 ),
										   static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_ANALOG ) };
const uC_PERIPH_IO_STRUCT ADC3_IN1_PIO = { GPIOA, static_cast<uint8_t>( IO_PIN_1 ),
										   static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_ANALOG ) };
const uC_PERIPH_IO_STRUCT ADC3_IN2_PIO = { GPIOA, static_cast<uint8_t>( IO_PIN_2 ),
										   static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_ANALOG ) };
const uC_PERIPH_IO_STRUCT ADC3_IN3_PIO = { GPIOA, static_cast<uint8_t>( IO_PIN_3 ),
										   static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_ANALOG ) };
const uC_PERIPH_IO_STRUCT ADC3_IN4_PIO = { GPIOF, static_cast<uint8_t>( IO_PIN_6 ),
										   static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_ANALOG ) };
const uC_PERIPH_IO_STRUCT ADC3_IN5_PIO = { GPIOF, static_cast<uint8_t>( IO_PIN_7 ),
										   static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_ANALOG ) };
const uC_PERIPH_IO_STRUCT ADC3_IN6_PIO = { GPIOF, static_cast<uint8_t>( IO_PIN_8 ),
										   static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_ANALOG ) };
const uC_PERIPH_IO_STRUCT ADC3_IN7_PIO = { GPIOF, static_cast<uint8_t>( IO_PIN_9 ),
										   static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_ANALOG ) };
const uC_PERIPH_IO_STRUCT ADC3_IN8_PIO = { GPIOF, static_cast<uint8_t>( IO_PIN_10 ),
										   static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_ANALOG ) };
const uC_PERIPH_IO_STRUCT ADC3_IN9_PIO = { GPIOF, static_cast<uint8_t>( IO_PIN_3 ),
										   static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_ANALOG ) };
const uC_PERIPH_IO_STRUCT ADC3_IN10_PIO = { GPIOC, static_cast<uint8_t>( IO_PIN_0 ),
											static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_ANALOG ) };
const uC_PERIPH_IO_STRUCT ADC3_IN11_PIO = { GPIOC, static_cast<uint8_t>( IO_PIN_1 ),
											static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_ANALOG ) };
const uC_PERIPH_IO_STRUCT ADC3_IN12_PIO = { GPIOC, static_cast<uint8_t>( IO_PIN_2 ),
											static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_ANALOG ) };
const uC_PERIPH_IO_STRUCT ADC3_IN13_PIO = { GPIOC, static_cast<uint8_t>( IO_PIN_3 ),
											static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_ANALOG ) };
const uC_PERIPH_IO_STRUCT ADC3_IN14_PIO = { GPIOF, static_cast<uint8_t>( IO_PIN_4 ),
											static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_ANALOG ) };
const uC_PERIPH_IO_STRUCT ADC3_IN15_PIO = { GPIOF, static_cast<uint8_t>( IO_PIN_5 ),
											static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_ANALOG ) };
const uC_PERIPH_IO_STRUCT ADC3_IN16_PIO = { GPIOF, static_cast<uint8_t>( IO_PIN_UNDEFINED ),
											static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_ANALOG ) };
const uC_PERIPH_IO_STRUCT ADC3_IN17_PIO = { GPIOF, static_cast<uint8_t>( IO_PIN_UNDEFINED ),
											static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_ANALOG ) };
const uC_PERIPH_IO_STRUCT ADC3_IN18_PIO = { GPIOF, static_cast<uint8_t>( IO_PIN_UNDEFINED ),
											static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_ANALOG ) };
 ...
 */
/// const uC_PERIPH_IO_STRUCT     ETH_MCO_CLOCK_OUT_PIO	= { GPIOA,
/// static_cast<uint8_t>(IO_PIN_8),static_cast<uint8_t>(uC_IO_ALTERNATE_MAP_11) };
...
const uC_PERIPH_IO_STRUCT ETH_MII_TXD3_PIO_PE2 =
{ GPIOE, static_cast<uint8_t>( IO_PIN_2 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_11 ) };
/// ********** Inputs **********
...
const uC_PERIPH_IO_STRUCT ETH_MII_RXD2_PIO_PH6 /*x*/ =
{ GPIOH, static_cast<uint8_t>( IO_PIN_6 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_11 ) };
...
// const uC_PERIPH_IO_STRUCT   ETH_RMII_PPS_OUT_PIO	= { GPIOB,
// static_cast<uint8_t>(IO_PIN_5),static_cast<uint8_t>(uC_IO_ALTERNATE_MAP_11) };	//Unused
/// ********** Inputs **********
...
/*
 ******************************************
 *		FMC SDRAM Peripheral
        Only tested on F750 board to support External RAM
 */

const uC_PERIPH_IO_STRUCT FMC_SDRAM_A0_PIO_PF0 =
{ GPIOF, static_cast<uint8_t>( IO_PIN_0 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_12 ) };
const uC_PERIPH_IO_STRUCT FMC_SDRAM_A1_PIO_PF1 =
{ GPIOF, static_cast<uint8_t>( IO_PIN_1 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_12 ) };
const uC_PERIPH_IO_STRUCT FMC_SDRAM_A2_PIO_PF2 =
{ GPIOF, static_cast<uint8_t>( IO_PIN_2 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_12 ) };
const uC_PERIPH_IO_STRUCT FMC_SDRAM_A3_PIO_PF3 =
{ GPIOF, static_cast<uint8_t>( IO_PIN_3 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_12 ) };
const uC_PERIPH_IO_STRUCT FMC_SDRAM_A4_PIO_PF4 =
{ GPIOF, static_cast<uint8_t>( IO_PIN_4 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_12 ) };
const uC_PERIPH_IO_STRUCT FMC_SDRAM_A5_PIO_PF5 =
{ GPIOF, static_cast<uint8_t>( IO_PIN_5 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_12 ) };
const uC_PERIPH_IO_STRUCT FMC_SDRAM_A6_PIO_PF12 =
{ GPIOF, static_cast<uint8_t>( IO_PIN_12 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_12 ) };
const uC_PERIPH_IO_STRUCT FMC_SDRAM_A7_PIO_PF13 =
{ GPIOF, static_cast<uint8_t>( IO_PIN_13 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_12 ) };
const uC_PERIPH_IO_STRUCT FMC_SDRAM_A8_PIO_PF14 =
{ GPIOF, static_cast<uint8_t>( IO_PIN_14 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_12 ) };
const uC_PERIPH_IO_STRUCT FMC_SDRAM_A9_PIO_PF15 =
{ GPIOF, static_cast<uint8_t>( IO_PIN_15 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_12 ) };
const uC_PERIPH_IO_STRUCT FMC_SDRAM_A10_PIO_PG0 =
{ GPIOG, static_cast<uint8_t>( IO_PIN_0 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_12 ) };
const uC_PERIPH_IO_STRUCT FMC_SDRAM_A11_PIO_PG1 =
{ GPIOG, static_cast<uint8_t>( IO_PIN_1 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_12 ) };

const uC_PERIPH_IO_STRUCT FMC_SDRAM_B0_PIO_PG4 =
{ GPIOG, static_cast<uint8_t>( IO_PIN_4 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_12 ) };
const uC_PERIPH_IO_STRUCT FMC_SDRAM_B1_PIO_PG5 =
{ GPIOG, static_cast<uint8_t>( IO_PIN_5 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_12 ) };

const uC_PERIPH_IO_STRUCT FMC_SDRAM_D0_PIO_PD14 =
{ GPIOD, static_cast<uint8_t>( IO_PIN_14 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_12 ) };
const uC_PERIPH_IO_STRUCT FMC_SDRAM_D1_PIO_PD15 =
{ GPIOD, static_cast<uint8_t>( IO_PIN_15 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_12 ) };
const uC_PERIPH_IO_STRUCT FMC_SDRAM_D2_PIO_PD0 =
{ GPIOD, static_cast<uint8_t>( IO_PIN_0 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_12 ) };
const uC_PERIPH_IO_STRUCT FMC_SDRAM_D3_PIO_PD1 =
{ GPIOD, static_cast<uint8_t>( IO_PIN_1 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_12 ) };
const uC_PERIPH_IO_STRUCT FMC_SDRAM_D4_PIO_PE7 =
{ GPIOE, static_cast<uint8_t>( IO_PIN_7 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_12 ) };
const uC_PERIPH_IO_STRUCT FMC_SDRAM_D5_PIO_PE8 =
{ GPIOE, static_cast<uint8_t>( IO_PIN_8 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_12 ) };
const uC_PERIPH_IO_STRUCT FMC_SDRAM_D6_PIO_PE9 =
{ GPIOE, static_cast<uint8_t>( IO_PIN_9 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_12 ) };
const uC_PERIPH_IO_STRUCT FMC_SDRAM_D7_PIO_PE10 =
{ GPIOE, static_cast<uint8_t>( IO_PIN_10 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_12 ) };
const uC_PERIPH_IO_STRUCT FMC_SDRAM_D8_PIO_PE11 =
{ GPIOE, static_cast<uint8_t>( IO_PIN_11 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_12 ) };
const uC_PERIPH_IO_STRUCT FMC_SDRAM_D9_PIO_PE12 =
{ GPIOE, static_cast<uint8_t>( IO_PIN_12 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_12 ) };
const uC_PERIPH_IO_STRUCT FMC_SDRAM_D10_PIO_PE13 =
{ GPIOE, static_cast<uint8_t>( IO_PIN_13 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_12 ) };
const uC_PERIPH_IO_STRUCT FMC_SDRAM_D11_PIO_PE14 =
{ GPIOE, static_cast<uint8_t>( IO_PIN_14 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_12 ) };
const uC_PERIPH_IO_STRUCT FMC_SDRAM_D12_PIO_PE15 =
{ GPIOE, static_cast<uint8_t>( IO_PIN_15 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_12 ) };
const uC_PERIPH_IO_STRUCT FMC_SDRAM_D13_PIO_PD8 =
{ GPIOD, static_cast<uint8_t>( IO_PIN_8 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_12 ) };
const uC_PERIPH_IO_STRUCT FMC_SDRAM_D14_PIO_PD9 =
{ GPIOD, static_cast<uint8_t>( IO_PIN_9 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_12 ) };
const uC_PERIPH_IO_STRUCT FMC_SDRAM_D15_PIO_PD10 =
{ GPIOD, static_cast<uint8_t>( IO_PIN_10 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_12 ) };

const uC_PERIPH_IO_STRUCT FMC_SDRAM_NBL0_PIO_PE0 =
{ GPIOE, static_cast<uint8_t>( IO_PIN_0 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_12 ) };
const uC_PERIPH_IO_STRUCT FMC_SDRAM_NBL1_PIO_PE1 =
{ GPIOE, static_cast<uint8_t>( IO_PIN_1 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_12 ) };

const uC_PERIPH_IO_STRUCT FMC_SDRAM_SDCLK_PIO_PG8 =
{ GPIOG, static_cast<uint8_t>( IO_PIN_8 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_12 ) };
const uC_PERIPH_IO_STRUCT FMC_SDRAM_SDNRAS_PIO_PF11 =
{ GPIOF, static_cast<uint8_t>( IO_PIN_11 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_12 ) };
const uC_PERIPH_IO_STRUCT FMC_SDRAM_SDNCAS_PIO_PG15 =
{ GPIOG, static_cast<uint8_t>( IO_PIN_15 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_12 ) };
const uC_PERIPH_IO_STRUCT FMC_SDRAM_SDNE0_PIO_PH3 =
{ GPIOH, static_cast<uint8_t>( IO_PIN_3 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_12 ) };
const uC_PERIPH_IO_STRUCT FMC_SDRAM_SDNWE_PIO_PH5 =
{ GPIOH, static_cast<uint8_t>( IO_PIN_5 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_12 ) };
const uC_PERIPH_IO_STRUCT FMC_SDRAM_SDCKE0_PIO_PC3 =
{ GPIOC, static_cast<uint8_t>( IO_PIN_3 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_12 ) };
...
// *****************************************
// **		IO Port J
const uint32_t SET_PIO_J_OUTPUT = PIO_J_SET_OUTPUT_MASK;
const uint32_t SET_PIO_J_OUTPUT_INIT = PIO_J_OUTPUT_INIT_MASK;
const uint32_t SET_PIO_J_INPUT = PIO_J_SET_INPUT_MASK;
const uint32_t SET_PIO_J_INPUT_PULLUP = PIO_J_INPUT_PULLUP_MASK;
const uint32_t SET_PIO_J_INPUT_PULLDOWN = PIO_J_INPUT_PULLDOWN_MASK;

// *****************************************
// **		IO Port K
const uint32_t SET_PIO_K_OUTPUT = PIO_K_SET_OUTPUT_MASK;
const uint32_t SET_PIO_K_OUTPUT_INIT = PIO_K_OUTPUT_INIT_MASK;
const uint32_t SET_PIO_K_INPUT = PIO_K_SET_INPUT_MASK;
const uint32_t SET_PIO_K_INPUT_PULLUP = PIO_K_INPUT_PULLUP_MASK;
const uint32_t SET_PIO_K_INPUT_PULLDOWN = PIO_K_INPUT_PULLDOWN_MASK;
/*
 ******************************************
 *		CAN Peripheral
 */
// const uC_PERIPH_IO_STRUCT     CAN_RX_PIO    = { GPIOB, IO_PIN_8, ( uC_IO_ALTERNATE_MAP_2 |
// uC_IO_REMAP_MASK_2 ), 13 };
// const uC_PERIPH_IO_STRUCT     CAN_TX_PIO    = { GPIOB, IO_PIN_9, ( uC_IO_ALTERNATE_MAP_2 |
// uC_IO_REMAP_MASK_2 ), 13 };
