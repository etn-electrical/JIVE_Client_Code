 ...
 *****************************************************************************************
 */
#ifndef uC_BASE_HW_IDS_STM32F767_H
   #define uC_BASE_HW_IDS_STM32F767_H
...
enum
{
	uC_BASE_STM32F767_PCLK_INDEX_AHB1,		// These first three must match the "Peripheral Power
											// Definition Structure"
	uC_BASE_STM32F767_PCLK_INDEX_AHB2,		// enumeration in uC_Base.h.
	uC_BASE_STM32F767_PCLK_INDEX_AHB3,
	uC_BASE_STM32F767_PCLK_INDEX_APB1,
	uC_BASE_STM32F767_PCLK_INDEX_APB2,
...
/*
 *****************************************************************************************
 *      SDRAM Chip Select Application Peripheral ID's
 *			File: uC_SDRAM
...
enum
{
	uC_BASE_FMC_SDRAM_CTRL_1,
	uC_BASE_FMC_SDRAM_MAX_CTRLS
};
