 ...
 *****************************************************************************************
 */
#ifndef uC_Base_STM32F765_H
   #define uC_Base_STM32F765_H
 ...
 *  Class Declaration
   --------------------------------------------------------------------------------------------------
 */
class uC_Base_STM32F765 : public uC_Base
{
	public:
		uC_Base_STM32F765( void );
		~uC_Base_STM32F765( void );
	...
	private:
		...
		static const uint32_t m_pclock_freqs[uC_BASE_STM32F765_MAX_PCLKS];
