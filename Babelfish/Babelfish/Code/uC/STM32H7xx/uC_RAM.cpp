...
extern uint8_t __ICFEDIT_region_CCMRAM_start__;
extern uint8_t __ICFEDIT_region_CCMRAM_end__;
}
	...
	: m_cr_update_task( reinterpret_cast<CR_Tasker*>( NULL ) )
{
	...
	m_volatile_item_first.start = reinterpret_cast<uint8_t*>( 0x00000000U );// start of MCU
																			// address space
	m_volatile_item_first.end = &__ICFEDIT_region_CCMRAM_start__;
	...
	m_volatile_item_post_ccm.start = &__ICFEDIT_region_CCMRAM_end__;
