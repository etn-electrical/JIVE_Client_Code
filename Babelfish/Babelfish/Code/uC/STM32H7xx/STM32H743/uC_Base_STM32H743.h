 ...
 *****************************************************************************************
 */
#ifndef uC_Base_STM32H743_H
   #define uC_Base_STM32H743_H
 ...
 *  Class Declaration
   --------------------------------------------------------------------------------------------------
 */
class uC_Base_STM32H743 : public uC_Base
{
	public:
		uC_Base_STM32H743( void );
		~uC_Base_STM32H743( void );
	...
	private:
		...
		static const uint32_t m_pclock_freqs[uC_BASE_STM32H743_MAX_PCLKS];
