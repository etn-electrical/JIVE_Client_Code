 ...
 *****************************************************************************************
 */
#ifndef uC_BASE_HW_IDS_STM32H743_H
   #define uC_BASE_HW_IDS_STM32H743_H
...
enum
{
	uC_BASE_STM32H743_PCLK_INDEX_AHB1,		// These first three must match the "Peripheral Power Definition Structure"
	uC_BASE_STM32H743_PCLK_INDEX_AHB2,		// enumeration in uC_Base.h.
	uC_BASE_STM32H743_PCLK_INDEX_AHB3,
	uC_BASE_STM32H743_PCLK_INDEX_AHB4,
	uC_BASE_STM32H743_PCLK_INDEX_APB1L,
	uC_BASE_STM32H743_PCLK_INDEX_APB1H,
	uC_BASE_STM32H743_PCLK_INDEX_APB2,
	uC_BASE_STM32H743_PCLK_INDEX_APB3,
	uC_BASE_STM32H743_PCLK_INDEX_APB4,
	uC_BASE_STM32H743_PCLK_INDEX_TIMERS2_TO_7_12_TO_14,
	uC_BASE_STM32H743_PCLK_INDEX_TIMER1_8_15_TO_17,
	uC_BASE_STM32H743_PCLK_INDEX_TIMER_ADC,
	uC_BASE_STM32H743_MAX_PCLKS
};
...
enum
{
	...
	uC_ATOD_CHANNEL_19 = 0x1 << 19,
	uC_ATOD_CHANNEL_ALL = 0xFF
};

#define uC_ATOD_1_CHANNEL_MAX           16U
#define uC_ATOD_2_CHANNEL_MAX           16U
#define uC_ATOD_3_CHANNEL_MAX           15U

#define uC_ATOD_CHANNEL_MAX         20
...
#define DMA_I2C1TX_D1S2         ( static_cast<uint16_t>( uC_DMA1_STREAM_2 ) | \
								  ( static_cast<uint16_t>( DMA_REQUEST_I2C1_TX ) << DMA_STREAM_CHANNEL_SHIFT ) )
#define DMA_I2C2TX_D1S3         ( static_cast<uint16_t>( uC_DMA1_STREAM_3 ) | \
								  ( static_cast<uint16_t>( DMA_REQUEST_I2C2_TX ) << DMA_STREAM_CHANNEL_SHIFT ) )
#define DMA_I2C3TX_D1S4         ( static_cast<uint16_t>( uC_DMA1_STREAM_4 ) | \
								  ( static_cast<uint16_t>( DMA_REQUEST_I2C1_TX ) << DMA_STREAM_CHANNEL_SHIFT ) )
#define DMA_I2C4TX_D1S5         ( static_cast<uint16_t>( uC_DMA1_STREAM_5 ) | \
								  ( static_cast<uint16_t>( DMA_REQUEST_I2C2_TX ) << DMA_STREAM_CHANNEL_SHIFT ) )

#define DMA_ADC1_D1S6           ( static_cast<uint16_t>( uC_DMA1_STREAM_6 ) | \
								  ( static_cast<uint16_t>( DMA_REQUEST_ADC1 ) << DMA_STREAM_CHANNEL_SHIFT ) )
#define DMA_ADC2_D1S7           ( static_cast<uint16_t>( uC_DMA1_STREAM_7 ) | \
								  ( static_cast<uint16_t>( DMA_REQUEST_ADC2 ) << DMA_STREAM_CHANNEL_SHIFT ) )
...
#define DMA_I2C1RX_D2S2         ( static_cast<uint16_t>( uC_DMA2_STREAM_2 ) | \
								  ( static_cast<uint16_t>( DMA_REQUEST_I2C1_RX ) << DMA_STREAM_CHANNEL_SHIFT ) )
#define DMA_I2C2RX_D2S3         ( static_cast<uint16_t>( uC_DMA2_STREAM_3 ) | \
								  ( static_cast<uint16_t>( DMA_REQUEST_I2C2_RX ) << DMA_STREAM_CHANNEL_SHIFT ) )
#define DMA_I2C3RX_D2S4         ( static_cast<uint16_t>( uC_DMA2_STREAM_4 ) | \
								  ( static_cast<uint16_t>( DMA_REQUEST_I2C1_RX ) << DMA_STREAM_CHANNEL_SHIFT ) )
#define DMA_I2C4RX_D2S5         ( static_cast<uint16_t>( uC_DMA2_STREAM_5 ) | \
								  ( static_cast<uint16_t>( DMA_REQUEST_I2C2_RX ) << DMA_STREAM_CHANNEL_SHIFT ) )

#define DMA_ADC3_D2S6           ( static_cast<uint16_t>( uC_DMA2_STREAM_6 ) | \
								  ( static_cast<uint16_t>( DMA_REQUEST_ADC3 ) << DMA_STREAM_CHANNEL_SHIFT ) )
...
static const uint32_t SECTOR_ERASE_TIME_BASELINE_MS = 1000U;/* Sector erase time in miliseconds. Considering x32 erase.
															   smallest sector size for H743 is 128kb*/
...
/* H743 has all equal size 128KB sectors.
   Bank 1 sector number : 0 to 7
 * Bank 2 sector number : 8 to 15 */
const flash_page_t INTERNAL_FLASH_PAGE_SIZES[] =
{
	{0x20000, 0},
	{0x20000, 1},
	{0x20000, 2},
