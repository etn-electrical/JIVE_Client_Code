/**
 **********************************************************************************************
 *  @file           STM32F4xx_I2C.cpp C++ Implementation File for Queued I2C derived class.
 *
 ...
 *****************************************************************************************
 */
STM32F4xx_I2C::STM32F4xx_I2C( class_config_t const* i2c_assy,
 ...
 *****************************************************************************************
 */
STM32F4xx_I2C::~STM32F4xx_I2C( void )
{
	uC_Interrupt::Clear_Vector( m_i2c_vector_number );
 ...
 *****************************************************************************************
 */
void STM32F4xx_I2C::Start_Exchange( bool_t new_exchange )
{
 ...
 *****************************************************************************************
 */
void STM32F4xx_I2C::DMA_TX_ISR( void )
{
	bool_t failure;
 ...
 *****************************************************************************************
 */
void STM32F4xx_I2C::DMA_RX_ISR( void )
{
	bool_t failure;
 ...
 *****************************************************************************************
 */
void STM32F4xx_I2C::I2C_ISR( void )
{
 ...
 *****************************************************************************************
 */
void STM32F4xx_I2C::Assume_IO_Control( const uC_BASE_I2C_IO_PORT_STRUCT* i2c_io ) const
{
 ...
 *****************************************************************************************
 */
void STM32F4xx_I2C::Initialize_Peripheral_Clock( const PERIPH_DEF_ST* periph_def ) const
{
 ...
 *****************************************************************************************
 */
bool_t STM32F4xx_I2C::Clear_DMA_Interrupts()
{
 ...
 *****************************************************************************************
 */
void STM32F4xx_I2C::select_config_t::Configure( i2c_speed_mode_t i2c_mode,
 ...
 *****************************************************************************************
 */
void STM32F4xx_I2C::Generate_Start( void )
{
 ...
 *****************************************************************************************
 */
void STM32F4xx_I2C::Set_Stop( void )
{
	m_i2c->CR1 &= ( ~I2C_CR1_ACK );
 ...
 *****************************************************************************************
 */
uint16_t STM32F4xx_I2C::Get_SR1( void ) const
{
	return ( m_i2c->SR1 );
}
 ...
 *****************************************************************************************
 */
uint16_t STM32F4xx_I2C::Get_SR2( void ) const
{
	return ( m_i2c->SR2 );
}
 ...
 *****************************************************************************************
 */
void STM32F4xx_I2C::Wait_Flag_Timeout( uint32_t flag_mask ) const
{
 ...
 *****************************************************************************************
 */
void STM32F4xx_I2C::Bus_Busy_TimeOut( void )
{
