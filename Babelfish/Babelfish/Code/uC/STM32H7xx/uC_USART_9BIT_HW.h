 ...
 *****************************************************************************************
 */
#ifndef uC_USART_9BIT_HW_H
   #define uC_USART_9BIT_HW_H
...
class uC_USART_9BIT_HW
{
	public:
		...
		uC_USART_9BIT_HW( uint8_t port_requested,
		...
		inline uint32_t Get_Int_Status_Bits( void )           { return ( m_usart->SR ); }

		inline uint32_t Get_RX_Data( void )            { return ( m_usart->DR & m_parity_bit_mask ); }
	...
	private:
		 ...
		 * to disallow usage.
		 */
		uC_USART_9BIT_HW( const uC_USART_9BIT_HW& rhs );
		uC_USART_9BIT_HW & operator =( const uC_USART_9BIT_HW& object );
