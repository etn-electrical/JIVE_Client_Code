...
const UINT32 uC_Base_K60D10::m_pclock_freqs[uC_BASE_K60D10_MAX_PCLKS] =
{
 ...
 */
const uC_BASE_PIO_CTRL_STRUCT uC_Base_K60D10::m_pio_ctrls[uC_BASE_MAX_PIO_CTRLS] =
{
	{
		PTA,
		PORTA,
...
{ &PERIPH_NULL_PIO,    &PERIPH_NULL_PIO,    &PERIPH_NULL_PIO };																	//
																																// unused

const uC_BASE_USART_IO_STRUCT uC_Base_K60D10::m_usart_io[uC_BASE_MAX_USART_PORTS] =
{
	{
		UART0,
		{
...
{ &SPI0_MOSI_PIO_PC7, &SPI0_MISO_PIO_PC6, &SPI0_CLOCK_PIO_PC5, &SPI0_PCS0_PIO_PC4 };
...
const uC_BASE_SPI_IO_STRUCT uC_Base_K60D10::m_spi_io[uC_BASE_SPI_MAX_CTRLS] =
{
	{
		SPI0,
		{
...
// uC_BASE_I2C_INT_OBJ_CBACK_FUNC* uC_Base_K60D10::m_obj_func_i2c_dma_list_Tx[uC_BASE_I2C_MAX_CTRLS];
////Stores the function pointer of the objects static interrupt handler.
// uC_BASE_I2C_INT_OBJ_CBACK_FUNC* uC_Base_K60D10::m_obj_func_i2c_dma_list_Rx[uC_BASE_I2C_MAX_CTRLS];
////Stores the object pointer associated with the interrupt.
// uC_BASE_I2C_OBJ_PARAM_TD uC_Base_K60D10::m_obj_i2c_dma_list_Tx[uC_BASE_I2C_MAX_CTRLS];
////Stores the object pointer associated with the interrupt.
// uC_BASE_I2C_OBJ_PARAM_TD uC_Base_K60D10::m_obj_i2c_dma_list_Rx[uC_BASE_I2C_MAX_CTRLS];
//
////Stores the function pointer of the objects static interrupt handler.
// uC_BASE_I2C_INT_OBJ_CBACK_FUNC* uC_Base_K60D10::m_obj_func_i2c_list[uC_BASE_I2C_MAX_CTRLS];
////Stores the object pointer associated with the interrupt.
// uC_BASE_I2C_OBJ_PARAM_TD uC_Base_K60D10::m_obj_i2c_list[uC_BASE_I2C_MAX_CTRLS];
//
// void uC_Base_K60D10::uC_BASE_I2C_DMA_INT1_Tx( void )	{ (*m_obj_func_i2c_dma_list_Tx[0])( m_obj_i2c_dma_list_Tx[0] );
// }
// void uC_Base_K60D10::uC_BASE_I2C_DMA_INT2_Tx( void )	{ (*m_obj_func_i2c_dma_list_Tx[1])( m_obj_i2c_dma_list_Tx[1] );
// }
// void uC_Base_K60D10::uC_BASE_I2C_DMA_INT3_Tx( void )	{ (*m_obj_func_i2c_dma_list_Tx[2])( m_obj_i2c_dma_list_Tx[2] );
// }
//
// void uC_Base_K60D10::uC_BASE_I2C_DMA_INT1_Rx( void )	{ (*m_obj_func_i2c_dma_list_Rx[0])( m_obj_i2c_dma_list_Rx[0] );
// }
// void uC_Base_K60D10::uC_BASE_I2C_DMA_INT2_Rx( void )	{ (*m_obj_func_i2c_dma_list_Rx[1])( m_obj_i2c_dma_list_Rx[1] );
// }
// void uC_Base_K60D10::uC_BASE_I2C_DMA_INT3_Rx( void )	{ (*m_obj_func_i2c_dma_list_Rx[2])( m_obj_i2c_dma_list_Rx[2] );
// }
//
// void uC_Base_K60D10::uC_BASE_I2C_INT1( void )	{ (*m_obj_func_i2c_list[0])( m_obj_i2c_list[0] ); }
// void uC_Base_K60D10::uC_BASE_I2C_INT2( void )	{ (*m_obj_func_i2c_list[1])( m_obj_i2c_list[1] ); }
// void uC_Base_K60D10::uC_BASE_I2C_INT3( void )	{ (*m_obj_func_i2c_list[2])( m_obj_i2c_list[2] ); }
//
//
// const uC_BASE_I2C_IO_STRUCT         uC_Base_K60D10::m_i2c_io[uC_BASE_I2C_MAX_CTRLS] =
// {
// {
// I2C1,
// {
...
const uC_BASE_TIMER_IO_STRUCT uC_Base_K60D10::m_timer_io[uC_BASE_MAX_TIMER_CTRLS] =
{
...
const uC_BASE_LP_TIMER_CTRL_STRUCT uC_Base_K60D10::m_lp_timer_ctrls[uC_BASE_MAX_LP_TIMER_CTRLS] =
{
	{	// Timer Control Block 0
		LPTMR0,
		{
 ...
 */
const uC_BASE_EXT_INT_IO_STRUCT uC_Base_K60D10::m_ext_ints[uC_BASE_EXT_INT_MAX_PORTS] =
{
	{
		PORTA_IRQn
	},
...
// };
//
// const uC_BASE_ATOD_IO_STRUCT	uC_Base_K60D10::m_atod_io[uC_BASE_ATOD_MAX_CTRLS] =
// {
// {
// ADC1,
// {
...
// RCC_APB2ENR_ADC1EN
// },
// uC_BASE_K60D10_PCLK_INDEX_TIMER_ADC,
// ADC_IRQn,
// uC_ATOD_CHANNEL_MAX,
// m_adc12_pio,
 ...
 */
const uC_BASE_DMA_IO_STRUCT uC_Base_K60D10::m_dma_io[uC_BASE_DMA_CHANNEL_MAX] =
{
	{
		DMA0,
		DMAMUX,
...
const uC_BASE_EMAC_IO_STRUCT uC_Base_K60D10::m_emac_io[uC_BASE_EMAC_MAX_CTRLS] =
{
	{
		ENET,
		ENET_Transmit_IRQn,
