	...
	, public uC_USART_Buff
{
	public:
		 ...
		 * @param hw_usart_num - USART innterface of uC.
		 * @param hw_timer_num - uC_Timer used for RX and TX.  Provides the timeout.
		 * @param io_port - Port configuration used for USART communication - tx, rx, rts.
		 */
