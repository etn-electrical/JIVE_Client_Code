 ...
 *****************************************************************************************
 */
#ifndef uC_Base_K60F12_H
   #define uC_Base_K60F12_H
 ...
 *  Class Declaration
   --------------------------------------------------------------------------------------------------
 */
class uC_Base_K60F12 : public uC_Base
{
	public:
		uC_Base_K60F12( void );
		~uC_Base_K60F12( void );
		...
		{
			UINT8* device_sig_ptr;

			device_sig_ptr = ( UINT8* )0x1FFF7A10;
		...
		static const UINT32 m_pclock_freqs[uC_BASE_K60F12_MAX_PCLKS];
