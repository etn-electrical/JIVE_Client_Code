 ...
 *****************************************************************************************
 */
#ifndef uC_Base_STM32L451_H
   #define uC_Base_STM32L451_H
 ...
 *  Class Declaration
   --------------------------------------------------------------------------------------------------
 */
class uC_Base_STM32L451 : public uC_Base
{
	public:
		uC_Base_STM32L451( void );
		~uC_Base_STM32L451( void );
	...
	private:
		...
		static const uint32_t m_pclock_freqs[uC_BASE_STM32L451_MAX_PCLKS];
