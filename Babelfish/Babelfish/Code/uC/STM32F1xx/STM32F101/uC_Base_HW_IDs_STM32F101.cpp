...
const uint32_t uC_Base_STM32F101::m_pclock_freqs[uC_BASE_STM32F101_MAX_PCLKS] =
{
 ...
 */
const uC_BASE_PIO_CTRL_STRUCT uC_Base_STM32F101::m_pio_ctrls[uC_BASE_MAX_PIO_CTRLS] =
{
	{
		GPIOA,
		{
...
const uC_BASE_USART_IO_STRUCT uC_Base_STM32F101::m_usart_io[uC_BASE_MAX_USART_PORTS] =
{
	{
		USART1,
		{
...
const uC_BASE_SPI_IO_STRUCT uC_Base_STM32F101::m_spi_io[uC_BASE_SPI_MAX_CTRLS] =
{
	{
		SPI1,
		{
	...
	},
	{
		...
		SPI2_IRQn,
		uC_DMA2_CHANNEL_1,			// #k: Ori. b4 7 Nov.:- uC_DMA1_CHANNEL_4,
		uC_DMA2_CHANNEL_2,			// #k: Ori. b4 7 Nov.: uC_DMA1_CHANNEL_5,
...
// static uC_PERIPH_IO_STRUCT const* m_timer5_pio[uC_BASE_MAX_TIMER_CAP_COMP_CH] =
// { &TIMER5_PIO1, &TIMER5_PIO2, &TIMER5_PIO3, &TIMER5_PIO4 };
const uC_BASE_TIMER_IO_STRUCT uC_Base_STM32F101::m_timer_io[uC_BASE_MAX_TIMER_CTRLS] =
{
	{			// Timer Control Block 0
		...
		TIM1_UP_IRQn,									// #k: Ori-TIM1_UP_TIM16_IRQn,
		TIM1_CC_IRQn,
		m_timer1_pio,
		TMR_CNT_SIZE_16BITS,
 ...
 */
const uC_BASE_EXT_INT_IO_STRUCT uC_Base_STM32F101::m_ext_ints[uC_BASE_EXT_INT_MAX_INPUTS] =
{
	{
		EXTI0_IRQn,
		0x0001
...
const uC_BASE_ATOD_IO_STRUCT uC_Base_STM32F101::m_atod_io[uC_BASE_ATOD_MAX_CTRLS] =
{
	{
		ADC1,
		{
		...
		ADC1_2_IRQn,									// #k: Ori-ADC1_IRQn, // Parrish ADC1_2_IRQn,
		uC_ATOD_CHANNEL_MAX,
		m_adc12_pio,
 ...
 */
const uC_BASE_DMA_IO_STRUCT uC_Base_STM32F101::m_dma_io[uC_BASE_DMA_CHANNEL_MAX] =
{
	{
		DMA1,
		DMA1_Channel1,
