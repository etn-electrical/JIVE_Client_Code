 ...
 *****************************************************************************************
 */
#ifndef uC_BASE_HW_IDS_STM32F107_H
   #define uC_BASE_HW_IDS_STM32F107_H
...
enum
{
	uC_BASE_STM32F107_PCLK_INDEX_AHB,		// These first three must match the "Peripheral Power Definition Structure"
	uC_BASE_STM32F107_PCLK_INDEX_APB1,		// enumeration in uC_Base.h.
	uC_BASE_STM32F107_PCLK_INDEX_APB2,
	uC_BASE_STM32F107_PCLK_INDEX_TIMERS2to7,
	uC_BASE_STM32F107_PCLK_INDEX_TIMER1,
	uC_BASE_STM32F107_PCLK_INDEX_TIMER_ADC,
	uC_BASE_STM32F107_MAX_PCLKS
};
...
// static const unsigned int FLASH_PAGE_SIZE = 0x800;                 /* 2KB page */
/*
 *****************************************************************************************
