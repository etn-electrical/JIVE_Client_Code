 ...
 *		CAN Peripheral
 */
const uC_PERIPH_IO_STRUCT CAN1_RX_PIO =
{ GPIOB, static_cast<uint8_t>( IO_PIN_8 ), ( uC_IO_ALTERNATE_MAP_2 | uC_IO_REMAP_MASK_2 ), 13U };
const uC_PERIPH_IO_STRUCT CAN1_TX_PIO =
{ GPIOB, static_cast<uint8_t>( IO_PIN_9 ), ( uC_IO_ALTERNATE_MAP_2 | uC_IO_REMAP_MASK_2 ), 13U };

#ifdef STM32F10X_CL
const uC_PERIPH_IO_STRUCT CAN2_RX_PIO =
{ GPIOB, static_cast<uint8_t>( IO_PIN_8 ), ( uC_IO_ALTERNATE_MAP_2 | uC_IO_REMAP_MASK_2 ), 13U };
const uC_PERIPH_IO_STRUCT CAN3_TX_PIO =
{ GPIOB, static_cast<uint8_t>( IO_PIN_9 ), ( uC_IO_ALTERNATE_MAP_2 | uC_IO_REMAP_MASK_2 ), 13U };
#endif
/*
 *****************************************************************************************
