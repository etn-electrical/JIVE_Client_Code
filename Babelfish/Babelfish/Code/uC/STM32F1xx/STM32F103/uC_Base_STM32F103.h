 ...
 *****************************************************************************************
 */
#ifndef uC_Base_STM32F103_H
   #define uC_Base_STM32F103_H
 ...
 *  Class Declaration
   --------------------------------------------------------------------------------------------------
 */
class uC_Base_STM32F103 : public uC_Base
{
	public:
		uC_Base_STM32F103( void );
		~uC_Base_STM32F103( void );
		...
		uC_BASE_CAN_IO_STRUCT const* Get_CAN_Ctrl( uint32_t can_block );
	...
	private:
		...
		static const uint32_t m_pclock_freqs[uC_BASE_STM32F103_MAX_PCLKS];
};
