...
// inline 	BOOL 	TX_Ready_Int_Enabled( void )			{ return ( ( m_usart->US_IMR & AT91C_US_TXRDY ) != 0 ); }
// inline 	BOOL 	TX_Ready_Int_Status( UINT32 status )	{ return ( ( status & AT91C_US_TXRDY ) != 0 ); }
//
...
// inline 	BOOL 	RX_Break_Int_Enabled( void )			{ return ( ( m_usart->US_IMR & AT91C_US_RXBRK ) != 0 ); }
// inline 	BOOL 	RX_Break_Int_Status( UINT32 status )	{ return ( ( status & AT91C_US_RXBRK ) != 0 ); }
//
...
// inline 	BOOL 	End_Of_RX_Int_Enabled( void )			{ return ( ( m_usart->US_IMR & AT91C_US_RXBRK ) != 0 ); }
// inline 	BOOL 	End_Of_RX_Int_Status( UINT32 status )	{ return ( ( status & AT91C_US_ENDRX ) != 0 ); }
//
...
// inline 	BOOL 	End_Of_TX_Int_Enabled( void )			{ return ( ( m_usart->US_IMR & AT91C_US_ENDTX ) != 0 ); }
// inline 	BOOL 	End_Of_TX_Int_Status( UINT32 status )	{ return ( ( status & AT91C_US_ENDTX ) != 0 ); }
//
// inline 	void 	Enable_RX_Timeout_Int( void )				{ m_usart->US_IER = AT91C_US_TIMEOUT; }
// inline 	void 	Disable_RX_Timeout_Int( void )				{ m_usart->US_IDR = AT91C_US_TIMEOUT; }
// inline 	BOOL 	RX_Timeout_Int_Enabled( void )				{ return ( ( m_usart->US_IMR & AT91C_US_TIMEOUT ) != 0
// ); }
// inline 	BOOL 	RX_Timeout_Int_Status( UINT32 status )		{ return ( ( status & AT91C_US_TIMEOUT ) != 0 ); }
//
...
// inline 	BOOL 	TX_DMA_Empty_Int_Enabled( void )			{ return ( ( m_usart->US_IMR & AT91C_US_TXBUFE ) != 0 );
// }
// inline 	BOOL 	TX_DMA_Empty_Int_Status( UINT32 status )	{ return ( ( status & AT91C_US_TXBUFE ) != 0 ); }
//
...
// inline 	BOOL 	RX_DMA_Empty_Int_Enabled( void )			{ return ( ( m_usart->US_IMR & AT91C_US_RXBUFF ) != 0 );
// }
// inline 	BOOL 	RX_DMA_Empty_Int_Status( UINT32 status )	{ return ( ( status & AT91C_US_RXBUFF ) != 0 ); }
