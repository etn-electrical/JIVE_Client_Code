 ...
 *****************************************************************************************
 */
#ifndef uC_Base_STM32F105_H
   #define uC_Base_STM32F105_H
 ...
 *  Class Declaration
   --------------------------------------------------------------------------------------------------
 */
class uC_Base_STM32F105 : public uC_Base
{
	public:
		uC_Base_STM32F105( void );
		~uC_Base_STM32F105( void );
	...
	private:
		...
		static const uint32_t m_pclock_freqs[uC_BASE_STM32F105_MAX_PCLKS];
};
