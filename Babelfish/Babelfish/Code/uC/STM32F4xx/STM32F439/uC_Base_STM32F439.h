 ...
 *****************************************************************************************
 */
#ifndef uC_Base_STM32F439_H
   #define uC_Base_STM32F439_H
 ...
 *  Class Declaration
   --------------------------------------------------------------------------------------------------
 */
class uC_Base_STM32F439 : public uC_Base
{
	public:
		uC_Base_STM32F439( void );
		~uC_Base_STM32F439( void );
	...
	private:
		...
		static const uint32_t m_pclock_freqs[uC_BASE_STM32F439_MAX_PCLKS];
