 ...
 *****************************************************************************************
 */
#ifndef uC_Base_STM32F437_H
   #define uC_Base_STM32F437_H
 ...
 *  Class Declaration
   --------------------------------------------------------------------------------------------------
 */
class uC_Base_STM32F437 : public uC_Base
{
	public:
		uC_Base_STM32F437( void );
		~uC_Base_STM32F437( void );
	...
	private:
		...
		static const uint32_t m_pclock_freqs[uC_BASE_STM32F437_MAX_PCLKS];
