 ...
 *****************************************************************************************
 */
uint32_t uC_Single_Timer::Set_Timeout_With_Repeat( uint32_t desired_frequency, uint32_t repetition_count, bool repeat )
{
	uint64_t temp_calc = 0U;
	TICK_TD prescaler = 0U;
	TICK_TD count = 0U;
