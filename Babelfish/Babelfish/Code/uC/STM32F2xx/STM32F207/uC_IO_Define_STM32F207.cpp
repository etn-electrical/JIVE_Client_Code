...
#include "Includes.h"
#include "uC_IO_Define_STM32F207.h"
 ...
 *		UART Peripheral
 */
const uC_PERIPH_IO_STRUCT USART1_TX_PIO_PA9 = { GPIOA, IO_PIN_9, uC_IO_ALTERNATE_MAP_7 };
const uC_PERIPH_IO_STRUCT USART1_RX_PIO_PA10 = { GPIOA, IO_PIN_10, uC_IO_ALTERNATE_MAP_7 };
const uC_PERIPH_IO_STRUCT USART1_TX_PIO_PB6 = { GPIOB, IO_PIN_6, uC_IO_ALTERNATE_MAP_7 };
const uC_PERIPH_IO_STRUCT USART1_RX_PIO_PB7 = { GPIOB, IO_PIN_7, uC_IO_ALTERNATE_MAP_7 };

const uC_PERIPH_IO_STRUCT USART2_TX_PIO_PA2 = { GPIOA, IO_PIN_2, uC_IO_ALTERNATE_MAP_7 };
const uC_PERIPH_IO_STRUCT USART2_RX_PIO_PA3 = { GPIOA, IO_PIN_3, uC_IO_ALTERNATE_MAP_7 };
const uC_PERIPH_IO_STRUCT USART2_TX_PIO_PD5 = { GPIOD, IO_PIN_5, uC_IO_ALTERNATE_MAP_7 };
const uC_PERIPH_IO_STRUCT USART2_RX_PIO_PD6 = { GPIOD, IO_PIN_6, uC_IO_ALTERNATE_MAP_7 };

// const uC_PERIPH_IO_STRUCT 	USART2_CK_PIO_PD7    = { GPIOD, IO_PIN_7, uC_IO_ALTERNATE_MAP_7 };

const uC_PERIPH_IO_STRUCT USART3_TX_PIO_PB10 = { GPIOB, IO_PIN_10, uC_IO_ALTERNATE_MAP_7 };
const uC_PERIPH_IO_STRUCT USART3_RX_PIO_PB11 = { GPIOB, IO_PIN_11, uC_IO_ALTERNATE_MAP_7 };
const uC_PERIPH_IO_STRUCT USART3_TX_PIO_PC10 = { GPIOC, IO_PIN_10, uC_IO_ALTERNATE_MAP_7 };
const uC_PERIPH_IO_STRUCT USART3_RX_PIO_PC11 = { GPIOC, IO_PIN_11, uC_IO_ALTERNATE_MAP_7 };
const uC_PERIPH_IO_STRUCT USART3_TX_PIO_PD8 = { GPIOD, IO_PIN_8, uC_IO_ALTERNATE_MAP_7 };
const uC_PERIPH_IO_STRUCT USART3_RX_PIO_PD9 = { GPIOD, IO_PIN_9, uC_IO_ALTERNATE_MAP_7 };

const uC_PERIPH_IO_STRUCT USART4_TX_PIO_PC10 = { GPIOC, IO_PIN_10, uC_IO_ALTERNATE_MAP_8 };
const uC_PERIPH_IO_STRUCT USART4_RX_PIO_PC11 = { GPIOC, IO_PIN_11, uC_IO_ALTERNATE_MAP_8 };

const uC_PERIPH_IO_STRUCT USART5_TX_PIO_PC12 = { GPIOC, IO_PIN_12, uC_IO_ALTERNATE_MAP_8 };
const uC_PERIPH_IO_STRUCT USART5_RX_PIO_PD2 = { GPIOD, IO_PIN_2, uC_IO_ALTERNATE_MAP_8 };

const uC_PERIPH_IO_STRUCT USART6_TX_PIO_PC6 = { GPIOC, IO_PIN_6, uC_IO_ALTERNATE_MAP_8 };
const uC_PERIPH_IO_STRUCT USART6_RX_PIO_PC7 = { GPIOC, IO_PIN_7, uC_IO_ALTERNATE_MAP_8 };

const uC_PERIPH_IO_STRUCT USART6_TX_PIO_PG14 = { GPIOG, IO_PIN_14, uC_IO_ALTERNATE_MAP_8 };
const uC_PERIPH_IO_STRUCT USART6_RX_PIO_PG9 = { GPIOG, IO_PIN_9, uC_IO_ALTERNATE_MAP_8 };
/*
 ******************************************
 *		SPI Peripheral
 */

const uC_PERIPH_IO_STRUCT SPI1_MOSI_PIO_PA7 = { GPIOA, IO_PIN_7, uC_IO_ALTERNATE_MAP_5 };
const uC_PERIPH_IO_STRUCT SPI1_MISO_PIO_PA6 = { GPIOA, IO_PIN_6, uC_IO_ALTERNATE_MAP_5 };
const uC_PERIPH_IO_STRUCT SPI1_CLOCK_PIO_PA5 = { GPIOA, IO_PIN_5, uC_IO_ALTERNATE_MAP_5 };
const uC_PERIPH_IO_STRUCT SPI1_SS_PIO_PA4 = { GPIOA, IO_PIN_4, uC_IO_ALTERNATE_MAP_5 };

// const uC_PERIPH_IO_STRUCT 	SPI1_MOSI_PIO_PB5    = { GPIOB, IO_PIN_5, uC_IO_ALTERNATE_MAP_5 };
// const uC_PERIPH_IO_STRUCT 	SPI1_MISO_PIO_PB4    = { GPIOB, IO_PIN_4, uC_IO_ALTERNATE_MAP_5 };
// const uC_PERIPH_IO_STRUCT 	SPI1_CLOCK_PIO_PB3    = { GPIOB, IO_PIN_3, uC_IO_ALTERNATE_MAP_5 };
const uC_PERIPH_IO_STRUCT SPI1_SS_PIO_PA15 = { GPIOA, IO_PIN_15, uC_IO_ALTERNATE_MAP_5 };

const uC_PERIPH_IO_STRUCT SPI2_MOSI_PIO_PC3 = { GPIOC, IO_PIN_3, uC_IO_ALTERNATE_MAP_5 };
const uC_PERIPH_IO_STRUCT SPI2_MISO_PIO_PC2 = { GPIOC, IO_PIN_2, uC_IO_ALTERNATE_MAP_5 };
const uC_PERIPH_IO_STRUCT SPI2_CLOCK_PIO_PB10 = { GPIOB, IO_PIN_10, uC_IO_ALTERNATE_MAP_5 };


const uC_PERIPH_IO_STRUCT SPI2_MOSI_PIO_PB15 = { GPIOB, IO_PIN_15, uC_IO_ALTERNATE_MAP_5 };
const uC_PERIPH_IO_STRUCT SPI2_MISO_PIO_PB14 = { GPIOB, IO_PIN_14, uC_IO_ALTERNATE_MAP_5 };
const uC_PERIPH_IO_STRUCT SPI2_CLOCK_PIO_PB13 = { GPIOB, IO_PIN_13, uC_IO_ALTERNATE_MAP_5 };
const uC_PERIPH_IO_STRUCT SPI2_CLOCK_PIO_PD3 =
{ GPIOD, static_cast<uint8_t>( IO_PIN_3 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_5 ) };
const uC_PERIPH_IO_STRUCT SPI2_SS_PIO_PB12 = { GPIOB, IO_PIN_12, uC_IO_ALTERNATE_MAP_5 };


const uC_PERIPH_IO_STRUCT SPI3_MOSI_PIO_PB5 = { GPIOB, IO_PIN_5, uC_IO_ALTERNATE_MAP_6 };
const uC_PERIPH_IO_STRUCT SPI3_MISO_PIO_PB4 = { GPIOB, IO_PIN_4, uC_IO_ALTERNATE_MAP_6 };
const uC_PERIPH_IO_STRUCT SPI3_CLOCK_PIO_PB3 = { GPIOB, IO_PIN_3, uC_IO_ALTERNATE_MAP_6 };
const uC_PERIPH_IO_STRUCT SPI3_SS_PIO_PA15 = { GPIOA, IO_PIN_15, uC_IO_ALTERNATE_MAP_6 };

const uC_PERIPH_IO_STRUCT SPI3_MOSI_PIO_PC12 = { GPIOC, IO_PIN_12, uC_IO_ALTERNATE_MAP_6 };
const uC_PERIPH_IO_STRUCT SPI3_MISO_PIO_PC11 = { GPIOC, IO_PIN_11, uC_IO_ALTERNATE_MAP_6 };
const uC_PERIPH_IO_STRUCT SPI3_CLOCK_PIO_PC10 = { GPIOC, IO_PIN_10, uC_IO_ALTERNATE_MAP_6 };
const uC_PERIPH_IO_STRUCT SPI3_SS_PIO_PA4 = { GPIOA, IO_PIN_4, uC_IO_ALTERNATE_MAP_6 };

const uC_PERIPH_IO_STRUCT SPI2_MOSI_PIO_PI3 = { GPIOI, IO_PIN_3, uC_IO_ALTERNATE_MAP_5 };
const uC_PERIPH_IO_STRUCT SPI2_MISO_PIO_PI2 = { GPIOI, IO_PIN_2, uC_IO_ALTERNATE_MAP_5 };
const uC_PERIPH_IO_STRUCT SPI2_CLOCK_PIO_PI1 = { GPIOI, IO_PIN_1, uC_IO_ALTERNATE_MAP_5 };
const uC_PERIPH_IO_STRUCT SPI2_SS_PIO_PI0 = { GPIOI, IO_PIN_0, uC_IO_ALTERNATE_MAP_5 };
/*
 ******************************************
 *		I2C Peripheral
 */
const uC_PERIPH_IO_STRUCT I2C1_SCL_PIO_PB6 = { GPIOB, IO_PIN_6, uC_IO_ALTERNATE_MAP_4 };
const uC_PERIPH_IO_STRUCT I2C1_SDA_PIO_PB7 = { GPIOB, IO_PIN_7, uC_IO_ALTERNATE_MAP_4 };

const uC_PERIPH_IO_STRUCT I2C1_SCL_PIO_PB8 = { GPIOB, IO_PIN_8, uC_IO_ALTERNATE_MAP_4 };
const uC_PERIPH_IO_STRUCT I2C1_SDA_PIO_PB9 = { GPIOB, IO_PIN_9, uC_IO_ALTERNATE_MAP_4 };

const uC_PERIPH_IO_STRUCT I2C2_SCL_PIO_PF1 = { GPIOF, IO_PIN_1, uC_IO_ALTERNATE_MAP_4 };
const uC_PERIPH_IO_STRUCT I2C2_SDA_PIO_PF0 = { GPIOF, IO_PIN_0, uC_IO_ALTERNATE_MAP_4 };

const uC_PERIPH_IO_STRUCT I2C3_SCL_PIO_PA8 = { GPIOA, IO_PIN_8, uC_IO_ALTERNATE_MAP_4 };
const uC_PERIPH_IO_STRUCT I2C3_SDA_PIO_PC9 = { GPIOC, IO_PIN_9, uC_IO_ALTERNATE_MAP_4 };
const uC_PERIPH_IO_STRUCT I2C2_SCL_PIO_PH4 = { GPIOH, IO_PIN_4, uC_IO_ALTERNATE_MAP_4 };
const uC_PERIPH_IO_STRUCT I2C2_SDA_PIO_PH5 = { GPIOH, IO_PIN_5, uC_IO_ALTERNATE_MAP_4 };
const uC_PERIPH_IO_STRUCT I2C3_SCL_PIO_PH7 = { GPIOH, IO_PIN_7, uC_IO_ALTERNATE_MAP_4 };
const uC_PERIPH_IO_STRUCT I2C3_SDA_PIO_PH8 = { GPIOH, IO_PIN_8, uC_IO_ALTERNATE_MAP_4 };
/*
 ***********************************
 *  	USB Peripheral
 */
 ...
 *		Timer Peripheral
 */
const uC_PERIPH_IO_STRUCT TIMER1_PIO1_PA8 = { GPIOA, IO_PIN_8, uC_IO_ALTERNATE_MAP_1 };
const uC_PERIPH_IO_STRUCT TIMER1_PIO2_PA9 = { GPIOA, IO_PIN_9, uC_IO_ALTERNATE_MAP_1 };
const uC_PERIPH_IO_STRUCT TIMER1_PIO3_PA10 = { GPIOA, IO_PIN_10, uC_IO_ALTERNATE_MAP_1 };
const uC_PERIPH_IO_STRUCT TIMER1_PIO4_PA11 = { GPIOA, IO_PIN_11, uC_IO_ALTERNATE_MAP_1 };
const uC_PERIPH_IO_STRUCT TIMER1_PIO1_PE9 = { GPIOE, IO_PIN_9, uC_IO_ALTERNATE_MAP_1 };
const uC_PERIPH_IO_STRUCT TIMER1_PIO2_PE11 = { GPIOE, IO_PIN_11, uC_IO_ALTERNATE_MAP_1 };
const uC_PERIPH_IO_STRUCT TIMER1_PIO3_PE13 = { GPIOE, IO_PIN_13, uC_IO_ALTERNATE_MAP_1 };
const uC_PERIPH_IO_STRUCT TIMER1_PIO4_PE14 = { GPIOE, IO_PIN_14, uC_IO_ALTERNATE_MAP_1 };

const uC_PERIPH_IO_STRUCT TIMER2_PIO1_PA0 = { GPIOA, IO_PIN_0, uC_IO_ALTERNATE_MAP_1 };
const uC_PERIPH_IO_STRUCT TIMER2_PIO2_PA1 = { GPIOA, IO_PIN_1, uC_IO_ALTERNATE_MAP_1 };
const uC_PERIPH_IO_STRUCT TIMER2_PIO3_PA2 = { GPIOA, IO_PIN_2, uC_IO_ALTERNATE_MAP_1 };
const uC_PERIPH_IO_STRUCT TIMER2_PIO4_PA3 = { GPIOA, IO_PIN_3, uC_IO_ALTERNATE_MAP_1 };
const uC_PERIPH_IO_STRUCT TIMER2_PIO1_PA5 = { GPIOA, IO_PIN_5, uC_IO_ALTERNATE_MAP_1 };
const uC_PERIPH_IO_STRUCT TIMER2_PIO1_PA15 = { GPIOA, IO_PIN_15, uC_IO_ALTERNATE_MAP_1 };
const uC_PERIPH_IO_STRUCT TIMER2_PIO2_PB3 = { GPIOB, IO_PIN_3, uC_IO_ALTERNATE_MAP_1 };
const uC_PERIPH_IO_STRUCT TIMER2_PIO3_PB10 = { GPIOB, IO_PIN_10, uC_IO_ALTERNATE_MAP_1 };
const uC_PERIPH_IO_STRUCT TIMER2_PIO4_PB11 = { GPIOB, IO_PIN_11, uC_IO_ALTERNATE_MAP_1 };

const uC_PERIPH_IO_STRUCT TIMER3_PIO1_PA6 = { GPIOA, IO_PIN_6, uC_IO_ALTERNATE_MAP_2 };
const uC_PERIPH_IO_STRUCT TIMER3_PIO2_PA7 = { GPIOA, IO_PIN_7, uC_IO_ALTERNATE_MAP_2 };
const uC_PERIPH_IO_STRUCT TIMER3_PIO3_PB0 = { GPIOB, IO_PIN_0, uC_IO_ALTERNATE_MAP_2 };
const uC_PERIPH_IO_STRUCT TIMER3_PIO4_PB1 = { GPIOB, IO_PIN_1, uC_IO_ALTERNATE_MAP_2 };
const uC_PERIPH_IO_STRUCT TIMER3_PIO1_PB4 = { GPIOB, IO_PIN_4, uC_IO_ALTERNATE_MAP_2 };
const uC_PERIPH_IO_STRUCT TIMER3_PIO2_PB5 = { GPIOB, IO_PIN_5, uC_IO_ALTERNATE_MAP_2 };
const uC_PERIPH_IO_STRUCT TIMER3_PIO1_PC6 = { GPIOC, IO_PIN_8, uC_IO_ALTERNATE_MAP_2 };
const uC_PERIPH_IO_STRUCT TIMER3_PIO2_PC7 = { GPIOB, IO_PIN_1, uC_IO_ALTERNATE_MAP_2 };
const uC_PERIPH_IO_STRUCT TIMER3_PIO3_PC8 = { GPIOC, IO_PIN_6, uC_IO_ALTERNATE_MAP_2 };
const uC_PERIPH_IO_STRUCT TIMER3_PIO4_PC9 = { GPIOC, IO_PIN_9, uC_IO_ALTERNATE_MAP_2 };

const uC_PERIPH_IO_STRUCT TIMER4_PIO1_PB6 = { GPIOB, IO_PIN_6, uC_IO_ALTERNATE_MAP_2 };
const uC_PERIPH_IO_STRUCT TIMER4_PIO2_PB7 = { GPIOB, IO_PIN_7, uC_IO_ALTERNATE_MAP_2 };
const uC_PERIPH_IO_STRUCT TIMER4_PIO3_PB8 = { GPIOB, IO_PIN_8, uC_IO_ALTERNATE_MAP_2 };
const uC_PERIPH_IO_STRUCT TIMER4_PIO4_PB9 = { GPIOB, IO_PIN_9, uC_IO_ALTERNATE_MAP_2 };
const uC_PERIPH_IO_STRUCT TIMER4_PIO1_PD12 = { GPIOD, IO_PIN_12, uC_IO_ALTERNATE_MAP_2 };
const uC_PERIPH_IO_STRUCT TIMER4_PIO2_PD13 = { GPIOD, IO_PIN_13, uC_IO_ALTERNATE_MAP_2 };
const uC_PERIPH_IO_STRUCT TIMER4_PIO3_PD14 = { GPIOD, IO_PIN_14, uC_IO_ALTERNATE_MAP_2 };
const uC_PERIPH_IO_STRUCT TIMER4_PIO4_PD15 = { GPIOD, IO_PIN_15, uC_IO_ALTERNATE_MAP_2 };

const uC_PERIPH_IO_STRUCT TIMER5_PIO1_PA0 = { GPIOA, IO_PIN_0, uC_IO_ALTERNATE_MAP_2 };
const uC_PERIPH_IO_STRUCT TIMER5_PIO2_PA1 = { GPIOA, IO_PIN_1, uC_IO_ALTERNATE_MAP_2 };
const uC_PERIPH_IO_STRUCT TIMER5_PIO3_PA2 = { GPIOA, IO_PIN_2, uC_IO_ALTERNATE_MAP_2 };
const uC_PERIPH_IO_STRUCT TIMER5_PIO4_PA3 = { GPIOA, IO_PIN_3, uC_IO_ALTERNATE_MAP_2 };
const uC_PERIPH_IO_STRUCT TIMER5_PIO1_PH10 = { GPIOH, IO_PIN_10, uC_IO_ALTERNATE_MAP_2 };
const uC_PERIPH_IO_STRUCT TIMER5_PIO2_PH11 = { GPIOH, IO_PIN_11, uC_IO_ALTERNATE_MAP_2 };
const uC_PERIPH_IO_STRUCT TIMER5_PIO3_PH12 = { GPIOH, IO_PIN_12, uC_IO_ALTERNATE_MAP_2 };
const uC_PERIPH_IO_STRUCT TIMER5_PIO4_PI0 = { GPIOI, IO_PIN_0, uC_IO_ALTERNATE_MAP_2 };

const uC_PERIPH_IO_STRUCT TIMER8_PIO1_PC6 = { GPIOC, IO_PIN_6, uC_IO_ALTERNATE_MAP_3 };
const uC_PERIPH_IO_STRUCT TIMER8_PIO2_PC7 = { GPIOC, IO_PIN_7, uC_IO_ALTERNATE_MAP_3 };
const uC_PERIPH_IO_STRUCT TIMER8_PIO3_PC8 = { GPIOC, IO_PIN_8, uC_IO_ALTERNATE_MAP_3 };
const uC_PERIPH_IO_STRUCT TIMER8_PIO4_PC9 = { GPIOC, IO_PIN_9, uC_IO_ALTERNATE_MAP_3 };
const uC_PERIPH_IO_STRUCT TIMER8_PIO1_PI5 = { GPIOI, IO_PIN_5, uC_IO_ALTERNATE_MAP_3 };
const uC_PERIPH_IO_STRUCT TIMER8_PIO2_PI6 = { GPIOI, IO_PIN_6, uC_IO_ALTERNATE_MAP_3 };
const uC_PERIPH_IO_STRUCT TIMER8_PIO3_PI7 = { GPIOI, IO_PIN_7, uC_IO_ALTERNATE_MAP_3 };
const uC_PERIPH_IO_STRUCT TIMER8_PIO4_PI2 = { GPIOI, IO_PIN_2, uC_IO_ALTERNATE_MAP_3 };

const uC_PERIPH_IO_STRUCT TIMER9_PIO1_PA2 = { GPIOA, IO_PIN_2, uC_IO_ALTERNATE_MAP_3 };
const uC_PERIPH_IO_STRUCT TIMER9_PIO2_PA3 = { GPIOA, IO_PIN_3, uC_IO_ALTERNATE_MAP_3 };
const uC_PERIPH_IO_STRUCT TIMER9_PIO1_PE5 = { GPIOE, IO_PIN_5, uC_IO_ALTERNATE_MAP_3 };
const uC_PERIPH_IO_STRUCT TIMER9_PIO2_PE6 = { GPIOE, IO_PIN_6, uC_IO_ALTERNATE_MAP_3 };
const uC_PERIPH_IO_STRUCT TIMER10_PIO1_PF6 = { GPIOF, IO_PIN_6, uC_IO_ALTERNATE_MAP_3 };
const uC_PERIPH_IO_STRUCT TIMER10_PIO1_PB8 = { GPIOB, IO_PIN_8, uC_IO_ALTERNATE_MAP_3 };
const uC_PERIPH_IO_STRUCT TIMER11_PIO1_PF7 = { GPIOF, IO_PIN_9, uC_IO_ALTERNATE_MAP_3 };
const uC_PERIPH_IO_STRUCT TIMER11_PIO1_PB9 = { GPIOB, IO_PIN_9, uC_IO_ALTERNATE_MAP_3 };
const uC_PERIPH_IO_STRUCT TIMER12_PIO1_PH6 = { GPIOH, IO_PIN_6, uC_IO_ALTERNATE_MAP_9 };
const uC_PERIPH_IO_STRUCT TIMER12_PIO2_PH9 = { GPIOH, IO_PIN_9, uC_IO_ALTERNATE_MAP_9 };
const uC_PERIPH_IO_STRUCT TIMER12_PIO1_PB14 = { GPIOB, IO_PIN_14, uC_IO_ALTERNATE_MAP_9 };
const uC_PERIPH_IO_STRUCT TIMER12_PIO2_PB15 = { GPIOB, IO_PIN_15, uC_IO_ALTERNATE_MAP_9 };
const uC_PERIPH_IO_STRUCT TIMER13_PIO1_PA6 = { GPIOA, IO_PIN_6, uC_IO_ALTERNATE_MAP_9 };
const uC_PERIPH_IO_STRUCT TIMER13_PIO1_PF8 = { GPIOF, IO_PIN_8, uC_IO_ALTERNATE_MAP_9 };
const uC_PERIPH_IO_STRUCT TIMER14_PIO1_PA7 = { GPIOA, IO_PIN_7, uC_IO_ALTERNATE_MAP_9 };
const uC_PERIPH_IO_STRUCT TIMER14_PIO1_PF9 = { GPIOF, IO_PIN_9, uC_IO_ALTERNATE_MAP_9 };
/*
 ******************************************
 *		ADC Peripheral
 */
const uC_PERIPH_IO_STRUCT ADC12_IN0_PIO = { GPIOA, IO_PIN_0, uC_IO_ALTERNATE_MAP_ANALOG };
const uC_PERIPH_IO_STRUCT ADC12_IN1_PIO = { GPIOA, IO_PIN_1, uC_IO_ALTERNATE_MAP_ANALOG };
const uC_PERIPH_IO_STRUCT ADC12_IN2_PIO = { GPIOA, IO_PIN_2, uC_IO_ALTERNATE_MAP_ANALOG };
const uC_PERIPH_IO_STRUCT ADC12_IN3_PIO = { GPIOA, IO_PIN_3, uC_IO_ALTERNATE_MAP_ANALOG };
const uC_PERIPH_IO_STRUCT ADC12_IN4_PIO = { GPIOA, IO_PIN_4, uC_IO_ALTERNATE_MAP_ANALOG };
const uC_PERIPH_IO_STRUCT ADC12_IN5_PIO = { GPIOA, IO_PIN_5, uC_IO_ALTERNATE_MAP_ANALOG };
const uC_PERIPH_IO_STRUCT ADC12_IN6_PIO = { GPIOA, IO_PIN_6, uC_IO_ALTERNATE_MAP_ANALOG };
const uC_PERIPH_IO_STRUCT ADC12_IN7_PIO = { GPIOA, IO_PIN_7, uC_IO_ALTERNATE_MAP_ANALOG };
const uC_PERIPH_IO_STRUCT ADC12_IN8_PIO = { GPIOB, IO_PIN_0, uC_IO_ALTERNATE_MAP_ANALOG };
const uC_PERIPH_IO_STRUCT ADC12_IN9_PIO = { GPIOB, IO_PIN_1, uC_IO_ALTERNATE_MAP_ANALOG };
const uC_PERIPH_IO_STRUCT ADC12_IN10_PIO = { GPIOC, IO_PIN_0, uC_IO_ALTERNATE_MAP_ANALOG };
const uC_PERIPH_IO_STRUCT ADC12_IN11_PIO = { GPIOC, IO_PIN_1, uC_IO_ALTERNATE_MAP_ANALOG };
const uC_PERIPH_IO_STRUCT ADC12_IN12_PIO = { GPIOC, IO_PIN_2, uC_IO_ALTERNATE_MAP_ANALOG };
const uC_PERIPH_IO_STRUCT ADC12_IN13_PIO = { GPIOC, IO_PIN_3, uC_IO_ALTERNATE_MAP_ANALOG };
const uC_PERIPH_IO_STRUCT ADC12_IN14_PIO = { GPIOC, IO_PIN_4, uC_IO_ALTERNATE_MAP_ANALOG };
const uC_PERIPH_IO_STRUCT ADC12_IN15_PIO = { GPIOC, IO_PIN_5, uC_IO_ALTERNATE_MAP_ANALOG };
const uC_PERIPH_IO_STRUCT ADC12_IN16_PIO = { GPIOC, IO_PIN_UNDEFINED, uC_IO_ALTERNATE_MAP_ANALOG };
const uC_PERIPH_IO_STRUCT ADC12_IN17_PIO = { GPIOC, IO_PIN_UNDEFINED, uC_IO_ALTERNATE_MAP_ANALOG };
const uC_PERIPH_IO_STRUCT ADC12_IN18_PIO = { GPIOC, IO_PIN_UNDEFINED, uC_IO_ALTERNATE_MAP_ANALOG };

const uC_PERIPH_IO_STRUCT ADC3_IN0_PIO = { GPIOA, IO_PIN_0, uC_IO_ALTERNATE_MAP_ANALOG };
const uC_PERIPH_IO_STRUCT ADC3_IN1_PIO = { GPIOA, IO_PIN_1, uC_IO_ALTERNATE_MAP_ANALOG };
const uC_PERIPH_IO_STRUCT ADC3_IN2_PIO = { GPIOA, IO_PIN_2, uC_IO_ALTERNATE_MAP_ANALOG };
const uC_PERIPH_IO_STRUCT ADC3_IN3_PIO = { GPIOA, IO_PIN_3, uC_IO_ALTERNATE_MAP_ANALOG };
const uC_PERIPH_IO_STRUCT ADC3_IN4_PIO = { GPIOF, IO_PIN_6, uC_IO_ALTERNATE_MAP_ANALOG };
const uC_PERIPH_IO_STRUCT ADC3_IN5_PIO = { GPIOF, IO_PIN_7, uC_IO_ALTERNATE_MAP_ANALOG };
const uC_PERIPH_IO_STRUCT ADC3_IN6_PIO = { GPIOF, IO_PIN_8, uC_IO_ALTERNATE_MAP_ANALOG };
const uC_PERIPH_IO_STRUCT ADC3_IN7_PIO = { GPIOF, IO_PIN_9, uC_IO_ALTERNATE_MAP_ANALOG };
const uC_PERIPH_IO_STRUCT ADC3_IN8_PIO = { GPIOF, IO_PIN_10, uC_IO_ALTERNATE_MAP_ANALOG };
const uC_PERIPH_IO_STRUCT ADC3_IN9_PIO = { GPIOF, IO_PIN_3, uC_IO_ALTERNATE_MAP_ANALOG };
const uC_PERIPH_IO_STRUCT ADC3_IN10_PIO = { GPIOC, IO_PIN_0, uC_IO_ALTERNATE_MAP_ANALOG };
const uC_PERIPH_IO_STRUCT ADC3_IN11_PIO = { GPIOC, IO_PIN_1, uC_IO_ALTERNATE_MAP_ANALOG };
const uC_PERIPH_IO_STRUCT ADC3_IN12_PIO = { GPIOC, IO_PIN_2, uC_IO_ALTERNATE_MAP_ANALOG };
const uC_PERIPH_IO_STRUCT ADC3_IN13_PIO = { GPIOC, IO_PIN_3, uC_IO_ALTERNATE_MAP_ANALOG };
const uC_PERIPH_IO_STRUCT ADC3_IN14_PIO = { GPIOF, IO_PIN_4, uC_IO_ALTERNATE_MAP_ANALOG };
const uC_PERIPH_IO_STRUCT ADC3_IN15_PIO = { GPIOF, IO_PIN_5, uC_IO_ALTERNATE_MAP_ANALOG };
const uC_PERIPH_IO_STRUCT ADC3_IN16_PIO = { GPIOF, IO_PIN_UNDEFINED, uC_IO_ALTERNATE_MAP_ANALOG };
const uC_PERIPH_IO_STRUCT ADC3_IN17_PIO = { GPIOF, IO_PIN_UNDEFINED, uC_IO_ALTERNATE_MAP_ANALOG };
const uC_PERIPH_IO_STRUCT ADC3_IN18_PIO = { GPIOF, IO_PIN_UNDEFINED, uC_IO_ALTERNATE_MAP_ANALOG };
...
/// ********** Outputs **********
const uC_PERIPH_IO_STRUCT ETH_MII_MDIO_PIO = { GPIOA, IO_PIN_2, uC_IO_ALTERNATE_MAP_11 };
const uC_PERIPH_IO_STRUCT ETH_MII_TXD3_PIO_PE2 = { GPIOE, IO_PIN_2, uC_IO_ALTERNATE_MAP_11 };
const uC_PERIPH_IO_STRUCT ETH_MII_TXD3_PIO = { GPIOB, IO_PIN_8, uC_IO_ALTERNATE_MAP_11 };
const uC_PERIPH_IO_STRUCT ETH_MII_TX_EN_PIO = { GPIOB, IO_PIN_11, uC_IO_ALTERNATE_MAP_11 };
const uC_PERIPH_IO_STRUCT ETH_MII_TXD0_PIO = { GPIOB, IO_PIN_12, uC_IO_ALTERNATE_MAP_11 };
const uC_PERIPH_IO_STRUCT ETH_MII_TXD1_PIO_PG14 = { GPIOG, IO_PIN_14, uC_IO_ALTERNATE_MAP_11 };
const uC_PERIPH_IO_STRUCT ETH_MII_TXD1_PIO = { GPIOB, IO_PIN_13, uC_IO_ALTERNATE_MAP_11 };
const uC_PERIPH_IO_STRUCT ETH_MII_MDC_PIO = { GPIOC, IO_PIN_1, uC_IO_ALTERNATE_MAP_11 };
const uC_PERIPH_IO_STRUCT ETH_MII_TXD2_PIO = { GPIOC, IO_PIN_2, uC_IO_ALTERNATE_MAP_11 };
// const uC_PERIPH_IO_STRUCT 	ETH_MII_PPS_OUT_PIO		= { GPIOB, IO_PIN_5, uC_IO_ALTERNATE_MAP_11 };	//Unused
const uC_PERIPH_IO_STRUCT ETH_MII_TXD0_PIO_PG13 = { GPIOG, IO_PIN_13, uC_IO_ALTERNATE_MAP_11 };
const uC_PERIPH_IO_STRUCT ETH_MII_TX_EN_PIO_PG11 = { GPIOG, IO_PIN_11, uC_IO_ALTERNATE_MAP_11 };

/// ********** Inputs **********
const uC_PERIPH_IO_STRUCT ETH_MII_COL_PIO = { GPIOA, IO_PIN_3, uC_IO_ALTERNATE_MAP_11 };
const uC_PERIPH_IO_STRUCT ETH_MII_CRS_WKUP_PIO = { GPIOA, IO_PIN_0, uC_IO_ALTERNATE_MAP_11 };
const uC_PERIPH_IO_STRUCT ETH_MII_TX_CLK_PIO = { GPIOC, IO_PIN_3, uC_IO_ALTERNATE_MAP_11 };
const uC_PERIPH_IO_STRUCT ETH_MII_RX_ER_PIO = { GPIOB, IO_PIN_10, uC_IO_ALTERNATE_MAP_11 };
const uC_PERIPH_IO_STRUCT ETH_MII_RX_CLK_PIO = { GPIOA, IO_PIN_1, uC_IO_ALTERNATE_MAP_11 };
const uC_PERIPH_IO_STRUCT ETH_MII_RX_ER_PIO_PI10 =
{ GPIOI, static_cast<uint8_t>( IO_PIN_10 ), static_cast<uint8_t>( uC_IO_ALTERNATE_MAP_11 ) };

const uC_PERIPH_IO_STRUCT ETH_MII_COL_PIO_PH3 = { GPIOH, IO_PIN_3, uC_IO_ALTERNATE_MAP_11 };
const uC_PERIPH_IO_STRUCT ETH_MII_CRS_WKUP_PIO_PH2 = { GPIOH, IO_PIN_2, uC_IO_ALTERNATE_MAP_11 };
const uC_PERIPH_IO_STRUCT ETH_MII_RX_DV_PIO = { GPIOA, IO_PIN_7, uC_IO_ALTERNATE_MAP_11 };
const uC_PERIPH_IO_STRUCT ETH_MII_RXD0_PIO = { GPIOC, IO_PIN_4, uC_IO_ALTERNATE_MAP_11 };
const uC_PERIPH_IO_STRUCT ETH_MII_RXD1_PIO = { GPIOC, IO_PIN_5, uC_IO_ALTERNATE_MAP_11 };
const uC_PERIPH_IO_STRUCT ETH_MII_RXD2_PIO = { GPIOB, IO_PIN_0, uC_IO_ALTERNATE_MAP_11 };
const uC_PERIPH_IO_STRUCT ETH_MII_RXD3_PIO = { GPIOB, IO_PIN_1, uC_IO_ALTERNATE_MAP_11 };
// const uC_PERIPH_IO_STRUCT 	ETH_MII_RX_DV_PIO   = { GPIOD, IO_PIN_8, uC_IO_ALTERNATE_MAP_11 };
// const uC_PERIPH_IO_STRUCT 	ETH_MII_RXD0_PIO    = { GPIOD, IO_PIN_9, uC_IO_ALTERNATE_MAP_11 };
// const uC_PERIPH_IO_STRUCT 	ETH_MII_RXD1_PIO    = { GPIOD, IO_PIN_10, uC_IO_ALTERNATE_MAP_11 };
// const uC_PERIPH_IO_STRUCT 	ETH_MII_RXD2_PIO    = { GPIOD, IO_PIN_11, uC_IO_ALTERNATE_MAP_11 };
// const uC_PERIPH_IO_STRUCT 	ETH_MII_RXD3_PIO    = { GPIOD, IO_PIN_12, uC_IO_ALTERNATE_MAP_11 };
const uC_PERIPH_IO_STRUCT ETH_MII_RXD2_PIO_PH6 = { GPIOH, IO_PIN_6, uC_IO_ALTERNATE_MAP_11 };
const uC_PERIPH_IO_STRUCT ETH_MII_RXD3_PIO_PH7 = { GPIOH, IO_PIN_7, uC_IO_ALTERNATE_MAP_11 };
 ...
 */
/// ********** Outputs **********
const uC_PERIPH_IO_STRUCT ETH_RMII_MDIO_PIO = { GPIOA, IO_PIN_2, uC_IO_ALTERNATE_MAP_11 };
const uC_PERIPH_IO_STRUCT ETH_RMII_TX_EN_PIO = { GPIOB, IO_PIN_11, uC_IO_ALTERNATE_MAP_11 };
const uC_PERIPH_IO_STRUCT ETH_RMII_TXD0_PIO = { GPIOB, IO_PIN_12, uC_IO_ALTERNATE_MAP_11 };
const uC_PERIPH_IO_STRUCT ETH_RMII_TXD1_PIO = { GPIOB, IO_PIN_13, uC_IO_ALTERNATE_MAP_11 };
const uC_PERIPH_IO_STRUCT ETH_RMII_MDC_PIO = { GPIOC, IO_PIN_1, uC_IO_ALTERNATE_MAP_11 };
// const uC_PERIPH_IO_STRUCT 	ETH_RMII_PPS_OUT_PIO	= { GPIOB, IO_PIN_5, uC_IO_ALTERNATE_MAP_11 };	//Unused

/// ********** Inputs **********
const uC_PERIPH_IO_STRUCT ETH_RMII_REF_CLK_PIO = { GPIOA, IO_PIN_1, uC_IO_ALTERNATE_MAP_11 };

const uC_PERIPH_IO_STRUCT ETH_RMII_CRS_DV_PIO = { GPIOA, IO_PIN_7, uC_IO_ALTERNATE_MAP_11 };
const uC_PERIPH_IO_STRUCT ETH_RMII_RXD0_PIO = { GPIOC, IO_PIN_4, uC_IO_ALTERNATE_MAP_11 };
const uC_PERIPH_IO_STRUCT ETH_RMII_RXD1_PIO = { GPIOC, IO_PIN_5, uC_IO_ALTERNATE_MAP_11 };
// const uC_PERIPH_IO_STRUCT 	ETH_RMII_CRS_DV_PIO   = { GPIOD, IO_PIN_8, uC_IO_ALTERNATE_MAP_11 };
// const uC_PERIPH_IO_STRUCT 	ETH_RMII_RXD0_PIO    = { GPIOD, IO_PIN_9, uC_IO_ALTERNATE_MAP_11 };
// const uC_PERIPH_IO_STRUCT 	ETH_RMII_RXD1_PIO    = { GPIOD, IO_PIN_10, uC_IO_ALTERNATE_MAP_11 };
