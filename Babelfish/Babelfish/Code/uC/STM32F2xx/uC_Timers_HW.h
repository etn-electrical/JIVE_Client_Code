...
class uC_Timers_HW
{
	public:
		...
		/**@brief  This function is used to reset and enable the counter*/
		...
		/**
		 * @brief  This function is used to get the time in nanoseconds.
		 */
		inline static uint32_t Get_Time_nSec( void ) { return ( *DWT_CYCCNT ); }

		/**
		 * @brief  This function is used to get the elapsed time in nanoseconds.
		 */
