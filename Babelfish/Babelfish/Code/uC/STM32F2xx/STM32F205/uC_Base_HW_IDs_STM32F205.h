 ...
 *****************************************************************************************
 */
#ifndef uC_BASE_HW_IDS_STM32F205_H
   #define uC_BASE_HW_IDS_STM32F205_H

#include "uC_STM32F205.h"

#ifdef __IAR_SYSTEMS_ICC__		// This makes sure that the assembly compile will not include the following.


#include "uC_IO_Define_STM32F205.h"
...
enum
{
	uC_BASE_STM32F205_PCLK_INDEX_AHB1,		// These first three must match the "Peripheral Power Definition Structure"
	uC_BASE_STM32F205_PCLK_INDEX_AHB2,		// enumeration in uC_Base.h.
	uC_BASE_STM32F205_PCLK_INDEX_AHB3,
	uC_BASE_STM32F205_PCLK_INDEX_APB1,
	uC_BASE_STM32F205_PCLK_INDEX_APB2,
	uC_BASE_STM32F205_PCLK_INDEX_TIMERS2to7,
	uC_BASE_STM32F205_PCLK_INDEX_TIMER1and8,
	uC_BASE_STM32F205_PCLK_INDEX_TIMER_ADC,
	uC_BASE_STM32F205_MAX_PCLKS
};
...
#define DMA_UART5RX_D1S0C4      ( static_cast<uint8_t>( uC_DMA1_STREAM_0 ) | \
								  ( static_cast<uint8_t>( static_cast<uint8_t>( uC_DMA_CHANNEL_4 ) << \
	DMA_STREAM_CHANNEL_SHIFT ) ) )																																		//
																																										// Default
#define DMA_SPI3RX_D1S0C0       ( static_cast<uint8_t>( uC_DMA1_STREAM_0 ) | \
								  ( static_cast<uint8_t>( static_cast<uint8_t>( uC_DMA_CHANNEL_0 ) << \
	DMA_STREAM_CHANNEL_SHIFT ) ) )																																		//
																																										// Default
...
#define DMA_USART6RX_D1S1C5     ( static_cast<uint8_t>( uC_DMA1_STREAM_1 ) | \
								  ( static_cast<uint8_t>( static_cast<uint8_t>( uC_DMA_CHANNEL_5 ) << \
	DMA_STREAM_CHANNEL_SHIFT ) ) )
...
#define DMA_I2C3RX_D1S2C3       ( static_cast<uint8_t>( uC_DMA1_STREAM_2 ) | \
								  ( static_cast<uint8_t>( static_cast<uint8_t>( uC_DMA_CHANNEL_3 ) << \
	DMA_STREAM_CHANNEL_SHIFT ) ) )																																		//
																																										// Default
...
#define DMA_I2C2RX_D1S3C7               ( static_cast<uint8_t>( uC_DMA1_STREAM_3 ) | \
										  ( static_cast<uint8_t>( static_cast<uint8_t>( uC_DMA_CHANNEL_7 ) << \
	DMA_STREAM_CHANNEL_SHIFT ) ) )																																				//
																																												// Default
...
#define DMA_I2C1RX_D1S5C1       ( static_cast<uint8_t>( uC_DMA1_STREAM_5 ) | \
								  ( static_cast<uint8_t>( static_cast<uint8_t>( uC_DMA_CHANNEL_1 ) << \
	DMA_STREAM_CHANNEL_SHIFT ) ) )
...
#define DMA_ADC3_D2S1C2         ( static_cast<uint8_t>( uC_DMA2_STREAM_1 ) | \
								  ( static_cast<uint8_t>( static_cast<uint8_t>( uC_DMA_CHANNEL_2 ) << \
	DMA_STREAM_CHANNEL_SHIFT ) ) )
