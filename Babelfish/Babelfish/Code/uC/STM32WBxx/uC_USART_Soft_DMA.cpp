										 ...
										 uint32_t rx_byte_time, uint32_t tx_holdoff_time )
{
	...
	}// Someone has a null timer and still asked for a rx/tx time.  Should tell them.
	else if ( ( rx_byte_time != 0 ) || ( tx_holdoff_time == 0 ) ||
	...
	{
		// Else deliberately empty.  Everything is alright.
	}
