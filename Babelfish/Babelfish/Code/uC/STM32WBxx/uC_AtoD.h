 ...
 *                  over ADC channels on STM32WBxx.
 * @details
...
#define ADC_VOLTAGE_REGULATOR_START_TIME_uS  20U
...
class uC_AtoD
{
	...
	public:
		 ...
		 * @n                                 uC_ATOD_6BIT_RESOLUTION : Selects 6 Bit Resolution
		 * @n                                 uC_ATOD_8BIT_RESOLUTION : Selects 8 Bit Resolution
		 * @n                                 uC_ATOD_10BIT_RESOLUTION : Selects 10 Bit Resolution
		 * @n                                 uC_ATOD_12BIT_RESOLUTION : Selects 12 Bit Resolution
		 * @param[in] active_channels_mask    Specifies ADC channels used in application. STM32WB55 features total 19
	...
	private:
		...
		/**
		 * @brief dma channel mux structure member.
		 */
		DMA_CHannel_MUX m_dma_channel_mux;
