 ...
 *****************************************************************************************
 */
#ifndef uC_Base_STM32WB55R_H
   #define uC_Base_STM32WB55R_H
...
{
	BROWN_OUT_OPT_SEL_1p7,
	BROWN_OUT_OPT_SEL_2p0,
	BROWN_OUT_OPT_SEL_2p2,
	BROWN_OUT_OPT_SEL_2p5,
	BROWN_OUT_OPT_SEL_2p8
} BROWN_OUT_OPT_SELECT_EN;
 ...
 *  Class Declaration
   --------------------------------------------------------------------------------------------------
 */
class uC_Base_STM32WB55R : public uC_Base
{
	public:
		uC_Base_STM32WB55R( void );
		~uC_Base_STM32WB55R( void );
		...
		uC_BASE_LPTIMER_IO_STRUCT const* Get_LPTimer_Ctrl( uint32_t timer );
	...
	private:
		...
		static const uC_BASE_LPTIMER_IO_STRUCT m_lptimer_io[uC_BASE_MAX_LPTIMER_CTRLS];
		...
		static const uint32_t m_pclock_freqs[uC_BASE_STM32WB55R_MAX_PCLKS];
