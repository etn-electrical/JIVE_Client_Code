 ...
 *****************************************************************************************
 */
#ifndef uC_USART_9BIT_SOFT_DMA_H
   #define uC_USART_9BIT_SOFT_DMA_H
 ...
 ****************************************************************************************
 */
class uC_USART_9BIT_Soft_DMA : public uC_USART_9BIT_HW
	, public uC_USART_9BIT_Buff
{
	public:
		 ...
		 */
		uC_USART_9BIT_Soft_DMA( uint8_t hw_usart_num, uint8_t hw_timer_num,
								const uC_BASE_USART_IO_PORT_STRUCT* io_port = NULL );

		/**
		 * @brief The destructor.
		 */
		~uC_USART_9BIT_Soft_DMA( void );
	...
	private:
		 ...
		 * to disallow usage.
		 */
		uC_USART_9BIT_Soft_DMA( const uC_USART_9BIT_Soft_DMA& rhs );
		uC_USART_9BIT_Soft_DMA & operator =( const uC_USART_9BIT_Soft_DMA& object );
		...
		{ ( ( uC_USART_9BIT_Soft_DMA* )handle )->USART_Int(); }
		...
		{ ( ( uC_USART_9BIT_Soft_DMA* )handle )->RX_Timer_Int(); }
		...
		{ ( ( uC_USART_9BIT_Soft_DMA* )handle )->TX_Timer_Int(); }
		...
		uC_USART_9BIT_Buff::char_size_t m_char_size;
		enum
		{
			RX_TIMER,
			TX_TIMER,
