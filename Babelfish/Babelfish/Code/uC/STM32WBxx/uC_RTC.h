...
class uC_RTC
{
	public:
		...
		enum RTC_index_t
		{
			RTC_1	///< STM32WB has only 1 RTC peripheral
		};
		 ...
		 *					Preferably use LSE as it provides better functionality
		 *					w.r.f Section 8.2.16 Reference Mannual RM0434 Rev 4
		 ...
		 * @param1 BackupRegister RTC Backup data Register number.
		 *          This parameter can be from 0 to 19 to specify the register.
		...
		/**
		 * @brief  	Returns the the pointer to uC_RTC,
		 *			Basically returning 'this' pointer
		 *
		 * @retval 	pointer
		 */
