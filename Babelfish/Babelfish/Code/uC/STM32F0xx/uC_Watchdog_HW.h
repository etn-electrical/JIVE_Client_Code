 ...
 *
 *	 @brief         This file shall wrap all the functions required for watchdog hardware
 * functionality
 *
...
/*
 **************************************************************************************************
 *  uc_WatchdogHW class declaration     This class includes all the functions used to reset the
...
class uC_Watchdog_HW
{
	public:
		 ...
		 * @note            This function is used to set the timeout value of the downcounter by
		 * changing value of the prescaler index.
		 *                  The prescaling is done by changing the value loaded into the
		 * m_prescalers array from[000 -111].
		 ...
		 * @note            This function is used to reload count value of0xAAAA into the key
		 * register of IWDG to restart the counter.
		 */
