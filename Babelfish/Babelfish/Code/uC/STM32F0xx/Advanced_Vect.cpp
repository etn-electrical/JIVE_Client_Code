	...
	m_func_index( 0U )
{
	...
	{
		m_cback_params = static_cast<cback_param_t*>( Ram::Allocate(
														  sizeof( cback_param_t ) *
														  m_cback_funcs_max ) );
		m_cback_funcs = static_cast<cback_func_t*>( Ram::Allocate(
														sizeof( cback_func_t ) *
														m_cback_funcs_max ) );
	}
	// We have used too many advanced vectors.  Create more.
