...
class uC_Reset
{
	public:
		 ...
		 * @note                     When the object is created using this constructor, the
		 * constructor
		 *                           finds out the cause of last microcontroller reset by reading
		 * the
		...
		/**
		 * @brief                   Destructor to delete the uC_Reset instance when it goes out of
		 * scope
		 */
		~uC_Reset()
		{}
		 ...
		 *                          Integrator should use this function when he wants to perform
		 * soft
		 *                          reset
		 * @note
		 */
		...
		/**
		 * @brief                   This function envokes watchdog reset
		 * @note                    It put the system/micro in exception state and triggers watchdog
		 * reset
		 *                          Do not use this if you dont want to put micro in exception
		 * state.
		 *
		 */
