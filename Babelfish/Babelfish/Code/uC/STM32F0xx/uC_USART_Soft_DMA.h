	...
	, public uC_USART_Buff
{
	...
	private:
		...
		static const uint32_t M_TIME_TO_FREQ_CALC = 1000000U;

		// The multi timer indexes.
		static const uint8_t RX_TIMER = 0U;
		static const uint8_t TX_TIMER = 1U;
		static const uint8_t TOTAL_TIMERS = 2U;
