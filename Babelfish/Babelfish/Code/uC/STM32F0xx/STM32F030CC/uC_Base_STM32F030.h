 ...
 *****************************************************************************************
 */
#ifndef uC_Base_STM32F030_H
#define uC_Base_STM32F030_H
 ...
 *  Class Declaration
   --------------------------------------------------------------------------------------------------
 */
class uC_Base_STM32F030 : public uC_Base
{
	public:
		uC_Base_STM32F030( void );
		~uC_Base_STM32F030( void );
	...
	private:
		...
		static const uint32_t m_pclock_freqs[uC_BASE_STM32F030_MAX_PCLKS];
