...
typedef struct
{
	...
	UINT8 filterMatchIndex;		// Specifies the index of the filter the message stored in the
								// mailbox passes through
...
class uC_CAN
{
	public:
		...
		void InitMailboxRegisters( UINT8 CAN_Filter_Index, UINT32 mesg_id, UINT8 format,
								   UINT8 isRTR );
