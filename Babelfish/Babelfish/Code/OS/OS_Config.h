...
#ifdef FREERTOS_V10
#error Wrong Definition: FREERTOS_V10 must not be defined if we are not using OS_FreeRTOS
// You probably want v10 of FreeRTOS but gave the path to this older version of it.
#endif
 ...
 */
#define CONFIG_CPU_CLOCK_HZ             SYSTICK_CLOCK_FREQ
...
/**
 * @brief Selects whether to use alternative API.
 * @details Defined as any non-zero value enables feature, undefined or zero value disables feature.
 */
// alternative API's: simpler, faster although less interrupt responsive
#define CONFIG_USE_ALTERNATIVE_API      1
 ...
 */
#define CONFIG_MAX_TASK_NAME_LEN            10U
