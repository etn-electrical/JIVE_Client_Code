...
#if BF_DCI_DBG
	#define DCI_DBG_PRINT  BF_DBG_ON
#else
	#define DCI_DBG_PRINT  BF_DBG_OFF
#endif
 ...
 */
#ifndef DCI_PRINT_ENABLE_MASK
	#define DCI_ENABLE_MASK     DEBUG_MASK( DCI_DBG_PRINT )
#endif
 ...
 */
#define DCI_DEBUG_PRINT( MessageType, ... )     BF_DEBUG_PRINT( DCI_ENABLE_MASK, MessageType, __VA_ARGS__ )

#endif	// #ifndef DCI_DEBUG_H
