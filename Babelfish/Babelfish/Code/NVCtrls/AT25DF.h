...
typedef struct AT25DF_CHIP_CONFIG_TD
{
...
} AT25DF_CHIP_CONFIG_TD;

typedef enum AT25DF_CHIP_STATUS_EN
{
	AT25DF_CHIP_BUSY,
	AT25DF_CHIP_ERROR_PG,
	AT25DF_CHIP_ERROR_WRP,
	AT25DF_CHIP_COMPLETE,
	AT25DF_CHIP_TIMEOUT
} AT25DF_CHIP_STATUS_EN;
...
class AT25DF : public NV_Ctrl
{
	public:
		 ...
		 * @return None
		 */
		AT25DF( uC_SPI* spi_ctrl, uint8_t chip_select, AT25DF_CHIP_CONFIG_TD const* chip_config,
	...
	private:
		...
		AT25DF_CHIP_CONFIG_TD const* m_chip_cfg;
