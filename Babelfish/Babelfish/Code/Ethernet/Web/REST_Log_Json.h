/**
 *****************************************************************************************
 *	@file        REST_Log_Json.h
 *
 *	@brief       LOG header file for the webservices. This file shall wrap the functions required for webservices using
 * REST protocol to asscess LOG information.
 *
...
#ifndef REST_LOG_JSON_H
#define REST_LOG_JSON_H
