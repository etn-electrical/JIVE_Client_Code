/* author: Ting Yan, August 22, 2010
   KSZ8081 PHY related definitions*/
...
// #define KSZ8081_VIRTUAL_PORT_ADDR   0
...
#define PHY_KSZ8081_REG_INTRPT_JABBER    0x80
#define PHY_KSZ8081_REG_INTRPT_RXERR     0x40
#define PHY_KSZ8081_REG_INTRPT_PGERR     0x20
#define PHY_KSZ8081_REG_INTRPT_PRLFAULT  0x10
#define PHY_KSZ8081_REG_INTRPT_LPACK     0x08
#define PHY_KSZ8081_REG_INTRPT_LINKDOWN  0x04
#define PHY_KSZ8081_REG_INTRPT_REM_FAULT 0x02
#define PHY_KSZ8081_REG_INTRPT_LINKUP    0x01

/* KSZ8081 Special Register definitions. */

/* Link Partner Next Page Ability */
#define PHY_KSZ8081_REG_LPNPA            0x08
/* Use for power saving, will probably not need this... */
#define PHY_KSZ8081_REG_AFE_CTRL1        0x11
/* RXER Counter (Receive error counter for Symbol Error frames) */
#define PHY_KSZ8081_REG_RXER             0x15
/* Override the bootstrap settings. */
#define PHY_KSZ8081_REG_STRAP_OVERRIDE   0x16
/* Oeration mode strap status. */
#define PHY_KSZ8081_REG_STRAP_STRAPST    0x17
/* Expanded control. */
#define PHY_KSZ8081_REG_STRAP_EXPCTRL    0x18
/* Interrupt Control/Status. */
#define PHY_KSZ8081_REG_INTRPT           0x1B
/* LinkMD. */
#define PHY_KSZ8081_REG_STRAP_LINKMD     0x1D

static const uint16_t PHY_SPECIAL_CONTROL_STATUS_AUTODONE_COMPLETED = 0x1000;
static const uint16_t PHY_SPECIAL_CONTROL_STATUS_SPEED_MASK = 0x0003;
static const uint16_t PHY_SPECIAL_CONTROL_STATUS_SPEED_DUPLEX_MASK = 0x0007;
static const uint16_t PHY_SPECIAL_CONTROL_STATUS_MODE_FULL_DUPLEX = 0x0004;
static const uint16_t PHY_SPECIAL_CONTROL_STATUS_SPEED_100M = 0x0002;
