...
#ifndef IP101GRI_REG_H
#define IP101GRI_REG_H
...
#define PHY_SPECIAL_CONTROL_STATUS_OFFSET                   30U
...
static const uint16_t PHY_SPECIAL_CONTROL_STATUS_SPEED_MASK = 0x0007;
static const uint16_t PHY_SPECIAL_CONTROL_STATUS_SPEED_10M_HALF_DUPLEX = 0x0001;
static const uint16_t PHY_SPECIAL_CONTROL_STATUS_SPEED_100M_HALF_DUPLEX = 0x0002;
static const uint16_t PHY_SPECIAL_CONTROL_STATUS_SPEED_10M_FULL_DUPLEX = 0x0005;
static const uint16_t PHY_SPECIAL_CONTROL_STATUS_SPEED_100M_FULL_DUPLEX = 0x0006;
