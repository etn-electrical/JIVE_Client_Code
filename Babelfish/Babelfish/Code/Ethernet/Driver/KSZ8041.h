/**
 **********************************************************************************************
 * @file            KSZ8041 Header File for driver class.
 *
...
class KSZ8041 : public PHY_Driver
{
	public:
		/**
		 ...
		 * @n
		 */
		KSZ8041( BF_Lib::Output* reset_ctrl, EMAC_Driver* emac_ctrl, bool_t switch_enable, bool_t alr_learn,
				 uint8_t PhyAddr );
	...
	private:
		...
		{
			return ( ( ( v & PHY_SPECIAL_CONTROL_STATUS_SPEED_MASK ) == PHY_SPECIAL_CONTROL_STATUS_SPEED_100M ) ? \
					 true : false );
		}
		...
		{
			return ( ( ( v & PHY_SPECIAL_CONTROL_STATUS_MODE_FULL_DUPLEX ) ) ? true : false );
		}
		...
		{
			return ( ( !( v & PHY_SPECIAL_CONTROL_STATUS_SPEED_DUPLEX_MASK ) ) ? true : false );
		}
