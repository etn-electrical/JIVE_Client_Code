 ...
 *	@brief image control.
 *
 *	@details This class will provide interfaces of image controls
 *
	...
	, public Image_Header
{
	public:
		 ...
		 * @return Status
		 */
		Image_Ctrl( NV_Ctrl* scratch_nv_ctrl, NV_Ctrl* real_nv_ctrl,
		...
		{
			reinterpret_cast<Image_Ctrl*>( param )->Image_Status_Cb( status );
		}
	...
	private:
		...
		{
			reinterpret_cast<Image_Ctrl*>( handle )->Image_Upgrade_Task( cr_task );
		}
