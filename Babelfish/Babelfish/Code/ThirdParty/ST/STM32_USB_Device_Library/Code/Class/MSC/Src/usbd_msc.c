/* Modified by Eaton. 
 * Exported functions USBD_MSC_Init() et al to support composite device operation.
 * Tweaked pClassData and pUserData to support composite device operation.
 * R. Wilder 2014/07/10
 */
/**
  ******************************************************************************
...
#define pClassData pMscClassData
#define pUserData pMscUserData
