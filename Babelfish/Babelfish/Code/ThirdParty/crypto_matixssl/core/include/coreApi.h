 ...
 */
PSPUBLIC psPool_t *psOpenPool(char *name, uint32 size, int32 type,
                              void *staticAddr, void *userPtr);
PSPUBLIC void       psClosePool(psPool_t *pool);
PSPUBLIC void       psSetPoolFlags(psPool_t *pool, int flags);
PSPUBLIC int32      psAddPoolCache(psPool_t *pool, uint32 size);
PSPUBLIC void *psMalloc(psPool_t *pool, size_t size);
PSPUBLIC void       psFree(void *ptr, psPool_t *pool);
PSPUBLIC void *psCalloc(psPool_t *pool, size_t n, size_t size);
PSPUBLIC void *psRealloc(void *ptr, size_t n, psPool_t *pool);
...
PSPUBLIC int32 psMallocAlign(psPool_t *pool, unsigned char **memptr,
                             unsigned char **trueptr, size_t size);
PSPUBLIC int32 psReallocAlign(unsigned char **memptr, unsigned char **trueptr,
...
/* Networking support is in its own file. */
#   include "psnet.h"
