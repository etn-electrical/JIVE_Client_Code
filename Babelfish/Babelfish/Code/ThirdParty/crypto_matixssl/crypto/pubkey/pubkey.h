...
#  ifdef USE_CERT_GEN
extern int32_t psRsaMakeKey(psPool_t *pool, psSize_t size, uint32_t e,
                            psRsaKey_t **ptrKey);
extern int32_t psRsaWritePrivKeyMem(psPool_t *pool, const psRsaKey_t *key,
                                    unsigned char **keyMem, psSize_t *keyMemLen);
#   ifdef MATRIX_USE_FILE_SYSTEM
extern int32_t psRsaWritePrivKeyFile(psPool_t *pool, const psRsaKey_t *key,
