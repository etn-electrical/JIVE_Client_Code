...
#  ifdef USE_MATRIX_MEMORY_MANAGEMENT
    int32 poolSize = sizeof(sslSessionId_t) + sizeof(psPool_t) + MIN_BLOCK_SIZE;

#   ifdef USE_STATELESS_SESSION_TICKETS
    poolSize += 512; /* Size enough to hold a ticket */
#   endif

    if ((pool = psOpenPool("SESSION_ID", poolSize, 0, NULL, poolUserPtr))
        == NULL)
    {
        return PS_MEM_FAIL;
    }
