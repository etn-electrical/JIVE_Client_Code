...
/*The MACRO (__STDC_WANT_LIB_EXT1__) is disabled to fix the Warning[Pe1215]: function " __nounwind memcpy" was declared deprecated*/
...
/*If the MACRO (__STDC_WANT_LIB_EXT1__) is disabled, a new warning "Warning[Pe223]: function "strnlen_s" declared implicitly" is getting generated,*/
#ifndef __STDC_LIB_EXT1__   /* to fix the warning #ifndef is applied to MACRO __STDC_LIB_EXT1__*/
