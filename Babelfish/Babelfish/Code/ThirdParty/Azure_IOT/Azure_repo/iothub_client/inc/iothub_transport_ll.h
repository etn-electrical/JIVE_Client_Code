...
/************************************************************************
 ***** Eaton addition: include product-specific configuration header ****
 *
 * This header seems to be the most basic in the Azure code, included
 * by all the files of interest.
 ************************************************************************/
