...
#if VPC3_SERIAL_MODE
 // Updated by Sagar on 24.09.2012 for DPV1 integration
...
/* dp_user.c                                                              */
/*------------------------------------------------------------------------*/
extern void                   DpAppl_ProfibusInit                  ( UBYTE profiSlaveAdd );
extern void                   DpAppl_ProfibusMain                  ( void );
extern void                   DpAppl_FatalError                    ( DP_ERROR_FILE file, UWORD line, VPC3_ERRCB_PTR errcb_ptr );
...
extern void 				  VPC3_Poll_DX_Out_And_Param				 (void);

/*------------------------------------------------------------------------*/
/* dp_fdl.c                                                               */
/*------------------------------------------------------------------------*/
#if DP_FDL
extern DP_ERROR_CODE       FDL_InitAcyclicServices             ( uint8_t bSlaveAddress, sFdl_Init sFdlInit );        // Added by Sagar #stackUpgrade
...
// Added by Sagar on 23.08.2012 to include "Check_Config_Data" function defination
#if( ISR_ENABLE_VPC3_INT_NEW_CFG_DATA == 1 )
    extern UBYTE Check_Config_Data( UBYTE* cfg_buffer_ptr, UBYTE* rd_cfg_buffer_ptr, 
										   UBYTE cfg_data_len, UBYTE rd_cfg_data_len );
		//VPC3_UBYTE user_chk_new_cfg_data( void );
		
#endif//#if( ISR_ENABLE_VPC3_INT_NEW_CFG_DATA == 1 )
//  End of "Added by Sagar on 23.08.2012 to include "Check_Config_Data" function defination"
