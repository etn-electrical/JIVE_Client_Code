...
extern VPC3_ADR Vpc3AsicAddress;                                              /**< VPC3+ base
                                                                                 address */

   #if MOTOROLA_MODE
	  #define bVpc3RwIntReqReg_H       ( VPC3_ADR )( Vpc3AsicAddress + 0x00 )   /**<(000H) Interrupt
	                                                                               request register
	                                                                               high */
	  #define bVpc3RwIntReqReg_L       ( VPC3_ADR )( Vpc3AsicAddress + 0x01 )   /**<(001H) Interrupt
	                                                                               request register
	                                                                               low */

	  #define bVpc3RoIntReg_H          ( VPC3_ADR )( Vpc3AsicAddress + 0x02 )   /**<(002H) Interrupt
	                                                                               register high */
	  #define bVpc3RoIntReg_L          ( VPC3_ADR )( Vpc3AsicAddress + 0x03 )   /**<(003H) Interrupt
	                                                                               register low */
	  #define bVpc3RoStatus_H          ( VPC3_ADR )( Vpc3AsicAddress + 0x04 )   /**<(004H) status
	                                                                               register high */
	  #define bVpc3RoStatus_L          ( VPC3_ADR )( Vpc3AsicAddress + 0x05 )   /**<(005H) status
	                                                                               register low */

	  #define bVpc3WoIntAck_H          ( VPC3_ADR )( Vpc3AsicAddress + 0x02 )   /**<(002H) Interrupt
	                                                                               acknowledge high
	                                                                             */
	  #define bVpc3WoIntAck_L          ( VPC3_ADR )( Vpc3AsicAddress + 0x03 )   /**<(003H) Interrupt
	                                                                               acknowledge low
	                                                                             */
	  #define bVpc3WoIntMask_H         ( VPC3_ADR )( Vpc3AsicAddress + 0x04 )   /**<(004H) Interrupt
	                                                                               mask register
	                                                                               high */
	  #define bVpc3WoIntMask_L         ( VPC3_ADR )( Vpc3AsicAddress + 0x05 )   /**<(005H) Interrupt
	                                                                               mask register low
	                                                                             */

	  #define bVpc3RwModeReg0_H        ( VPC3_ADR )( Vpc3AsicAddress + 0x06 )   /**<(006H) mode
	                                                                               register0 high */
	  #define bVpc3RwModeReg0_L        ( VPC3_ADR )( Vpc3AsicAddress + 0x07 )   /**<(007H) mode
	                                                                               register0 low */
   #else
	  #define bVpc3RwIntReqReg_L       ( VPC3_ADR )( Vpc3AsicAddress + 0x00 )   /**<(000H) Interrupt
	                                                                               request register
	                                                                               low */
	  #define bVpc3RwIntReqReg_H       ( VPC3_ADR )( Vpc3AsicAddress + 0x01 )   /**<(001H) Interrupt
	                                                                               request register
	                                                                               high */

	  #define bVpc3RoIntReg_L          ( VPC3_ADR )( Vpc3AsicAddress + 0x02 )   /**<(002H) Interrupt
	                                                                               register low */
	  #define bVpc3RoIntReg_H          ( VPC3_ADR )( Vpc3AsicAddress + 0x03 )   /**<(003H) Interrupt
	                                                                               register high */
	  #define bVpc3RoStatus_L          ( VPC3_ADR )( Vpc3AsicAddress + 0x04 )   /**<(004H) status
	                                                                               register low */
	  #define bVpc3RoStatus_H          ( VPC3_ADR )( Vpc3AsicAddress + 0x05 )   /**<(005H) status
	                                                                               register high */

	  #define bVpc3WoIntAck_L          ( VPC3_ADR )( Vpc3AsicAddress + 0x02 )   /**<(002H) Interrupt
	                                                                               acknowledge low
	                                                                             */
	  #define bVpc3WoIntAck_H          ( VPC3_ADR )( Vpc3AsicAddress + 0x03 )   /**<(003H) Interrupt
	                                                                               acknowledge high
	                                                                             */
	  #define bVpc3WoIntMask_L         ( VPC3_ADR )( Vpc3AsicAddress + 0x04 )   /**<(004H) Interrupt
	                                                                               mask register low
	                                                                             */
	  #define bVpc3WoIntMask_H         ( VPC3_ADR )( Vpc3AsicAddress + 0x05 )   /**<(005H) Interrupt
	                                                                               mask register
	                                                                               high */

	  #define bVpc3RwModeReg0_L        ( VPC3_ADR )( Vpc3AsicAddress + 0x06 )   /**<(006H) mode
	                                                                               register0 low */
	  #define bVpc3RwModeReg0_H        ( VPC3_ADR )( Vpc3AsicAddress + 0x07 )   /**<(007H) mode
	                                                                               register0 high */
   #endif /* #if MOTOROLA_MODE */

   #define bVpc3RoDinBufferSm          ( VPC3_ADR )( Vpc3AsicAddress + 0x08 )   /**<(008H) buffer
	                                                                               assignment of the
	                                                                               DP_DIN_BUFFER
	                                                                               state machine */
   #define bVpc3RoNewDinBufferCmd      ( VPC3_ADR )( Vpc3AsicAddress + 0x09 )   /**<(009H) the user
	                                                                               makes a new
	                                                                               DP_DIN_BUFFER
	                                                                               available in the
	                                                                               N state */
   #define bVpc3RoDoutBufferSm         ( VPC3_ADR )( Vpc3AsicAddress + 0x0A )   /**<(00AH) buffer
	                                                                               assignment of the
	                                                                               DP_DOUT_BUFFER
	                                                                               state machine */
   #define bVpc3RoNextDoutBufferCmd    ( VPC3_ADR )( Vpc3AsicAddress + 0x0B )   /**<(00BH) the user
	                                                                               fetches the last
	                                                                               DP_DOUT_BUFFER
	                                                                               from the N state
	                                                                             */
   #define bVpc3RoDiagBufferSm         ( VPC3_ADR )( Vpc3AsicAddress + 0x0C )   /**<(00CH) buffer
	                                                                               assignment for
	                                                                               DP_DIAG_BUFFER
	                                                                               state machine */
   #define bVpc3RoNewDiagBufferCmd     ( VPC3_ADR )( Vpc3AsicAddress + 0x0D )   /**<(00DH) the user
	                                                                               makes a new
	                                                                               DP_DIAG_BUFFER
	                                                                               available to the
	                                                                               VPC3+ */
   #define bVpc3RoUserPrmDataOkay      ( VPC3_ADR )( Vpc3AsicAddress + 0x0E )   /**<(00EH) positive
	                                                                               acknowledge for
	                                                                               received user
	                                                                               parameter data */
   #define bVpc3RoUserPrmDataNotOkay   ( VPC3_ADR )( Vpc3AsicAddress + 0x0F )   /**<(00FH) negative
	                                                                               acknowledge for
	                                                                               received user
	                                                                               parameter data */
   #define bVpc3RoUserCfgDataOkay      ( VPC3_ADR )( Vpc3AsicAddress + 0x10 )   /**<(010H) positive
	                                                                               acknowledge for
	                                                                               received config
	                                                                               data */
   #define bVpc3RoUserCfgDataNotOkay   ( VPC3_ADR )( Vpc3AsicAddress + 0x11 )   /**<(011H) negative
	                                                                               acknowledge for
	                                                                               received config
	                                                                               data */
   #define bVpc3RoDxbOutBufferSm       ( VPC3_ADR )( Vpc3AsicAddress + 0x12 )   /**<(012H) buffer
	                                                                               assignment of the
	                                                                               DXB_OUT_BUFFER
	                                                                               state machine */
   #define bVpc3RoNextDxbOutBufferCmd  ( VPC3_ADR )( Vpc3AsicAddress + 0x13 )   /**<(013H) the user
	                                                                               fetches the last
	                                                                               DXB_OUT_BUFFER */
   #define bVpc3RoSsaBufferFreeCmd     ( VPC3_ADR )( Vpc3AsicAddress + 0x14 )   /**<(014H) the user
	                                                                               has fetched data
	                                                                               from ssa buffer
	                                                                               and enables
	                                                                               buffer again */
   #define bVpc3RoModeReg1             ( VPC3_ADR )( Vpc3AsicAddress + 0x15 )   /**<(015H) current
	                                                                               value of
	                                                                               mode_reg1 */

   #define bVpc3WoModeReg1_S           ( VPC3_ADR )( Vpc3AsicAddress + 0x08 )   /**<(008H) set
	                                                                               b0..b7 in
	                                                                               mode_reg1 */
   #define bVpc3WoModeReg1_R           ( VPC3_ADR )( Vpc3AsicAddress + 0x09 )   /**<(009H) reset
	                                                                               b0..b7 in
	                                                                               mode_reg1 */
   #define bVpc3WoWdBaudControlVal     ( VPC3_ADR )( Vpc3AsicAddress + 0x0A )   /**<(00AH) root
	                                                                               value for baud
	                                                                               rate monitoring
	                                                                             */
   #define bVpc3WoMinTsdrVal           ( VPC3_ADR )( Vpc3AsicAddress + 0x0B )   /**<(00BH) MinTsdr
	                                                                               time */
   #define bVpc3WoModeReg2             ( VPC3_ADR )( Vpc3AsicAddress + 0x0C )   /**<(00CH) set
	                                                                               b0..b7 in
	                                                                               mode_reg2 */
   #define bVpc3WoSyncPwReg            ( VPC3_ADR )( Vpc3AsicAddress + 0x0D )   /**<(00DH) sync
	                                                                               pulse width
	                                                                               register */
   #define bVpc3WoControlCommandReg    ( VPC3_ADR )( Vpc3AsicAddress + 0x0E )   /**<(00EH) Iso-Mode:
	                                                                               control command
	                                                                               value */
   #define bVpc3WoGroupSelectReg       ( VPC3_ADR )( Vpc3AsicAddress + 0x0F )   /**<(00FH) Iso-Mode:
	                                                                               group select
	                                                                               value */
   #define bVpc3WoControlCommandMask   ( VPC3_ADR )( Vpc3AsicAddress + 0x10 )   /**<(010H) Iso-Mode:
	                                                                               control command
	                                                                               mask register */
   #define bVpc3WoGroupSelectMask      ( VPC3_ADR )( Vpc3AsicAddress + 0x11 )   /**<(011H) Iso-Mode:
	                                                                               group select mask
	                                                                               register */

   #define bVpc3WoModeReg3             ( VPC3_ADR )( Vpc3AsicAddress + 0x12 )   /**<(012H) set
	                                                                               b0..b7 in
	                                                                               mode_reg3 */

   #define bVpc3RwTsAddr               ( VPC3_ADR )( Vpc3AsicAddress + 0x16 )   /**<(016H) setup
	                                                                               VPC3+ station
	                                                                               address */
   #define bVpc3RwFdlSapListPtr        ( VPC3_ADR )( Vpc3AsicAddress + 0x17 )   /**<(017H) pointer
	                                                                               fdl_sap_list */
   #define bVpc3RwUserWdValue_L        ( VPC3_ADR )( Vpc3AsicAddress + 0x18 )   /**<(018H) user
	                                                                               watchdog value
	                                                                               b0..b7 */
   #define bVpc3RwUserWdValue_H        ( VPC3_ADR )( Vpc3AsicAddress + 0x19 )   /**<(019H) user
	                                                                               watchdog value
	                                                                               b8..b15 */
   #define bVpc3RwLenDoutBuf           ( VPC3_ADR )( Vpc3AsicAddress + 0x1A )   /**<(01AH) length of
	                                                                               dout buffers */
   #define bVpc3RwDoutBufPtr1          ( VPC3_ADR )( Vpc3AsicAddress + 0x1B )   /**<(01BH) segment
	                                                                               base address of
	                                                                               dout_buffer [0]
	                                                                             */
   #define bVpc3RwDoutBufPtr2          ( VPC3_ADR )( Vpc3AsicAddress + 0x1C )   /**<(01CH) segment
	                                                                               base address of
	                                                                               dout_buffer [1]
	                                                                             */
   #define bVpc3RwDoutBufPtr3          ( VPC3_ADR )( Vpc3AsicAddress + 0x1D )   /**<(01DH) segment
	                                                                               base address of
	                                                                               dout_buffer [2]
	                                                                             */
   #define bVpc3RwLenDinBuf            ( VPC3_ADR )( Vpc3AsicAddress + 0x1E )   /**<(01EH) length of
	                                                                               din buffers */
   #define bVpc3RwDinBufPtr1           ( VPC3_ADR )( Vpc3AsicAddress + 0x1F )   /**<(01FH) segment
	                                                                               base address of
	                                                                               din_buffer [0] */
   #define bVpc3RwDinBufPtr2           ( VPC3_ADR )( Vpc3AsicAddress + 0x20 )   /**<(020H) segment
	                                                                               base address of
	                                                                               din_buffer [1] */
   #define bVpc3RwDinBufPtr3           ( VPC3_ADR )( Vpc3AsicAddress + 0x21 )   /**<(021H) segment
	                                                                               base address of
	                                                                               din_buffer [2] */
   #define bVpc3RwLenDxbOutBuf         ( VPC3_ADR )( Vpc3AsicAddress + 0x22 )   /**<(022H) length of
	                                                                               dxb buffers */
   #define bVpc3RwDxbOutBufPtr1        ( VPC3_ADR )( Vpc3AsicAddress + 0x23 )   /**<(023H) segment
	                                                                               base address of
	                                                                               dxbout_buffer1 */
   #define bVpc3RwLenDiagBuf1          ( VPC3_ADR )( Vpc3AsicAddress + 0x24 )   /**<(024H) length of
	                                                                               diag buffers [0]
	                                                                             */
   #define bVpc3RwLenDiagBuf2          ( VPC3_ADR )( Vpc3AsicAddress + 0x25 )   /**<(025H) length of
	                                                                               diag buffers [1]
	                                                                             */
   #define bVpc3RwDiagBufPtr1          ( VPC3_ADR )( Vpc3AsicAddress + 0x26 )   /**<(026H) segment
	                                                                               base address of
	                                                                               diag_buffer [0]
	                                                                             */
   #define bVpc3RwDiagBufPtr2          ( VPC3_ADR )( Vpc3AsicAddress + 0x27 )   /**<(027H) segment
	                                                                               base address of
	                                                                               diag_buffer [1]
	                                                                             */
   #define bVpc3RwLenCtrlBuf1          ( VPC3_ADR )( Vpc3AsicAddress + 0x28 )   /**<(028H) length of
	                                                                               aux buffer 1 */
   #define bVpc3RwLenCtrlBuf2          ( VPC3_ADR )( Vpc3AsicAddress + 0x29 )   /**<(029H) length of
	                                                                               aux buffer 2 */
   #define bVpc3RwAuxBufSel            ( VPC3_ADR )( Vpc3AsicAddress + 0x2A )   /**<(02AH)
	                                                                               assignment for
	                                                                               aux buffers 1/2
	                                                                             */
   #define bVpc3RwAuxBufPtr1           ( VPC3_ADR )( Vpc3AsicAddress + 0x2B )   /**<(02BH) segment
	                                                                               base address of
	                                                                               aux buffer 1 */
   #define bVpc3RwAuxBufPtr2           ( VPC3_ADR )( Vpc3AsicAddress + 0x2C )   /**<(02CH) segment
	                                                                               base address of
	                                                                               aux buffer 2 */
   #define bVpc3RwLenSsaBuf            ( VPC3_ADR )( Vpc3AsicAddress + 0x2D )   /**<(02DH) length of
	                                                                               SET_SLAVE_ADDRESS
	                                                                               buffer */
   #define bVpc3RwSsaBufPtr            ( VPC3_ADR )( Vpc3AsicAddress + 0x2E )   /**<(02EH) segment
	                                                                               base address of
	                                                                               SET_SLAVE_ADDRESS
	                                                                               buffer */
   #define bVpc3RwLenPrmData           ( VPC3_ADR )( Vpc3AsicAddress + 0x2F )   /**<(02FH) max.
	                                                                               length of input
	                                                                               data in SET_PRM
	                                                                               buffer */
   #define bVpc3RwPrmBufPtr            ( VPC3_ADR )( Vpc3AsicAddress + 0x30 )   /**<(030H) segment
	                                                                               base address of
	                                                                               SET_PRM buffer */
   #define bVpc3RwLenCfgData           ( VPC3_ADR )( Vpc3AsicAddress + 0x31 )   /**<(031H) length of
	                                                                               input data in the
	                                                                               CHECK_CONFIG
	                                                                               buffer */
   #define bVpc3RwCfgBufPtr            ( VPC3_ADR )( Vpc3AsicAddress + 0x32 )   /**<(032H) segment
	                                                                               base address of
	                                                                               CHECK_CONFIG
	                                                                               buffer */
   #define bVpc3RwLenReadCfgData       ( VPC3_ADR )( Vpc3AsicAddress + 0x33 )   /**<(033H) length of
	                                                                               input data in the
	                                                                               GET_CONFIG buffer
	                                                                             */
   #define bVpc3RwReadCfgBufPtr        ( VPC3_ADR )( Vpc3AsicAddress + 0x34 )   /**<(034H) segment
	                                                                               base address of
	                                                                               GET_CONFIG buffer
	                                                                             */
   #define bVpc3RwLenDxbLinkBuf        ( VPC3_ADR )( Vpc3AsicAddress + 0x35 )   /**<(035H) length of
	                                                                               dxb link table
	                                                                               buffer */
   #define bVpc3RwDxbLinkBufPtr        ( VPC3_ADR )( Vpc3AsicAddress + 0x36 )   /**<(036H) segment
	                                                                               base address of
	                                                                               dxb link table
	                                                                               buffer */
   #define bVpc3RwLenDxbStatusBuf      ( VPC3_ADR )( Vpc3AsicAddress + 0x37 )   /**<(037H) length of
	                                                                               dxb link status
	                                                                               buffer */
   #define bVpc3RwDxbStatusBufPtr      ( VPC3_ADR )( Vpc3AsicAddress + 0x38 )   /**<(038H) segment
	                                                                               base address of
	                                                                               dxb link status
	                                                                               buffer */
   #define bVpc3RwRealNoAddChange      ( VPC3_ADR )( Vpc3AsicAddress + 0x39 )   /**<(039H) address
	                                                                               changes */
   #define bVpc3RwIdentLow             ( VPC3_ADR )( Vpc3AsicAddress + 0x3A )   /**<(03AH) IDENT_LOW
	                                                                             */
   #define bVpc3RwIdentHigH            ( VPC3_ADR )( Vpc3AsicAddress + 0x3B )   /**<(03BH)
	                                                                               IDENT_HIGH */
   #define bVpc3RwGcCommand            ( VPC3_ADR )( Vpc3AsicAddress + 0x3C )   /**<(03CH) last
	                                                                               global control
	                                                                               command */
   #define bVpc3RwLenSpecPrmBuf        ( VPC3_ADR )( Vpc3AsicAddress + 0x3D )   /**<(03DH) length of
	                                                                               SPEC_PRM buffer
	                                                                             */
   #define bVpc3RwDxbOutBufPtr2        ( VPC3_ADR )( Vpc3AsicAddress + 0x3E )   /**<(03EH) segment
	                                                                               base address of
	                                                                               dxbout_buffer2 */
   #define bVpc3RwDxbOutBufPtr3        ( VPC3_ADR )( Vpc3AsicAddress + 0x3F )   /**<(03FH) segment
	                                                                               base address of
	                                                                               dxbout_buffer3 */

   #define bVpc3RwStartSapCtrlList     ( VPC3_ADR )( Vpc3AsicAddress + 0x40 )   /**<(040H) SAP
	                                                                               CONTROL BLOCK
	                                                                               LIST */
		 ...
		 #define abVpc3RoErrorCnt               ( VPC3_ADR )( Vpc3AsicAddress + 0xFFC )     /* FFCH
		 ...
		 #define abVpc3RoErrorCnt               ( VPC3_ADR )( Vpc3AsicAddress + 0x7FC )     /* 7FCH
...
typedef struct
{
	...
	union
	{
		struct
		{                                             /* [read] */
			TVpc3Byte bDinBufferSm;                   /**<(008H) buffer assignment of the
			                                             DP_DIN_BUFFER state machine */
			TVpc3Byte bNewDinBufferCmd;               /**<(009H) the user makes a new DP_DIN_BUFFER
			                                             available in the N state */
			TVpc3Byte bDoutBufferSm;                  /**<(00AH) buffer assignment of the
			                                             DP_DOUT_BUFFER state machine */
			TVpc3Byte bNextDoutBufferCmd;             /**<(00BH) the user fetches the last
			                                             DP_DOUT_BUFFER from the N state */
			TVpc3Byte bDiagBufferSm;                  /**<(00CH) buffer assignment for
			                                             DP_DIAG_BUFFER state machine */
			TVpc3Byte bNewDiagBufferCmd;              /**<(00DH) the user makes a new DP_DIAG_BUFFER
			                                             available to the VPC3+ */
			TVpc3Byte bUserPrmDataOkay;               /**<(00EH) positive acknowledge for received
			                                             user parameter data */
			TVpc3Byte bUserPrmDataNotOkay;            /**<(00FH) negative acknowledge for received
			                                             user parameter data */
			TVpc3Byte bUserCfgDataOkay;               /**<(010H) positive acknowledge for received
			                                             config data */
			TVpc3Byte bUserCfgDataNotOkay;            /**<(011H) negative acknowledge for received
			                                             config data */
			TVpc3Byte bDxbOutBufferSm;                /**<(012H) buffer assignment of the
			                                             DXB_OUT_BUFFER state machine */
			TVpc3Byte bNextDxbOutBufferCmd;           /**<(013H) the user fetches the last
			                                             DXB_OUT_BUFFER */
			TVpc3Byte bSsaBufferFreeCmd;              /**<(014H) the user has fetched data from ssa
			                                             buffer and enables buffer again */
		...
		{                                             /* [write] */
			...
			TVpc3Byte bControlCommandMask;            /**<(010H) Iso-Mode: control command mask
			                                             register */
			TVpc3Byte bGroupSelectMask;               /**<(011H) Iso-Mode: group select mask
			                                             register */
	...
	TVpc3Byte abDoutBufPtr[3];                        /**<(01BH) segment base address of dout_buffer
	                                                     [0] */
	                                                  /**<(01CH) segment base address of dout_buffer
	                                                     [1] */
	                                                  /**<(01DH) segment base address of dout_buffer
	                                                     [2] */
	TVpc3Byte bLenDinBuf;                             /**<(01EH) length of din buffers */
	TVpc3Byte abDinBufPtr[3];                         /**<(01FH) segment base address of din_buffer
	                                                     [0] */
	                                                  /**<(020H) segment base address of din_buffer
	                                                     [1] */
	                                                  /**<(021H) segment base address of din_buffer
	                                                     [2] */
	TVpc3Byte bLenDxbOutBuf;                          /**<(022H) length of dxb buffers */
	TVpc3Byte bDxbOutBufPtr1;                         /**<(023H) segment base address of
	                                                     dxbout_buffer1 */
	TVpc3Byte abLenDiagBuf[2];                        /**<(024H) length of diag buffers [0] */
	                                                  /**<(025H) length of diag buffers [1] */
	TVpc3Byte abDiagBufPtr[2];                        /**<(026H) segment base address of diag_buffer
	                                                     [0] */
	                                                  /**<(027H) segment base address of diag_buffer
	                                                     [1] */
	...
	TVpc3Byte abAuxBufPtr[2];                         /**<(02BH) segment base address of aux buffer
	                                                     1 */
	                                                  /**<(02CH) segment base address of aux buffer
	                                                     2 */
	TVpc3Byte bLenSsaBuf;                             /**<(02DH) length of SET_SLAVE_ADDRESS buffer
	                                                   */
	TVpc3Byte bSsaBufPtr;                             /**<(02EH) segment base address of
	                                                     SET_SLAVE_ADDRESS buffer */
	TVpc3Byte bLenPrmData;                            /**<(02FH) max. length of input data in
	                                                     SET_PRM buffer */
	TVpc3Byte bPrmBufPtr;                             /**<(030H) segment base address of SET_PRM
	                                                     buffer */
	TVpc3Byte bLenCfgData;                            /**<(031H) length of input data in the
	                                                     CHECK_CONFIG buffer */
	TVpc3Byte bCfgBufPtr;                             /**<(032H) segment base address of
	                                                     CHECK_CONFIG buffer */
	TVpc3Byte bLenReadCfgData;                        /**<(033H) length of input data in the
	                                                     GET_CONFIG buffer */
	TVpc3Byte bReadCfgBufPtr;                         /**<(034H) segment base address of GET_CONFIG
	                                                     buffer */
	TVpc3Byte bLenDxbLinkBuf;                         /**<(035H) length of dxb link table buffer */
	TVpc3Byte bDxbLinkBufPtr;                         /**<(036H) segment base address of dxb link
	                                                     table buffer */
	TVpc3Byte bLenDxbStatusBuf;                       /**<(037H) length of dxb link status buffer */
	TVpc3Byte bDxbStatusBufPtr;                       /**<(038H) segment base address of dxb link
	                                                     status buffer */
	...
	TVpc3Byte bDxbOutBufPtr2;                         /**<(03EH) segment base address of
	                                                     dxbout_buffer2 */
	TVpc3Byte bDxbOutBufPtr3;                         /**<(03FH) segment base address of
	                                                     dxbout_buffer3 */
...
/*---------------------------------------------------------------------------*/
/*  low Byte */
#define VPC3_INT_MAC_RESET             ( ( UBYTE )0x01 )      /**<VPC3 has entered offline state */
...
#define VPC3_INT_USER_TIMER_CLOCK      ( ( UBYTE )0x10 )      /**<time base for USER_TIMER_CLOCKS
	                                                             has run out */
...
/*  high Byte */
#define VPC3_INT_NEW_GC_COMMAND        ( ( UBYTE )0x01 )      /**<New Global control command
	                                                             received */
...
#define VPC3_INT16_MAC_RESET           ( ( UWORD )0x0001 )   /**<VPC3 has entered offline state */
...
#define VPC3_INT16_USER_TIMER_CLOCK    ( ( UWORD )0x0010 )   /**<time base for USER_TIMER_CLOCKS has
	                                                            run out */
...
#define MASK_DP_STATE                  ( ( UBYTE )0x30 )
#define MASK_WD_STATE                  ( ( UBYTE )0xC0 )
...
#define VPC3_GC_CLEAR_DATA              ( ( UBYTE )0x02 )
...
/* -- Set fdl sap-list pointer ------------------------------------------------ */
   ...
   #define VPC3_GET_SAP_LIST_PTR()                    ( VPC3_UNSIGNED8_PTR )( ( ( VPC3_ADR )( 0x40 ) ) + \
																			  ( ( VPC3_ADR )Vpc3AsicAddress ) )
   ...
   #define VPC3_GET_NEXT_DOUT_BUFFER_CMD()            ( Vpc3Read( bVpc3RoNextDoutBufferCmd ) & \
   ...
   #define VPC3_GET_DIAG1_PTR()                       ( VPC3_UNSIGNED8_PTR )( ( ( VPC3_ADR )( Vpc3Read( \
																								  bVpc3RwDiagBufPtr1 ) ) \
																				<< SEG_MULDIV ) + \
																			  ( ( VPC3_ADR )Vpc3AsicAddress ) )
   #define VPC3_GET_DIAG2_PTR()                       ( VPC3_UNSIGNED8_PTR )( ( ( VPC3_ADR )( Vpc3Read( \
																								  bVpc3RwDiagBufPtr2 ) ) \
																				<< SEG_MULDIV ) + \
																			  ( ( VPC3_ADR )Vpc3AsicAddress ) )
...
/* Startaddress of User-Area in VPC3-Format ----------------------------------- */
   #define VPC3_DP_BUF_START                          ( UBYTE )( ( ( VPC3_ADR )&pVpc3->abDpBuffer[0] VPC3_EXTENSION - \
																   ( VPC3_ADR )Vpc3AsicAddress ) >> SEG_MULDIV )
/* Startaddress of FDL-List-Area in VPC3-Format ------------------------------- */
   #define VPC3_SAP_CTRL_LIST_START                   ( UBYTE )( ( ( VPC3_ADR )&pVpc3->abSapCtrlList - \
																   ( VPC3_ADR )Vpc3AsicAddress ) >> SEG_MULDIV )
 ...
 */
   #define VPC3_GoOffline()                           pVpc3->sCtrlPrm.sWrite.bModeReg1_S VPC3_EXTENSION = \
	VPC3_GO_OFFLINE
/* -- read/write Mode register ------------------------------------------------ */
 ...
 */
   #define VPC3_SET_USER_LEAVE_MASTER()               pVpc3->sCtrlPrm.sWrite.bModeReg1_S VPC3_EXTENSION = \
	VPC3_USER_LEAVE_MASTER
/* -- User-Watchdog ----------------------------------------------------------- */
...
/* -- Reset User-Watchdog ----------------------------------------------------- */
   #define VPC3_RESET_USER_WD()                       pVpc3->sCtrlPrm.sWrite.bModeReg1_S VPC3_EXTENSION = \
	VPC3_RES_USER_WD
/* -- VPC3_SET_EN_CHK_SSAP ----------------------------------------------------- */
   #define VPC3_SET_EN_CHK_SSAP()                     pVpc3->sCtrlPrm.sWrite.bModeReg1_S VPC3_EXTENSION = \
	VPC3_EN_CHK_SSAP
   #define VPC3_RESET_EN_CHK_SSAP()                   pVpc3->sCtrlPrm.sWrite.bModeReg1_R VPC3_EXTENSION = \
	VPC3_EN_CHK_SSAP
/* -- Set fdl sap-list pointer ------------------------------------------------ */
   #define VPC3_SET_FDL_SAP_LIST_PTR()                pVpc3->bFdlSapListPtr VPC3_EXTENSION = VPC3_SAP_LIST_PTR
   #define VPC3_GET_SAP_LIST_PTR()                    ( VPC3_UNSIGNED8_PTR )( ( VPC3_ADR )( &pVpc3->abSapCtrlList[0] \
																							VPC3_EXTENSION ) )
   ...
   #define VPC3_GET_NEXT_DOUT_BUFFER_CMD()            ( pVpc3->sCtrlPrm.sRead.bNextDoutBufferCmd VPC3_EXTENSION & \
														( VPC3_NEW_DOUT_BUF | VPC3_DOUT_BUF_CLEARED ) )
   ...
   #define VPC3_GET_DIAG1_PTR()                       ( VPC3_UNSIGNED8_PTR ) ( ( ( VPC3_ADR )( pVpc3->abDiagBufPtr[0] \
																							   VPC3_EXTENSION ) << \
																				 SEG_MULDIV ) + \
																			   ( ( VPC3_ADR )Vpc3AsicAddress ) )
   #define VPC3_GET_DIAG2_PTR()                       ( VPC3_UNSIGNED8_PTR ) ( ( ( VPC3_ADR )( pVpc3->abDiagBufPtr[1] \
																							   VPC3_EXTENSION ) << \
																				 SEG_MULDIV ) + \
																			   ( ( VPC3_ADR )Vpc3AsicAddress ) )
...
/* -- Acknowledging the indication ------------------------------------------- */
	  ...
	  #define VPC3_POLL_CON_IND_DX_OUT()              ( pDpSystem->wPollInterruptEvent &= ~VPC3_INT16_DX_OUT )
...
/* poll read out reasons for indications -------------------------------------- */
	  ...
	  #define VPC3_POLL_IND_DIAG_BUFFER_CHANGED()     ( pDpSystem->wPollInterruptEvent & \
														VPC3_INT16_DIAG_BUFFER_CHANGED )
...
/* -- read out reasons for indications ( Vpc3Isr() ) -------------------------- */
	  #define VPC3_GET_IND_MAC_RESET()                ( pVpc3->sReg.sRead.bIntReg_L VPC3_EXTENSION & \
														VPC3_INT_MAC_RESET )
	  #define VPC3_GET_IND_CLOCK_SYNC()               ( pVpc3->sReg.sRead.bIntReg_L VPC3_EXTENSION & \
														VPC3_INT_CLOCK_SYNC )
	  #define VPC3_GET_IND_GO_LEAVE_DATA_EX()         ( pVpc3->sReg.sRead.bIntReg_L VPC3_EXTENSION & \
														VPC3_INT_GO_LEAVE_DATA_EX )
	  #define VPC3_GET_IND_BAUDRATE_DETECT()          ( pVpc3->sReg.sRead.bIntReg_L VPC3_EXTENSION & \
														VPC3_INT_BAUDRATE_DETECT )
	  #define VPC3_GET_IND_WD_DP_MODE_TIMEOUT()       ( pVpc3->sReg.sRead.bIntReg_L VPC3_EXTENSION & \
														VPC3_INT_WD_DP_MODE_TIMEOUT )
	  #define VPC3_GET_IND_USER_TIMER_CLOCK()         ( pVpc3->sReg.sRead.bIntReg_L VPC3_EXTENSION & \
														VPC3_INT_USER_TIMER_CLOCK )
	  #define VPC3_GET_IND_DXB_LINK_ERROR()           ( pVpc3->sReg.sRead.bIntReg_L VPC3_EXTENSION & \
														VPC3_INT_DXB_LINK_ERROR )
	  #define VPC3_GET_IND_NEW_EXT_PRM_DATA()         ( pVpc3->sReg.sRead.bIntReg_L VPC3_EXTENSION & \
														VPC3_INT_NEW_EXT_PRM_DATA )
	  #define VPC3_GET_IND_DXB_OUT()                  ( pVpc3->sReg.sRead.bIntReg_L VPC3_EXTENSION & VPC3_INT_DXB_OUT )
	  #define VPC3_GET_IND_NEW_GC_COMMAND()           ( pVpc3->sReg.sRead.bIntReg_H VPC3_EXTENSION & \
														VPC3_INT_NEW_GC_COMMAND )
	  #define VPC3_GET_IND_NEW_SSA_DATA()             ( pVpc3->sReg.sRead.bIntReg_H VPC3_EXTENSION & \
														VPC3_INT_NEW_SSA_DATA )
	  #define VPC3_GET_IND_NEW_CFG_DATA()             ( pVpc3->sReg.sRead.bIntReg_H VPC3_EXTENSION & \
														VPC3_INT_NEW_CFG_DATA )
	  #define VPC3_GET_IND_NEW_PRM_DATA()             ( pVpc3->sReg.sRead.bIntReg_H VPC3_EXTENSION & \
														VPC3_INT_NEW_PRM_DATA )
	  #define VPC3_GET_IND_DIAG_BUFFER_CHANGED()      ( pVpc3->sReg.sRead.bIntReg_H VPC3_EXTENSION & \
														VPC3_INT_DIAG_BUFFER_CHANGED )
	  #define VPC3_GET_IND_DX_OUT()                   ( pVpc3->sReg.sRead.bIntReg_H VPC3_EXTENSION & VPC3_INT_DX_OUT )
	  #define VPC3_GET_IND_POLL_END_IND()             ( pVpc3->sReg.sRead.bIntReg_H VPC3_EXTENSION & \
														VPC3_INT_POLL_END_IND )
...
/* -- Acknowledging the indication ------------------------------------------- */
	  ...
	  #define VPC3_CON_IND_GO_LEAVE_DATA_EX()         pVpc3->sReg.sWrite.bIntAck_L VPC3_EXTENSION = \
	VPC3_INT_GO_LEAVE_DATA_EX
	  #define VPC3_CON_IND_BAUDRATE_DETECT()          pVpc3->sReg.sWrite.bIntAck_L VPC3_EXTENSION = \
	VPC3_INT_BAUDRATE_DETECT
	  #define VPC3_CON_IND_WD_DP_MODE_TIMEOUT()       pVpc3->sReg.sWrite.bIntAck_L VPC3_EXTENSION = \
	VPC3_INT_WD_DP_MODE_TIMEOUT
	  #define VPC3_CON_IND_USER_TIMER_CLOCK()         pVpc3->sReg.sWrite.bIntAck_L VPC3_EXTENSION = \
	VPC3_INT_USER_TIMER_CLOCK
	  #define VPC3_CON_IND_DXB_LINK_ERROR()           pVpc3->sReg.sWrite.bIntAck_L VPC3_EXTENSION = \
	VPC3_INT_DXB_LINK_ERROR
	  #define VPC3_CON_IND_NEW_EXT_PRM_DATA()         pVpc3->sReg.sWrite.bIntAck_L VPC3_EXTENSION = \
	VPC3_INT_NEW_EXT_PRM_DATA
	  #define VPC3_CON_IND_DXB_OUT()                  pVpc3->sReg.sWrite.bIntAck_L VPC3_EXTENSION = VPC3_INT_DXB_OUT
	  #define VPC3_CON_IND_NEW_GC_COMMAND()           pVpc3->sReg.sWrite.bIntAck_H VPC3_EXTENSION = \
	VPC3_INT_NEW_GC_COMMAND
	  #define VPC3_CON_IND_NEW_SSA_DATA()             pVpc3->sReg.sWrite.bIntAck_H VPC3_EXTENSION = \
	VPC3_INT_NEW_SSA_DATA
	  #define VPC3_POLL_CON_IND_DIAG_BUFFER_CHANGED() pVpc3->sReg.sWrite.bIntAck_H VPC3_EXTENSION = \
	VPC3_INT_DIAG_BUFFER_CHANGED
	  #define VPC3_CON_IND_DIAG_BUFFER_CHANGED()      pVpc3->sReg.sWrite.bIntAck_H VPC3_EXTENSION = \
	VPC3_INT_DIAG_BUFFER_CHANGED
	  #define VPC3_CON_IND_DX_OUT()                   pVpc3->sReg.sWrite.bIntAck_H VPC3_EXTENSION = VPC3_INT_DX_OUT
	  #define VPC3_CON_IND_POLL_END_IND()             pVpc3->sReg.sWrite.bIntAck_H VPC3_EXTENSION = \
	VPC3_INT_POLL_END_IND
...
/* poll read out reasons for indications -------------------------------------- */
	  ...
	  #define VPC3_POLL_IND_WD_DP_MODE_TIMEOUT()      ( pVpc3->bIntReqReg_L VPC3_EXTENSION & \
														VPC3_INT_WD_DP_MODE_TIMEOUT )
	  ...
	  #define VPC3_POLL_IND_DIAG_BUFFER_CHANGED()     ( pVpc3->bIntReqReg_H VPC3_EXTENSION & \
														VPC3_INT_DIAG_BUFFER_CHANGED )
...
/*
 ...
 |        1        |          0        |
 |--------------|------------|---------------|-----------------------|------------|-----------|------------------|-------------------|
 |   Lock_Req   | Unlock_Req |   Sync_Req    |       Freeze_Req      |    WD_On   |     0     |
 |        0        |          0        |
 |--------------|------------|---------------|-----------------------|------------|-----------|------------------|-------------------|
 | WD_Fact_1 (1 bis 255)
 |
 ...
 |                                                                                                 |
 |--------------|------------|---------------|-----------------------|------------|-----------|------------------|-------------------|
 | DPV1_Enable  | Fail_Safe  | Publisher_En  |       reserved        |  reserved  |  WD_Base  |
 |Dis_Stop_Control | Dis_Start_Control |
 |--------------|------------|---------------|-----------------------|------------|-----------|------------------|-------------------|
 | En_Pull_Plug | En_Process | En_Diagnostic | En_Manufacturer_Spec. | En_Status  | En_Update |
 |    reserved     | Chk_Cfg_Mode      |
 |    Alarm     |    Alarm   |    Alarm      |         Alarm         |   Alarm    |   Alarm   |
 |                 |                   |
 |--------------|------------|---------------|-----------------------|------------|-----------|------------------|-------------------|
 |   PrmCmd     |  reserved  |   reserved    |       IsoM_Req        | Prm_Struct |
 |                Alarm_Mode                       |
 |--------------|------------|---------------|-----------------------|------------|-----------|------------------|-------------------|
 |                                                            User_Prm_Data
 |                                                         |
...
#define cSizeOfRedPrmCmd                  ( ( UBYTE )0x08 )
...
/* get pointer to prm-buffer ------------------------------------------------ */
   #define VPC3_GET_PRM_BUF_PTR()         ( VPC3_UNSIGNED8_PTR )( ( ( VPC3_ADR )( Vpc3Read( bVpc3RwPrmBufPtr ) ) << \
																	SEG_MULDIV ) + ( ( VPC3_ADR )Vpc3AsicAddress ) )
...
/* get pointer to aux buffer 1 ---------------------------------------------- */
   #define VPC3_GET_AUX_BUF1_PTR()        ( VPC3_UNSIGNED8_PTR )( ( ( VPC3_ADR )( Vpc3Read( bVpc3RwAuxBufPtr1 ) ) << \
																	SEG_MULDIV ) + ( ( VPC3_ADR )Vpc3AsicAddress ) )
#else
 ...
 */
   #define VPC3_GET_PRM_BUF_PTR()         ( VPC3_UNSIGNED8_PTR )( ( ( VPC3_ADR )( pVpc3->bPrmBufPtr VPC3_EXTENSION ) << \
																	SEG_MULDIV ) + ( ( VPC3_ADR )Vpc3AsicAddress ) )
...
/*!
   ...
   The received parameter assignment isn't OK. The transferred parameter can't be used in the
      device.

   \retval VPC3_PRM_FINISHED - No further parameter assignment message is present --> end of
      sequence.
   \retval VPC3_PRM_CONFLICT - Another parameter assignment message is present --> repeat check of
      requested parameter assignment.
...
/*!
   ...
   \retval Address parameter data buffer.
 */
   #define VPC3_GET_AUX_BUF1_PTR()        ( VPC3_UNSIGNED8_PTR )( ( ( VPC3_ADR )( pVpc3->abAuxBufPtr[0] VPC3_EXTENSION ) \
																	<< SEG_MULDIV ) + ( ( VPC3_ADR )Vpc3AsicAddress ) )
#endif /* #if VPC3_SERIAL_MODE */
...
/* get pointer to cfg-buffers ---------------------------------------------- */
   #define VPC3_GET_READ_CFG_BUF_PTR()       ( VPC3_UNSIGNED8_PTR )( ( ( VPC3_ADR )( Vpc3Read( bVpc3RwReadCfgBufPtr ) ) \
																	   << SEG_MULDIV ) + \
																	 ( ( VPC3_ADR )Vpc3AsicAddress ) )
   #define VPC3_GET_CFG_BUF_PTR()            ( VPC3_UNSIGNED8_PTR )( ( ( VPC3_ADR )( Vpc3Read( bVpc3RwCfgBufPtr ) ) << \
																	   SEG_MULDIV ) + ( ( VPC3_ADR )Vpc3AsicAddress ) )
/* acknowledge prm-data ----------------------------------------------------- */
 ...
 */
   #define VPC3_GET_READ_CFG_BUF_PTR()       ( VPC3_UNSIGNED8_PTR )( ( ( VPC3_ADR )( pVpc3->bReadCfgBufPtr \
																					 VPC3_EXTENSION ) << SEG_MULDIV ) + \
																	 ( ( VPC3_ADR )Vpc3AsicAddress ) )
 ...
 */
   #define VPC3_GET_CFG_BUF_PTR()            ( VPC3_UNSIGNED8_PTR )( ( ( VPC3_ADR )( pVpc3->bCfgBufPtr VPC3_EXTENSION ) \
																	   << SEG_MULDIV ) + \
																	 ( ( VPC3_ADR )Vpc3AsicAddress ) )
...
/*!
   ...
   \retval VPC3_CFG_CONFLICT - An additional configuration message is present --> repeat
      verification of the requested configuration.
...
/*  -- get pointer to ssa buffer ----------------------------------------------- */
   #define VPC3_GET_SSA_BUF_PTR() ( VPC3_UNSIGNED8_PTR )( ( ( VPC3_ADR )( Vpc3Read( bVpc3RwSsaBufPtr ) ) << \
															SEG_MULDIV ) + ( ( VPC3_ADR )Vpc3AsicAddress ) )
 ...
 */
   #define VPC3_GET_SSA_BUF_PTR() ( VPC3_UNSIGNED8_PTR )( ( ( VPC3_ADR )( pVpc3->bSsaBufPtr VPC3_EXTENSION ) << \
															SEG_MULDIV ) + ( ( VPC3_ADR )Vpc3AsicAddress ) )
...
/*!
   ...
   \retval VPC3_SSA_CONFLICT - An additional ssa message is present --> repeat verification of the
      requested ssa.
...
/*!
   ...
   \retval Bit 1 - Clear_Data - With this command, the output data is cleared and made available to
      the user.
   \retval Bit 2 - Unfreeze - With "Unfreeze", freezing the input data is cancelled.
   \retval Bit 3 - Freeze - The input data is "frozen". The application will fetch new input data
      only if the master sends the next "freeze" command.
   \retval Bit 4 - Usync - The command "Unsync" cancels the "Sync"command.
   \retval Bit 5 - Sync - The output data received last is made availabe to the application. The
      output
...
#define STATUS_TYPE_MANU_MIN              ( ( UBYTE )0xA0 )
#define STATUS_TYPE_MANU_MAX              ( ( UBYTE )0xFE )
...
#define STATUS_UNSPECIFIC                 ( ( UBYTE )0x00 )
...
#define STATUS_PROC_ALARM_LOST            ( ( UBYTE )0x16 )
...
{
	UBYTE bHeader;
	UBYTE abDeviceRelatedDiagnosis[1];
...
/*---------------------------------------------------------------------------*/
   ...
   #define VPC3_GET_NEXT_DXB_OUT_BUFFER_CMD()      ( Vpc3Read( bVpc3RoNextDxbOutBufferCmd ) & \
													 ( VPC3_NEW_DOUT_BUF | VPC3_DOUT_BUF_CLEARED ) )
   #define VPC3_GET_DXB_OUT_BUFFER_SM()            ( Vpc3Read( bVpc3RoDxbOutBufferSm ) & 0x30 )

   #define VPC3_GET_DXB_LINK_STATUS_BUF_PTR()      ( VPC3_UNSIGNED8_PTR )( ( ( VPC3_ADR )( Vpc3Read( \
																							   bVpc3RwDxbStatusBufPtr ) ) \
																			 << SEG_MULDIV ) + \
																		   ( ( VPC3_ADR )Vpc3AsicAddress ) )
   ...
   #define VPC3_GET_DXB_LINK_TABLE_BUF_PTR()       ( VPC3_UNSIGNED8_PTR )( ( ( VPC3_ADR )( Vpc3Read( \
																							   bVpc3RwDxbLinkBufPtr ) ) \
																			 << SEG_MULDIV ) + \
																		   ( ( VPC3_ADR )Vpc3AsicAddress ) )
   ...
   #define VPC3_GET_NEXT_DXB_OUT_BUFFER_CMD()      ( pVpc3->sCtrlPrm.sRead.bNextDxbOutBufferCmd VPC3_EXTENSION & \
													 ( VPC3_NEW_DOUT_BUF | VPC3_DOUT_BUF_CLEARED ) )
   #define VPC3_GET_DXB_OUT_BUFFER_SM()            ( pVpc3->sCtrlPrm.sRead.bDxbOutBufferSm VPC3_EXTENSION & 0x30 )

   #define VPC3_GET_DXB_LINK_STATUS_BUF_PTR()      ( VPC3_UNSIGNED8_PTR )( ( ( VPC3_ADR )( pVpc3->bDxbStatusBufPtr \
																						   VPC3_EXTENSION ) << \
																			 SEG_MULDIV ) + \
																		   ( ( VPC3_ADR )Vpc3AsicAddress ) )
   ...
   #define VPC3_GET_DXB_LINK_TABLE_BUF_PTR()       ( VPC3_UNSIGNED8_PTR )( ( ( VPC3_ADR )( pVpc3->bDxbLinkBufPtr \
																						   VPC3_EXTENSION ) << \
																			 SEG_MULDIV ) + \
																		   ( ( VPC3_ADR )Vpc3AsicAddress ) )
...
#define ST_GC_CLOCK_HIT                   ( ( UBYTE )0x01 )
#define ST_GC_CLOCK_DETECT                ( ( UBYTE )0x02 )
#define ST_GC_CLOCK_ERROR                 ( ( UBYTE )0x04 )
#define ST_PLL_SYNCHED                    ( ( UBYTE )0x08 )
#define ST_OUT_CLOCK_DETECT               ( ( UBYTE )0x10 )
#define ST_IN_CLOCK_DETECT                ( ( UBYTE )0x20 )
/* defines for HwPLL - Command */
#define CM_PLL_STOP                       ( ( UBYTE )0x00 )
#define CM_PLL_START                      ( ( UBYTE )0x01 )
#define CM_SYNC_ENABLE                    ( ( UBYTE )0x02 )
#define CM_SYNC_MODE                      ( ( UBYTE )0x04 )
#define CM_ENABLE_GC_CLOCK                ( ( UBYTE )0x08 )
#define CM_ENABLE_OUT_CLOCK               ( ( UBYTE )0x10 )
#define CM_ENABLE_IN_CLOCK                ( ( UBYTE )0x20 )
...
typedef struct
{
	...
	ULONG dwTimeBaseDp;
	UWORD wDpCycleTime;
	UBYTE bMasterApplCycleTime;
	ULONG dwTimeBaseIo;
	UWORD wTi;
	UWORD wTo;
	ULONG dwDataExchangeTime;
	UWORD wPllWindow;
	UWORD wPllDelayTime;
} _PACKED_ sIsochron;
#define psIsochron sIsochron MEM_PTR
#define cSizeOfIsochronous                 ( ( UBYTE )0x18 )
...
#define cSizeOfIsochronPrmBlock           ( ( UBYTE )0x1C )
...
#define cSizeOfHwPLL                      ( ( UBYTE )0x15 )

#if VPC3_SERIAL_MODE
   #if DP_VPC3_4KB_MODE
	  #define VPC3_GET_HW_PLL_PTR()       ( VPC3_UNSIGNED8_PTR )( ( ( VPC3_ADR )( 0xFC0 ) ) + \
																  ( ( VPC3_ADR )Vpc3AsicAddress ) )
   ...
   #else
	  #define VPC3_GET_HW_PLL_PTR()       ( VPC3_UNSIGNED8_PTR )( ( ( VPC3_ADR )( 0x7C0 ) ) + \
																  ( ( VPC3_ADR )Vpc3AsicAddress ) )
...
typedef struct
{
   ...
   #if VPC3_SERIAL_MODE
	  #if DP_VPC3_4KB_MODE
		 #define VPC3_GET_CS_INTERVAL_PTR()     ( VPC3_UNSIGNED8_PTR )( ( ( VPC3_ADR )( 0xFF8 ) ) + \
																		( ( VPC3_ADR )Vpc3AsicAddress ) )
		 #define VPC3_GET_CV_SEC_PTR()          ( VPC3_UNSIGNED8_PTR )( ( ( VPC3_ADR )( 0xFE4 ) ) + \
																		( ( VPC3_ADR )Vpc3AsicAddress ) )
		 #define VPC3_GET_CV_FP_SEC_PTR()       ( VPC3_UNSIGNED8_PTR )( ( ( VPC3_ADR )( 0xFE8 ) ) + \
																		( ( VPC3_ADR )Vpc3AsicAddress ) )
		 #define VPC3_GET_CV_REC_DEL_TIME_PTR() ( VPC3_UNSIGNED8_PTR )( ( ( VPC3_ADR )( 0xFEC ) ) + \
																		( ( VPC3_ADR )Vpc3AsicAddress ) )

		 #define VPC3_GET_ERROR_COUNTER_PTR()   ( VPC3_UNSIGNED8_PTR )( ( ( VPC3_ADR )( 0xFFC ) ) + \
																		( ( VPC3_ADR )Vpc3AsicAddress ) )
	  #else
		 #define VPC3_GET_CS_INTERVAL_PTR()     ( VPC3_UNSIGNED8_PTR )( ( ( VPC3_ADR )( 0x7F8 ) ) + \
																		( ( VPC3_ADR )Vpc3AsicAddress ) )
		 #define VPC3_GET_CV_SEC_PTR()          ( VPC3_UNSIGNED8_PTR )( ( ( VPC3_ADR )( 0x7E4 ) ) + \
																		( ( VPC3_ADR )Vpc3AsicAddress ) )
		 #define VPC3_GET_CV_FP_SEC_PTR()       ( VPC3_UNSIGNED8_PTR )( ( ( VPC3_ADR )( 0x7E8 ) ) + \
																		( ( VPC3_ADR )Vpc3AsicAddress ) )
		 #define VPC3_GET_CV_REC_DEL_TIME_PTR() ( VPC3_UNSIGNED8_PTR )( ( ( VPC3_ADR )( 0x7EC ) ) + \
																		( ( VPC3_ADR )Vpc3AsicAddress ) )

		 #define VPC3_GET_ERROR_COUNTER_PTR()   ( VPC3_UNSIGNED8_PTR )( ( ( VPC3_ADR )( 0x7FC ) ) + \
																		( ( VPC3_ADR )Vpc3AsicAddress ) )
	  #endif /* #if DP_VPC3_4KB_MODE */
   #else
	  #define VPC3_GET_CS_INTERVAL_PTR()        ( VPC3_UNSIGNED8_PTR )( ( VPC3_ADR )( &pVpc3->sCs.abCsInterval[0] \
																					  VPC3_EXTENSION ) )
	  #define VPC3_GET_CV_SEC_PTR()             ( VPC3_UNSIGNED8_PTR )( ( VPC3_ADR )( &pVpc3->sCs.abCvTimeEvent[0] \
																					  VPC3_EXTENSION ) )
	  #define VPC3_GET_CV_FP_SEC_PTR()          ( VPC3_UNSIGNED8_PTR )( ( VPC3_ADR )( &pVpc3->sCs.abCvTimeEvent[4] \
																					  VPC3_EXTENSION ) )
	  #define VPC3_GET_CV_REC_DEL_TIME_PTR()    ( VPC3_UNSIGNED8_PTR )( ( VPC3_ADR )( &pVpc3->sCs.abRecDelTime[0] \
																					  VPC3_EXTENSION ) )

	  #define VPC3_GET_ERROR_COUNTER_PTR()      ( VPC3_UNSIGNED8_PTR )( ( VPC3_ADR )( &pVpc3->abErrorCounter[0] \
																					  VPC3_EXTENSION ) )
   #endif /* #if VPC3_SERIAL_MODE */
...
#define TS_UNION_STRUC_PTR   TS_UNION_STRUC MEM_PTR
   ...
   #define ALERT_PROFILE_IDENTIFICATION   ( ( UWORD )0xFFFC );
#endif /* #if TS_DIAG_WITH_PROFILE_ID */

#define TS_BUFFER_OFFSET                  ( ( UBYTE )0x64 )  /* DS 100..115 */

#define TS_MAX_BUFFER                     ( ( UBYTE )0x10 )  /* Index 100 to Index 115 */
#define MAX_TIMESTAMP_EVENTS              ( ( UBYTE )0x11 )  /* Each buffer consist of 17 entries,
	                                                          */
                                                             /* each entry has a data size of 14
                                                                bytes --> max size is 238 bytes */
/* defines for bStatus1 */
#define DS240_ST1_TS_ENABLED              ( ( UBYTE )0x01 )  /* timestamp is enabled */
#define DS240_ST1_NEW_CS_RECEIVED         ( ( UBYTE )0x02 )  /* new clock sync received */
#define DS240_ST1_BUFFER_OVERFLOW         ( ( UBYTE )0x08 )  /* buffer overflow */
#define DS240_ST1_RESTART_TIMESTAMP       ( ( UBYTE )0x10 )  /* restart timestamp */
#define DS240_ST1_MASTER_DISCONNECT       ( ( UBYTE )0x20 )  /* master is disconnect */
#define DS240_ST1_MASTER_CLEAR            ( ( UBYTE )0x40 )  /* master is in state clear ( Operate
	                                                            --> Clear ) */
#define DS240_ST1_START_PROCESS           ( ( UBYTE )0x80 )  /* set restarted bit in diagnostic
	                                                            state */
/* defines for bStatus2 */
#define DS240_ST2_INIT_OK                 ( ( UBYTE )0x01 )  /* VPC3 initialization OK, --> WaitPrm
	                                                          */
#define DS240_ST2_PRM_RECEIVED            ( ( UBYTE )0x02 )  /* prm-telegram received */
#define DS240_ST2_CFG_RECEIVED            ( ( UBYTE )0x04 )  /* cfg-telegram received */
#define DS240_ST2_READ_INPUT              ( ( UBYTE )0x08 )  /* update input data */
#define DS240_ST2_DATA_EXCHANGE           ( ( UBYTE )0x10 )  /* Data Exchange */
#define DS240_ST2_CS_PRM_RECEIVED         ( ( UBYTE )0x20 )  /* clocksync prm-block received */
#define DS240_ST2_MASTER_OPERATE          ( ( UBYTE )0x40 )  /* Master in state operate */
#define DS240_ST2_USER_TS_PRM_RECEIVED    ( ( UBYTE )0x80 )  /* prm data for user timestamp received
	                                                          */

#define MASK_FOR_TS_ENABLED               ( ( UBYTE )0xE0 )  /* mask for TsEnabled = VPC3_TRUE */

/* defines for bStatus3 */
#define DS240_ST3_CS_RECEIVED             ( ( UBYTE )0x01 )  /* clock sync received */
#define DS240_ST3_RED_SWITCHOVER          ( ( UBYTE )0x02 )  /* switch over */
...
typedef struct
{
	...
	UBYTE bStatus2;
	UBYTE bStatus3;
	UBYTE bNrOfActEvBuf;   /* number of actual event buffer */
	UBYTE bNrOfEvInBuf;    /* number of events in actual event buffer */
	UBYTE bRed1;           /* redundancy state */
	UBYTE bRed2;
	UBYTE bRed3;
} _PACKED_ sTsState;
...
typedef struct
{
	UBYTE bNrOfProcAlarm;
	UBYTE bNrOfReadEvBuf;
} sTsEventCounter;

typedef struct
{
	UBYTE bProcAlarmState;
	UBYTE bEventBufferState;
} _PACKED_ sTsEventState;

/* #define for bState */
#define TS_DIAG_ST_BUFFER_OVERFLOW     ( ( UBYTE )0x04 )
#define TS_DIAG_ST_TIMESTAMP_RESTARTED ( ( UBYTE )0x20 )

/* #define for Alert Data Type */
#define TS_DIAG_AT_EV_00               ( ( UBYTE )0x00 )     /* 0: Event, reserved */
#define TS_DIAG_AT_EV_01               ( ( UBYTE )0x01 )     /* 1: Event, Data_Set (mixed
	                                                            composition of signal end exception
	                                                            types) */
#define TS_DIAG_AT_EV_02               ( ( UBYTE )0x02 )     /* 2: Event, Trend_Float structure
	                                                            (DS-46) */
#define TS_DIAG_AT_EV_03               ( ( UBYTE )0x03 )     /* 3: Event, Trend_Discrete structure
	                                                            (DS-47) */
#define TS_DIAG_AT_EV_04               ( ( UBYTE )0x04 )     /* 4: Event, Trend_Bit_String structure
	                                                            (DS-48) */
                                                             /* 5 ñ 9: reserved for other Event
                                                                alert object types */
#define TS_DIAG_AT_PA_0A               ( ( UBYTE )0x0A )     /* 10: Process Alarm, Alarm_Float
	                                                            structure (DS-39) */
#define TS_DIAG_AT_PA_0B               ( ( UBYTE )0x0B )     /* 11: Process Alarm, Alarm_Discrete
	                                                            structure (DS-40) */
#define TS_DIAG_AT_PA_0C               ( ( UBYTE )0x0C )     /* 12: Process Alarm, Alarm_Integer
	                                                            structure (DS-86) */
                                                             /* 13 ñ 19: reserved for other Process
                                                                Alarm alert object types */
#define TS_DIAG_AT_PA_0D               ( ( UBYTE )0x0D )     /* 13: Process Alarm, */


#define TS_DIAG_AT_UA_14               ( ( UBYTE )0x14 )     /* 20: Update Alarm, Alarm_Update
	                                                            structure (DS-41) */
                                                             /* 21 ñ 29: reserved for other Update
                                                                Alarm alert object types */
#define TS_DIAG_AT_SA_1E               ( ( UBYTE )0x1E )     /* 30: Status Alarm, Alarm_Mode_Change
	                                                            structure (DS-87) */
#define TS_DIAG_AT_SA_1F               ( ( UBYTE )0x1F )     /* 31: Status Alarm, Alarm_Simulation
	                                                            structure (DS-88) */
#define TS_DIAG_AT_SA_20               ( ( UBYTE )0x20 )     /* 32: Status Alarm, Alarm_Fail_Safe
	                                                            structure (DS-89) */
#define TS_DIAG_AT_SA_21               ( ( UBYTE )0x21 )     /* 33: Status Alarm,
	                                                            Alarm_Access_Protection structure
	                                                            (DS-90) */
#define TS_DIAG_AT_SA_22               ( ( UBYTE )0x22 )     /* 34: Status Alarm,
	                                                            Alarm_Sampling_Information structure
	                                                            (DS-96) */
#define TS_DIAG_AT_SA_23               ( ( UBYTE )0x23 )     /* 35: Status Alarm,
	                                                            Alarm_Sampling_State structure
	                                                            (DS-96) */
                                                             /* 36 ñ 39: reserved for other Status
                                                                Alarm alert object types */
#define TS_DIAG_AT_TD_28               ( ( UBYTE )0x28 )     /* 40: Timestamped Diagnosis,
	                                                            Alarm_Diagnosis structure (DS-91) */
#define TS_DIAG_AT_TD_29               ( ( UBYTE )0x29 )     /* 41: Timestamped Diagnosis,
	                                                            Alarm_Extended_Diagnosis structure
	                                                            (DS-92) */
#define TS_DIAG_AT_TD_2A               ( ( UBYTE )0x2A )     /* 42: Timestamped Diagnosis,
	                                                            Alarm_Checkback structure (DS-93) */
#define TS_DIAG_AT_TD_2B               ( ( UBYTE )0x2B )     /* 43: Timestamped Diagnosis,
	                                                            Alarm_Defect_Class structure (DS-94)
	                                                          */
#define TS_DIAG_AT_TD_2C               ( ( UBYTE )0x2C )     /* 44: Timestamped Diagnosis,
	                                                            Alarm_Sampling_Diagnosis structure
	                                                            (DS-91) */
                                                             /* 45 ñ 49: reserved for other
                                                                Timestamped Diagnosis alert object
                                                                types */

/* #define for Alert Profile Identification */
#define TS_DIAG_API_NOT_ALLOWED        ( ( UWORD )0x0000 )  /* 0: reserved (not allowed) */
#define TS_DIAG_API_PA_01              ( ( UWORD )0x0001 )  /* 1: "PROFIBUS-PA Profile for Process
	                                                           Control Devices, Version 3, Amendment
	                                                           1"(support of alarms) */
                                                            /* 2 - 9: reserved for new versions or
                                                               amendments of "PROFIBUS-PA Profile
                                                               for Process Control Devices". */
                                                            /* 10 ñ 99: reserved for "Profile for
                                                               Remote I/O" and following versions
                                                               and amendments */
                                                            /* 100 ñ 199: reserved for "Profile for
                                                               NC/RC Controllers" and following
                                                               versions and amendments */
                                                            /* 200 ñ 299: reserved for "Profile for
                                                               Encoders" and following versions and
                                                               amendments */
                                                            /* 300 ñ 399: reserved for "Profile for
                                                               Variable Speed Drives" and following
                                                               versions and amendments */
                                                            /* 400 ñ 499: reserved for "Profile for
                                                               Variable Speed Drives" and following
                                                               versions and amendments */
                                                            /* 500 ñ 32767: reserved (PNO) */
                                                            /* 32768 ñ 65531: manufacturer specific
                                                             */
#define TS_DIAG_API_MANUFACTURER       ( ( UWORD )0x8000 )  /* 32768 */

#define TS_DIAG_API_NOT_USED           ( ( UWORD )0xFFFC )  /* 65532: not used */
#define TS_DIAG_API_NONE               ( ( UWORD )0xFFFD )  /* 65533: none */
#define TS_DIAG_API_UNKNOWN            ( ( UWORD )0xFFFE )  /* 65534: unknown */
#define TS_DIAG_API_SPECIAL            ( ( UWORD )0xFFFF )  /* 65535: special */
...
typedef struct
{
	...
	UBYTE bDs;
	UBYTE bNrOfEntries;
	UBYTE bAlertDataType;
   #if TS_DIAG_WITH_PROFILE_ID
	UWORD wAlertProfileIdentification;
   #endif /* #if TS_DIAG_WITH_PROFILE_ID */
...
/*---------------------------------------------------------------------------*/
#define MSAC_C2_MAX_INPUT_ITEMS           ( ( UBYTE )( ( 2 * DP_C2_NUM_SAPS ) + 1 ) ) /* number of
	                                                                                     elements in
	                                                                                     the input
	                                                                                     queue */
#define MSAC_C2_SAP_NR_LOW                ( ( UBYTE )0x00 )                   /* lowest possible SAP
	                                                                             for MSAC_C2 */
#define MSAC_C2_SAP_NR_HIGH               ( ( UBYTE )0x30 )                   /* highest possible
	                                                                             SAP for MSAC_C2
	                                                                             (dp_mode =1) */
...
typedef enum
{
	...
	RM_LOADABLE = ( ( UBYTE ) 0x02 ),  /* load rm-sap (immediate response was sent or channel was
	                                      opened) */
...
#define MSAC_C2_ABT_STO                   ( ( UBYTE )0x06 )   /* Send_Timeout requested was too
	                                                             small */
#define MSAC_C2_ABT_IA                    ( ( UBYTE )0x07 )   /* invalid additional address
	                                                             information */
...
#define MSAC_C2_MAX_PDU                   ( ( UBYTE )0xF4 )   /* PDU with DPV1-Header (4Byte) + 240
	                                                             User Data */
...
typedef struct
{
	...
	UBYTE bD_Type;
	UBYTE bD_Len;
	UBYTE abAddrData[C2_LEN - 16];     /* max length from DpCfg.h */
...
typedef struct _MSAC_C2_INITIATE_RES_PDU
{
	...
	UBYTE bD_Type;
	UBYTE bD_Len;
	UBYTE abAddrData[C2_LEN - 12];     /* max length from DpCfg.h */
...
#define SET_ALARM_NO_BUFFER               ( ( UBYTE )0x07 )
...
#define SPEC_DISAPP_SLOT_NOT_OK           ( ( UBYTE )0x03 )

#define SPEC_MASK                         ( ( UBYTE )0x03 )
#define SPEC_SEQ_START                    ( ( UBYTE )0x03 )   /* use it to shift the sequence number
	                                                             down to bit 0 or up to bit 3 */
...
#define MSAC_C1_MAX_PDU                   ( ( UBYTE )0xF4 )   /* PDU with DPV1-Header (4Byte) + 240
	                                                             User Data */
...
typedef enum
{
	DPV0_MODE = ( ( UBYTE ) 0x00 ),
	DPV1_MODE = ( ( UBYTE ) 0x01 )
} DP_OPMODE;
...
typedef struct
{
	...
	UBYTE bEnabled;
	UBYTE bCloseChannelRequest;                                    /* memory item for close_channel
	                                                                  request of the user, */
	                                                               /* used to reject a double
	                                                                  request */
	...
	MSAC_C2_CONNECT_ITEM asConnectionList[DP_C2_NUM_SAPS];           /* list of
...
#define AL_TYPE_MAX                       ( ( UBYTE )0x07 )   /* dpv1 draft specification - do not
	                                                             use cast ! */
#define AL_SEQUENCE_MAX                   ( ( UBYTE )0x20 )   /* dpv1 draft specification - do not
	                                                             use cast ! */
...
typedef struct
{
	...
	UBYTE bSequence;           /* VPC3_FALSE: only one alarm of a specific ALARM_TYPE can be active
	                              at one time */
	                           /* VPC3_TRUE : several alarms (2 to 32) of the same or different
	                              ALARM_TYPE can be */
	                           /*       active at one time */
...
#define eDpStateInit             ( ( UBYTE )( 1u << 0 ) )  /**< init state, all data cleared */
#define eDpStateRun              ( ( UBYTE )( 1u << 1 ) )  /**< internal state run */
#define eDpStateApplReady        ( ( UBYTE )( 1u << 2 ) )  /**< state application ready, set after
	                                                          successfull call of function
	                                                          DpAppl_ApplicationReady() */
#define eDpStateCfgOkStatDiag    ( ( UBYTE )( 1u << 3 ) )  /**< VPC3+ has received valid cfg-data,
	                                                          set Diag.StatDiag, call the function
	                                                          DpAppl_ApplicationReady() */
#define eDpStateDiagActive       ( ( UBYTE )( 1u << 4 ) )  /**< The user has send new user
	                                                          diagnostic to VPC3+ and waits for new
	                                                          diag-pointer */
#define eDpStateWritePrmOK       ( ( UBYTE )( 1u << 5 ) )  /**< Write Parameter was OK */
#define eDpStateWaitForApplReady ( ( UBYTE )( 1u << 6 ) )  /**< Wait for Diag.StatDiag reset! */
#define eDpStateAlarmActive      ( ( UBYTE )( 1u << 7 ) )  /**< The master is now in Operate-mode,
	                                                          the alarm state machine is active */
...
typedef struct
{
	...
	UWORD wPollInterruptMask;
   #endif /* #if DP_INTERRUPT_MASK_8BIT == 0 */
	UWORD wOldDiag;
	UBYTE bDiagSeqCounter;
	UBYTE bState;
	UBYTE bOldGlobalControl;
	UBYTE bUserDiagActive;                      //Added back from Stack V 06.07 #stackUpgrade
	UBYTE abUserDiagnostic[DIAG_BUFSIZE];
	UBYTE abPrmCfgSsaHelpBuffer[HELP_BUFSIZE];
	DP_OPMODE eDPV1;
	bool_t bApplicationReady;

	UBYTE bOutputDataLength;                                 /* calculated output length (data from
	                                                            DP-Master to VPC3) */
	UBYTE bInputDataLength;                                  /* calculated input length  (data from
	                                                            VPC3 to DP-Master) */
	UWORD wVpc3UsedDPV0BufferMemory;                        /* consumed user_memory */
	UWORD wVpc3UsedDPV1BufferMemory;                        /* consumed user_memory */

	UBYTE bIntIndHigh;                                       /* interrupt indication high byte */
	UBYTE bIntIndLow;                                        /* interrupt indication low byte */

	UBYTE bDinBufsize;                                       /*!< Length of the 3 Din buffers
	                                                            (dp_cfg.h:\ref DIN_BUFSIZE).
	                                                          */
	UBYTE bDoutBufsize;                                      /*!< Length of the 3 Dout buffers
	                                                            (dp_cfg.h:\ref DOUT_BUFSIZE).
	                                                          */
	UBYTE bPrmBufsize;                                       /*!< Length of the Set_Param buffer
	                                                            (dp_cfg.h:\ref PRM_BUFSIZE).
	                                                          */
	UBYTE bDiagBufsize;                                      /*!< Length of the 2 Diag buffer
	                                                            (dp_cfg.h:\ref DIAG_BUFSIZE).
	                                                          */
	UBYTE bCfgBufsize;                                       /*!< Length of the 2 Config buffer
	                                                            (dp_cfg.h:\ref CFG_BUFSIZE).
	                                                          */
	UBYTE bSsaBufsize;                                       /*!< Length of the
	                                                            Set_Slave_Address-buffer
	                                                            (dp_cfg.h:\ref SSA_BUFSIZE). */
	...
	UBYTE abCallService[0x10];

	UWORD awModImIndex[0x41][0x10];
	...
	VPC3_UNSIGNED8_PTR pDoutBuffer1;                           /*!< microprocessor formatted pointer
	                                                              to Dout buffer 1.*/
	VPC3_UNSIGNED8_PTR pDoutBuffer2;                           /*!< microprocessor formatted pointer
	                                                              to Dout buffer 2.*/
	VPC3_UNSIGNED8_PTR pDoutBuffer3;                           /*!< microprocessor formatted pointer
	                                                              to Dout buffer 3.*/

	VPC3_UNSIGNED8_PTR pDinBuffer1;                            /*!< microprocessor formatted pointer
	                                                              to Din buffer 1.*/
	VPC3_UNSIGNED8_PTR pDinBuffer2;                            /*!< microprocessor formatted pointer
	                                                              to Din buffer 2.*/
	VPC3_UNSIGNED8_PTR pDinBuffer3;                            /*!< microprocessor formatted pointer
	                                                              to Din buffer 3.*/

	VPC3_UNSIGNED8_PTR pDiagBuffer1;                           /*!< microprocessor formatted pointer
	                                                              to Diag buffer 1.*/
	VPC3_UNSIGNED8_PTR pDiagBuffer2;                           /*!< microprocessor formatted pointer
	                                                              to Diag buffer 2.*/

   #if DP_SUBSCRIBER
	PRM_DXB_LINK_TABLE sLinkTable;                             /* LinkTable */
	VPC3_UNSIGNED8_PTR pDxbOutBuffer1;                         /*!< microprocessor formatted pointer
	                                                              to Dxb buffer 1.*/
	VPC3_UNSIGNED8_PTR pDxbOutBuffer2;                         /*!< microprocessor formatted pointer
	                                                              to Dxb buffer 2.*/
	VPC3_UNSIGNED8_PTR pDxbOutBuffer3;                         /*!< microprocessor formatted pointer
	                                                              to Dxb buffer 3.*/
   #endif /* #if DP_SUBSCRIBER */

	VPC3_UNSIGNED8_PTR pDiagBuffer;                            /*!< microprocessor formatted pointer
	                                                              to current diagnostic buffer.*/

	//Added by Sagar from old implementation #stackUpgrade
	UBYTE bNrOfModules;
...
typedef struct
{
	...
	UBYTE bSwitchOverChannel1;
	UBYTE bSwitchOverChannel2;
	UBYTE bRedundancyPrimaryAddress;
	UBYTE bRedundancyBackupAddress;
	UBYTE bUpdateRedStateDiagnosis;
	UBYTE bRedStateSeqNr;
	UBYTE bRedTimerTick;
	UBYTE bAddressChanged;
} REDUNDANCY_STRUC;
...
#define IM_CS_WRITE_RECORD                ( ( UBYTE )0x01 )
   ...
   #define IM_INDEX_65100                 ( ( UWORD )0x4CFE )
#else
   ...
   #define IM_INDEX_65100                 ( ( UWORD )0xFE4C )
...
#if LITTLE_ENDIAN
   #define IM00_SUPPORTED                 ( ( UWORD )0x0000 )
   #define IM01_SUPPORTED                 ( ( UWORD )0x0200 )
   #define IM02_SUPPORTED                 ( ( UWORD )0x0400 )
   #define IM03_SUPPORTED                 ( ( UWORD )0x0800 )
   #define IM04_SUPPORTED                 ( ( UWORD )0x1000 )
   #define IM05_SUPPORTED                 ( ( UWORD )0x2000 )
   #define IM06_SUPPORTED                 ( ( UWORD )0x4000 )
   #define IM07_SUPPORTED                 ( ( UWORD )0x8000 )
   #define IM08_SUPPORTED                 ( ( UWORD )0x0001 )
   #define IM09_SUPPORTED                 ( ( UWORD )0x0002 )
   #define IM10_SUPPORTED                 ( ( UWORD )0x0004 )
   #define IM11_SUPPORTED                 ( ( UWORD )0x0008 )
   #define IM12_SUPPORTED                 ( ( UWORD )0x0010 )
   #define IM13_SUPPORTED                 ( ( UWORD )0x0020 )
   #define IM14_SUPPORTED                 ( ( UWORD )0x0040 )
   #define IM15_SUPPORTED                 ( ( UWORD )0x0080 )
#else
   #define IM00_SUPPORTED                 ( ( UWORD )0x0000 )
...
typedef enum
{
	...
	DP_CFG_UPDATE    /**< The transferred configuration is OK, but it's different from read
	                    configuration buffer. The user will exchange verified configuration with
