/**
 **********************************************************************************************
 * @file            ACD debug interface configuration file.
 *
...
/****************************************************************************************************
*  Debug defines for Address Conflict Detection debug logs
****************************************************************************************************/
#if BF_ACD_DBG
	#define ACD_DBG_PRINT BF_DBG_ON
#else
	#define ACD_DBG_PRINT BF_DBG_OFF
#endif
 ...
 */
#ifndef ACD_ENABLE_MASK
	#define ACD_ENABLE_MASK   DEBUG_MASK( ACD_DBG_PRINT )
#endif

/**
 * Macro to print ACD module specific debug prints
 ...
 */
#define ACD_DEBUG_PRINT( MessageType, ... )     BF_DEBUG_PRINT( ACD_ENABLE_MASK, MessageType, __VA_ARGS__ )


#endif	// #ifndef ACD_DEBUG_H
