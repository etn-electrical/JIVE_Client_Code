Attribute VB_Name = "Modbus_HTML_INTERNAL"
'****************************************************************************************************************************
'
...
'
'****************************************************************************************************************************
Sub Modbus_HTML_INTERNAL_Documentation()
    Application.Calculation = xlCalculationManual
    Dim file_name As String
    file_name = Get_Modbus_Output_File_Pathname(".html", "_INTERNAL")
    ...
    While (Cells(modbus_sheet_row, MODBUS_DATA_DEFINE_COL).text <> Empty) And (Cells(modbus_sheet_row, MODBUS_DATA_DEFINE_COL).text <> BEGIN_IGNORED_DATA)
        ...
        If desc_sheet_row > 0 Then
            ...
            short_descr = DCID_Lookup_Short_Description(desc_sheet_row) & "<br/>" & dcid_name & "<br/>"
...
Private Sub Emit_HTML_Header()
    ...
    HtmlDoc.WriteLine ("C445 Modbus Registers<br/>")
    HtmlDoc.WriteLine ("INTERNAL - For Eaton use only.")
    HtmlDoc.WriteLine ("</h1>")
    HtmlDoc.WriteLine ("This file contains information that is NOT to be shared with customers.<br/>")
...
Private Function Build_Html_Attribute_Description(modbus_sheet_row As Long, desc_sheet_row As Long) As String
    ...
    ' unpublished
    If Modbus_Is_UserDocIgnored_Checked(modbus_sheet_row) Then
        attrib_str = "INTERNAL"
